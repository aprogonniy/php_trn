<?php  
  session_start() ;
  class form_customers_form_teste
  {
   function form_customers_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_customers/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_customers</FONT></B> 
<br> 
...
<input type="submit" value="form_customers"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_customers_form_teste();
  $frm_teste->form_customers_teste();
?>
