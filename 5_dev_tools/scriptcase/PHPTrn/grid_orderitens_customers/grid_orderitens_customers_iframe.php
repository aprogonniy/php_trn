...
$oExportPdf = new grid_orderitens_customers_export_pdf;
$oExportPdf->exportPdf();

class grid_orderitens_customers_export_pdf {
...
include_once('../_lib/buttons/' . str_replace('.css', $_SESSION['scriptcase']['reg_conf']['css_dir'] . '.php', $STR_btn));
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $Nm_lang['lang_tble_orderitens'] ?> :: PDF</title>
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_orderitens_customers_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_orderitens_customers']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_orderitens_customers']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_orderitens_customers.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_orderitens_customers']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_orderitens_customers']['pdf_name'] : "grid_orderitens_customers.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="grid_orderitens_customers.php" target="<?php echo $NM_target; ?>" style="display: none"> 
