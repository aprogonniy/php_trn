<?php  
  ...
  session_start() ;
  class grid_orderitens_customers_form_teste
  {
  function grid_orderitens_customers_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_orderitens_customers</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_orderitens_customers.php" 
               target="_self"> 
v_order&nbsp;&nbsp;<input type=text name="v_order" size=20><br> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/>
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_orderitens_customers"> 
</form> 
<script language=javascript> 
 document.FCons.v_order.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_orderitens_customers_form_teste();
  $frm_teste->grid_orderitens_customers_teste();
?>
