<?php
   ...
   session_start();
    $Ord_Cmp = new grid_orderitens_customers_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_orderitens_customers_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['productid'] = "on";
   $tab_def_campos['productid'] = "productid";
   $tab_converte["productid"]   = "productid";
   $tab_labels["productid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['labels']["productid"])) ? $_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['labels']["productid"] : "" . $this->Nm_lang['lang_orderitens_fild_productid'] . "";
   $tab_ger_campos['quantity'] = "on";
   $tab_def_campos['quantity'] = "quantity";
   $tab_converte["quantity"]   = "quantity";
   $tab_labels["quantity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['labels']["quantity"])) ? $_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['labels']["quantity"] : "" . $this->Nm_lang['lang_orderitens_fild_quantity'] . "";
   $tab_ger_campos['unitprice'] = "on";
   $tab_def_campos['unitprice'] = "unitprice";
   $tab_converte["unitprice"]   = "unitprice";
   $tab_labels["unitprice"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['labels']["unitprice"])) ? $_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['labels']["unitprice"] : "" . $this->Nm_lang['lang_orderitens_fild_unitprice'] . "";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_converte["total"]   = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['labels']["total"] : "" . $this->Nm_lang['lang_orderitens_fild_total'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tble_orderitens'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_orderitens_customers_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_orderitens_customers']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
