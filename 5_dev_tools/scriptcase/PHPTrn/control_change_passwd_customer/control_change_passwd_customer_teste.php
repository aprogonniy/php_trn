<?php  
  session_start() ;
  class control_change_passwd_customer_form_teste
  {
   function control_change_passwd_customer_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "control_change_passwd_customer/img";
...
?> 
<br> 
<B><FONT SIZE="4">control_change_passwd_customer</FONT></B> 
<br> 
<form name="Fedit" method="post" 
               action="control_change_passwd_customer.php" 
               target="_self"> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/><input type="hidden" name="nmgp_outra_jan" value="true"/>v_customer&nbsp;&nbsp;<input type="text" name="v_customer" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="control_change_passwd_customer"> 
</form> 
<script language=javascript> 
 document.Fedit.v_customer.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new control_change_passwd_customer_form_teste();
  $frm_teste->control_change_passwd_customer_teste();
?>
