  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_state_by_country" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate stateid
  function do_ajax_form_state_by_country_validate_stateid()
  {
    var nomeCampo_stateid = "stateid";
    var var_stateid = scAjaxGetFieldText(nomeCampo_stateid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_state_by_country_validate_stateid(var_stateid, var_script_case_init, do_ajax_form_state_by_country_validate_stateid_cb);
  } // do_ajax_form_state_by_country_validate_stateid

  function do_ajax_form_state_by_country_validate_stateid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_state_by_country_validate_stateid_cb

  // ---------- Validate countrycode
  function do_ajax_form_state_by_country_validate_countrycode()
  {
    var nomeCampo_countrycode = "countrycode";
    var var_countrycode = scAjaxGetFieldSelect(nomeCampo_countrycode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_state_by_country_validate_countrycode(var_countrycode, var_script_case_init, do_ajax_form_state_by_country_validate_countrycode_cb);
  } // do_ajax_form_state_by_country_validate_countrycode

  function do_ajax_form_state_by_country_validate_countrycode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_state_by_country_validate_countrycode_cb

  // ---------- Validate name
  function do_ajax_form_state_by_country_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_state_by_country_validate_name(var_name, var_script_case_init, do_ajax_form_state_by_country_validate_name_cb);
  } // do_ajax_form_state_by_country_validate_name

  function do_ajax_form_state_by_country_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "name";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_state_by_country_validate_name_cb
  // ---------- Form
  function do_ajax_form_state_by_country_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_state_by_country_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_state_by_country_submit_form(var_stateid, var_countrycode, var_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_state_by_country_submit_form_cb);
  } // do_ajax_form_state_by_country_submit_form

  function do_ajax_form_state_by_country_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_state_by_country_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_state_by_country_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_state_by_country_navigate_form(var_stateid, var_countrycode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_state_by_country_navigate_form_cb);
  } // do_ajax_form_state_by_country_navigate_form

  function do_ajax_form_state_by_country_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_state_by_country_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_state_by_country_navigate_form_cb
