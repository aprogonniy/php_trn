<?php  
  session_start() ;
  class form_state_by_country_form_teste
  {
   function form_state_by_country_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_state_by_country/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_state_by_country</FONT></B> 
<br> 
<form name="Fedit" method="post" 
               action="form_state_by_country.php" 
               target="_self"> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/><input type="hidden" name="nmgp_outra_jan" value="true"/>v_country&nbsp;&nbsp;<input type="text" name="v_country" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="form_state_by_country"> 
</form> 
<script language=javascript> 
 document.Fedit.v_country.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_state_by_country_form_teste();
  $frm_teste->form_state_by_country_teste();
?>
