...
class grid_orderitens_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_orderitens_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_orderitens_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_orderitens_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "orderid";$Nm_numeric[] = "productid";$Nm_numeric[] = "quantity";$Nm_numeric[] = "unitprice";$Nm_numeric[] = "total";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['decimal_db'] == ".")
         {
            $nm_aspas = "";
         }
         if ($condicao != "IN")
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_orderitens.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_orderitens'] ?></TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_orderitens_ajax_search.js"></script>
 <script type="text/javascript" src="grid_orderitens_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_orderid_cond#NMF#' + search_get_sel_txt('SC_orderid_cond') + '@NMF@';
  str_out += 'SC_orderid#NMF#' + search_get_text('SC_orderid') + '@NMF@';
  str_out += 'SC_productid_cond#NMF#' + search_get_sel_txt('SC_productid_cond') + '@NMF@';
  str_out += 'SC_productid#NMF#' + search_get_text('SC_productid') + '@NMF@';
  str_out += 'SC_quantity_cond#NMF#' + search_get_sel_txt('SC_quantity_cond') + '@NMF@';
  str_out += 'SC_quantity#NMF#' + search_get_text('SC_quantity') + '@NMF@';
  str_out += 'SC_unitprice_cond#NMF#' + search_get_sel_txt('SC_unitprice_cond') + '@NMF@';
  str_out += 'SC_unitprice#NMF#' + search_get_text('SC_unitprice') + '@NMF@';
  str_out += 'SC_total_cond#NMF#' + search_get_sel_txt('SC_total_cond') + '@NMF@';
  str_out += 'SC_total#NMF#' + search_get_text('SC_total') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_orderitens.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_orderitens'] ?></span></td>
...
<?php
   ...
   {
      global 
             $orderid_cond, $orderid,
             $productid_cond, $productid,
             $quantity_cond, $quantity,
             $unitprice_cond, $unitprice,
             $total_cond, $total,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $orderid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['orderid']; 
          $orderid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['orderid_cond']; 
          $productid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['productid']; 
          $productid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['productid_cond']; 
          $quantity = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['quantity']; 
          $quantity_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['quantity_cond']; 
          $unitprice = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['unitprice']; 
          $unitprice_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['unitprice_cond']; 
          $total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['total']; 
          $total_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['total_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['NM_operador']; 
          if (strtoupper($orderid_cond) != "II" && strtoupper($orderid_cond) != "QP" && strtoupper($orderid_cond) != "NP" && strtoupper($orderid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($orderid, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($productid_cond) != "II" && strtoupper($productid_cond) != "QP" && strtoupper($productid_cond) != "NP" && strtoupper($productid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($productid, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($quantity_cond) != "II" && strtoupper($quantity_cond) != "QP" && strtoupper($quantity_cond) != "NP" && strtoupper($quantity_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($quantity, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($unitprice_cond) != "II" && strtoupper($unitprice_cond) != "QP" && strtoupper($unitprice_cond) != "NP" && strtoupper($unitprice_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($unitprice, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($total_cond) != "II" && strtoupper($total_cond) != "QP" && strtoupper($total_cond) != "NP" && strtoupper($total_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($total, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
      } 
      if (!isset($orderid_cond) || empty($orderid_cond))
      {
         $orderid_cond = "eq";
      }
      if (!isset($productid_cond) || empty($productid_cond))
      {
         $productid_cond = "eq";
      }
      if (!isset($quantity_cond) || empty($quantity_cond))
      {
         $quantity_cond = "eq";
      }
      if (!isset($unitprice_cond) || empty($unitprice_cond))
      {
         $unitprice_cond = "eq";
      }
      ...
      $str_hide_orderid = (in_array($orderid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_productid = (in_array($productid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_quantity = (in_array($quantity_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_unitprice = (in_array($unitprice_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_total = (in_array($total_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($orderid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $orderid = substr($orderid, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($productid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $productid = substr($productid, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($quantity, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $quantity = substr($quantity, 0, $tmp_pos);
         }
      }
      ...
      if (isset($unitprice) && !empty($unitprice))
      {
         $tmp_pos = strpos($unitprice, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $unitprice = substr($unitprice, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($total, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $total = substr($total, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_orderitens_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['orderid'])) ? $this->New_label['orderid'] : "" . $this->Ini->Nm_lang['lang_orderitens_fild_orderid'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_orderid_cond" name="orderid_cond" onChange="nm_campos_between(document.getElementById('id_vis_orderid'), this, 'orderid')">
       <OPTION value="eq" <?php if ("eq" == $orderid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $orderid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $orderid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $orderid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_orderid" <?php echo $str_hide_orderid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['orderid'])) ? $this->New_label['orderid'] : "" . $this->Ini->Nm_lang['lang_orderitens_fild_orderid'] . "";
 $nmgp_tab_label .= "orderid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_orderid" name="orderid" value="<?php echo NM_encode_input($orderid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['productid'])) ? $this->New_label['productid'] : "" . $this->Ini->Nm_lang['lang_orderitens_fild_productid'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_productid_cond" name="productid_cond" onChange="nm_campos_between(document.getElementById('id_vis_productid'), this, 'productid')">
       <OPTION value="eq" <?php if ("eq" == $productid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $productid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $productid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $productid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_productid" <?php echo $str_hide_productid?> valign="top">
 ...
 $nmgp_tab_label .= "productid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_productid" name="productid" value="<?php echo NM_encode_input($productid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['quantity'])) ? $this->New_label['quantity'] : "" . $this->Ini->Nm_lang['lang_orderitens_fild_quantity'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_quantity_cond" name="quantity_cond" onChange="nm_campos_between(document.getElementById('id_vis_quantity'), this, 'quantity')">
       <OPTION value="eq" <?php if ("eq" == $quantity_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $quantity_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $quantity_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $quantity_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_quantity" <?php echo $str_hide_quantity?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['quantity'])) ? $this->New_label['quantity'] : "" . $this->Ini->Nm_lang['lang_orderitens_fild_quantity'] . "";
 $nmgp_tab_label .= "quantity?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_quantity" name="quantity" value="<?php echo NM_encode_input($quantity) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['unitprice'])) ? $this->New_label['unitprice'] : "" . $this->Ini->Nm_lang['lang_orderitens_fild_unitprice'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_unitprice_cond" name="unitprice_cond" onChange="nm_campos_between(document.getElementById('id_vis_unitprice'), this, 'unitprice')">
       <OPTION value="eq" <?php if ("eq" == $unitprice_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $unitprice_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $unitprice_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $unitprice_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_unitprice" <?php echo $str_hide_unitprice?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['unitprice'])) ? $this->New_label['unitprice'] : "" . $this->Ini->Nm_lang['lang_orderitens_fild_unitprice'] . "";
 $nmgp_tab_label .= "unitprice?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_unitprice" name="unitprice" value="<?php echo NM_encode_input($unitprice) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['total'])) ? $this->New_label['total'] : "" . $this->Ini->Nm_lang['lang_orderitens_fild_total'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_total_cond" name="total_cond" onChange="nm_campos_between(document.getElementById('id_vis_total'), this, 'total')">
       <OPTION value="eq" <?php if ("eq" == $total_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $total_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $total_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $total_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_total" <?php echo $str_hide_total?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['total'])) ? $this->New_label['total'] : "" . $this->Ini->Nm_lang['lang_orderitens_fild_total'] . "";
 $nmgp_tab_label .= "total?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_total" name="total" value="<?php echo NM_encode_input($total) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_orderitens']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_orderitens']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_orderitens.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_orderid'), document.F1.orderid_cond, 'orderid');
   document.F1.orderid.value = "";
   nm_campos_between(document.getElementById('id_vis_productid'), document.F1.productid_cond, 'productid');
   document.F1.productid.value = "";
   nm_campos_between(document.getElementById('id_vis_quantity'), document.F1.quantity_cond, 'quantity');
   document.F1.quantity.value = "";
   nm_campos_between(document.getElementById('id_vis_unitprice'), document.F1.unitprice_cond, 'unitprice');
   document.F1.unitprice.value = "";
   nm_campos_between(document.getElementById('id_vis_total'), document.F1.total_cond, 'total');
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "PHPTrn/grid_orderitens";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_orderid_cond'] = 'cond';
      $tp_fields['SC_orderid'] = 'text';
      $tp_fields['SC_productid_cond'] = 'cond';
      $tp_fields['SC_productid'] = 'text';
      $tp_fields['SC_quantity_cond'] = 'cond';
      $tp_fields['SC_quantity'] = 'text';
      $tp_fields['SC_unitprice_cond'] = 'cond';
      $tp_fields['SC_unitprice'] = 'text';
      $tp_fields['SC_total_cond'] = 'cond';
      $tp_fields['SC_total'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $orderid_cond, $orderid,
             $productid_cond, $productid,
             $quantity_cond, $quantity,
             $unitprice_cond, $unitprice,
             $total_cond, $total, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $orderid_cond_salva = $orderid_cond; 
      if (!isset($orderid_input_2) || $orderid_input_2 == "")
      {
          $orderid_input_2 = $orderid;
      }
      $productid_cond_salva = $productid_cond; 
      if (!isset($productid_input_2) || $productid_input_2 == "")
      {
          $productid_input_2 = $productid;
      }
      $quantity_cond_salva = $quantity_cond; 
      if (!isset($quantity_input_2) || $quantity_input_2 == "")
      {
          $quantity_input_2 = $quantity;
      }
      $unitprice_cond_salva = $unitprice_cond; 
      if (!isset($unitprice_input_2) || $unitprice_input_2 == "")
      {
          $unitprice_input_2 = $unitprice;
      }
      $total_cond_salva = $total_cond; 
      if (!isset($total_input_2) || $total_input_2 == "")
      {
          $total_input_2 = $total;
      }
      if ($orderid_cond != "in")
      {
          nm_limpa_numero($orderid, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $orderid);
          ...
          $orderid = implode(",", $Nm_sc_valores);
      }
      if ($productid_cond != "in")
      {
          nm_limpa_numero($productid, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $productid);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, "."); 
          ...
          $productid = implode(",", $Nm_sc_valores);
      }
      if ($quantity_cond != "in")
      {
          nm_limpa_numero($quantity, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $quantity);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, "."); 
          ...
          $quantity = implode(",", $Nm_sc_valores);
      }
      if ($unitprice_cond != "in")
      {
          nm_limpa_numero($unitprice, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $unitprice);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, "."); 
          ...
          $unitprice = implode(",", $Nm_sc_valores);
      }
      if ($total_cond != "in")
      {
          nm_limpa_numero($total, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $total);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, "."); 
          ...
          $total = implode(",", $Nm_sc_valores);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['orderid'] = $orderid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['orderid_cond'] = $orderid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['productid'] = $productid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['productid_cond'] = $productid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['quantity'] = $quantity; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['quantity_cond'] = $quantity_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['unitprice'] = $unitprice; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['unitprice_cond'] = $unitprice_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['total'] = $total; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['total_cond'] = $total_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['orderid'] = $Conteudo;
      $Conteudo = $productid;
      if (strtoupper($productid_cond) != "II" && strtoupper($productid_cond) != "QP" && strtoupper($productid_cond) != "NP" && strtoupper($productid_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['productid'] = $Conteudo;
      $Conteudo = $quantity;
      if (strtoupper($quantity_cond) != "II" && strtoupper($quantity_cond) != "QP" && strtoupper($quantity_cond) != "NP" && strtoupper($quantity_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['quantity'] = $Conteudo;
      $Conteudo = $unitprice;
      if (strtoupper($unitprice_cond) != "II" && strtoupper($unitprice_cond) != "QP" && strtoupper($unitprice_cond) != "NP" && strtoupper($unitprice_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['unitprice'] = $Conteudo;
      $Conteudo = $total;
      if (strtoupper($total_cond) != "II" && strtoupper($total_cond) != "QP" && strtoupper($total_cond) != "NP" && strtoupper($total_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['total'] = $Conteudo;

      //----- $orderid
      $this->Date_part = false;
      if (isset($orderid) || $orderid_cond == "nu" || $orderid_cond == "nn" || $orderid_cond == "ep" || $orderid_cond == "ne")
      {
         $this->monta_condicao("orderid", $orderid_cond, $orderid, "", "orderid");
      }

      //----- $productid
      $this->Date_part = false;
      if (isset($productid) || $productid_cond == "nu" || $productid_cond == "nn" || $productid_cond == "ep" || $productid_cond == "ne")
      {
         $this->monta_condicao("productid", $productid_cond, $productid, "", "productid");
      }

      //----- $quantity
      $this->Date_part = false;
      if (isset($quantity) || $quantity_cond == "nu" || $quantity_cond == "nn" || $quantity_cond == "ep" || $quantity_cond == "ne")
      {
         $this->monta_condicao("quantity", $quantity_cond, $quantity, "", "quantity");
      }

      //----- $unitprice
      $this->Date_part = false;
      if (isset($unitprice) || $unitprice_cond == "nu" || $unitprice_cond == "nn" || $unitprice_cond == "ep" || $unitprice_cond == "ne")
      {
         $this->monta_condicao("unitprice", $unitprice_cond, $unitprice, "", "unitprice");
      }

      //----- $total
      $this->Date_part = false;
      if (isset($total) || $total_cond == "nu" || $total_cond == "nn" || $total_cond == "ep" || $total_cond == "ne")
      {
         $this->monta_condicao("total", $total_cond, $total, "", "total");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['fast_search']);
