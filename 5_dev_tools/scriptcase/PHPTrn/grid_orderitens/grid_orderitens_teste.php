<?php  
  ...
  session_start() ;
  class grid_orderitens_form_teste
  {
  function grid_orderitens_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_orderitens</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_orderitens.php" 
               target="_self"> 
...
<input type=submit value="grid_orderitens"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_orderitens_form_teste();
  $frm_teste->grid_orderitens_teste();
?>
