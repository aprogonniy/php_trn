...
class grid_orderitens_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grid_orderitens.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['rtf_name']);
      }
   ...
   function NM_export_productid()
   {
         ...
         $this->look_productid = str_replace('<', '&lt;', $this->look_productid);
         $this->look_productid = str_replace('>', '&gt;', $this->look_productid);
         $this->texto_tag .= "<td>" . $this->look_productid . "</td>\r\n";
   }
   //----- quantity
   ...
   function NM_export_unitprice()
   {
         ...
         $this->unitprice = str_replace('<', '&lt;', $this->unitprice);
         $this->unitprice = str_replace('>', '&gt;', $this->unitprice);
         $this->texto_tag .= "<td>" . $this->unitprice . "</td>\r\n";
   }
   //----- total
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_orderitens'] ?> :: RTF</TITLE>
