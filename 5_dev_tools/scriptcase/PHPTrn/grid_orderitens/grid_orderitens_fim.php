...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_orderitens"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_orderitens"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_orderitens']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_orderitens']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_orderitens']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_orderitens']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_orderitens']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_orderitens']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_orderitens']['embutida_filho'] as $ind => $sc_init)
          {
