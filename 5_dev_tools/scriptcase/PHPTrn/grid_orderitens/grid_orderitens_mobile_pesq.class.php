...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "orderid";$Nm_numeric[] = "productid";$Nm_numeric[] = "quantity";$Nm_numeric[] = "unitprice";$Nm_numeric[] = "total";$Nm_numeric[] = "orderid";$Nm_numeric[] = "productid";$Nm_numeric[] = "quantity";$Nm_numeric[] = "unitprice";$Nm_numeric[] = "total";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_orderid"  <?php echo $str_hide_orderid?>><INPUT  type="text" id="SC_orderid" name="orderid" value="<?php echo NM_encode_input($orderid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_productid"  <?php echo $str_hide_productid?>><INPUT  type="text" id="SC_productid" name="productid" value="<?php echo NM_encode_input($productid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_quantity"  <?php echo $str_hide_quantity?>><INPUT  type="text" id="SC_quantity" name="quantity" value="<?php echo NM_encode_input($quantity) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_unitprice"  <?php echo $str_hide_unitprice?>><INPUT  type="text" id="SC_unitprice" name="unitprice" value="<?php echo NM_encode_input($unitprice) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_total"  <?php echo $str_hide_total?>><INPUT  type="text" id="SC_total" name="total" value="<?php echo NM_encode_input($total) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
