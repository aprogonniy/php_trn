...
class grid_orderitens_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_orderitens.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_orderitens";
   ...
   {
         nmgp_Form_Num_Val($this->look_productid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_productid))
         {
             $this->look_productid = mb_convert_encoding($this->look_productid, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " productid =\"" . $this->trata_dados($this->look_productid) . "\"";
   }
   //----- quantity
   function NM_export_quantity()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->quantity))
         {
             $this->quantity = mb_convert_encoding($this->quantity, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " quantity =\"" . $this->trata_dados($this->quantity) . "\"";
   }
   //----- unitprice
   function NM_export_unitprice()
   {
         nmgp_Form_Num_Val($this->unitprice, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->unitprice))
         {
             $this->unitprice = mb_convert_encoding($this->unitprice, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " unitprice =\"" . $this->trata_dados($this->unitprice) . "\"";
   }
   //----- total
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orderitens']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_orderitens'] ?> :: XML</TITLE>
...
<FORM name="F0" method=post action="grid_orderitens.php" style="display: none"> 
