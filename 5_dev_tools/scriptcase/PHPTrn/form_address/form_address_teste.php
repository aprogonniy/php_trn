<?php  
  session_start() ;
  class form_address_form_teste
  {
   function form_address_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_address/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_address</FONT></B> 
<br> 
...
<input type="submit" value="form_address"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_address_form_teste();
  $frm_teste->form_address_teste();
?>
