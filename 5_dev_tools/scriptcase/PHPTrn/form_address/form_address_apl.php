...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_address']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_address']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_address']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_address']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_address']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_address']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_address']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_address']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_address']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_address']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_address']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_address']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_address']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_address']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_address_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_address']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_address'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_address']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_address']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_address') . "/form_address.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_address']['label'] = "" . $this->Ini->Nm_lang['lang_tble_address'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_address']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_address'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_call'] : $this->Embutida_call;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_address.php"; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_address']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_address']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_address']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_address']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_address']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_address']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_btn_nav'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_address']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_address']['insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_address']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_address']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_address']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_address']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_address']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_address']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_address", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_address_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_address_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_address/form_address_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_address_erro.class.php"); 
      }
      $this->Erro      = new form_address_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opcao']))
         { 
             if ($this->addressid != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_address']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_address']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_address.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['recarga'] = $this->nmgp_opcao;
...
//---------------------------------------------------------
    ...
    function ValidateField_description(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['description']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['description'] == "on")) 
      { 
          if ($this->description == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['address1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['address1'] == "on")) 
      { 
          if ($this->address1 == "")  
          { 
    ...
    function ValidateField_country(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['country']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['country'] == "on")
        { 
    ...
    {
        global $teste_validade;
               if (!empty($this->states) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_states']) && !in_array($this->states, $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_states']))
               {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['city']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['city'] == "on")) 
      { 
          if ($this->city == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['phone1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['phone1'] == "on")) 
      { 
          if ($this->phone1 == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['postalcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['postalcode'] == "on")) 
      { 
          if ($this->postalcode == "")  
          { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['addressid']['keyVal'] = form_address_pack_protect_string($this->nmgp_dados_form['addressid']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_country']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_country'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_country']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_country'] = array(); 
}
$aLookup[] = array(form_address_pack_protect_string('') => form_address_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_country'][] = '';
...
order by name";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_address_pack_protect_string($rs->fields[0]) => form_address_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_country'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_states']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_states'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_states']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_states'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
order by name";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['Lookup_states'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->phone2 = $this->phone2_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              }
              $this->nm_flag_iframe = true;
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['parms'] = "addressid?#?$this->addressid?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_address = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total'] = $qt_geral_reg_form_address;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->addressid))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_address = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] > $qt_geral_reg_form_address)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] = $qt_geral_reg_form_address; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_address) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] < $qt_geral_reg_form_address;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['dados_select'];
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] + 1;
...
{
$_SESSION['scriptcase']['form_address']['contr_erro'] = 'on';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_address_form0.php");
 }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_address_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opc_ant']);
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['sc_modal'])
   {
?>
