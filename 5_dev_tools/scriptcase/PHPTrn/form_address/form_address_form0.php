...
<?php
include_once("form_address_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_address_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['recarga'];
}
?>
...
<?php
 include_once("form_address_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_address'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_address'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col) { echo "<table style=\"border-collapse: collapse; height: 100%; width: 100%\"><tr><td style=\"vertical-align: middle; border-width: 0px; padding: 0px 2px 0px 0px\"><img src=\"" . $this->Ini->path_icones . "/" . $this->Ini->Block_img_col . "\" style=\"border: 0px; float: left\" class=\"sc-ui-block-control\"></td><td style=\"border-width: 0px; padding: 0px; width: 100%;\" class=\"scFormBlockAlign\">"; } ?><?php echo $this->Ini->Nm_lang['lang_address_fild_description'] ?><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col) { echo "</td></tr></table>"; } ?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_address1" style="<?php echo $sStyleHidden_address1; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_address1"><?php echo $this->nm_new_label['address1']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['address1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['address1'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_country" style="<?php echo $sStyleHidden_country; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_country"><?php echo $this->nm_new_label['country']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['country']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['country'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
order by name";
   ...
   echo " </select></span>" ; 
   echo "\r" ; 
 ?>&nbsp;<?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_country", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_country_edit . "?script_case_init=" . $this->Ini->sc_page . "&script_case_session=" . session_id() . "&nmgp_url_saida=modal&nmgp_parms=sc_redir_atualiz*scinok*scout&nmgp_outra_jan=true&nm_evt_ret_edit=do_ajax_form_address_lkpedt_refresh_country&KeepThis=true&TB_iframe=true&height=320&width=300&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_city" style="<?php echo $sStyleHidden_city; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_city"><?php echo $this->nm_new_label['city']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['city']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['city'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_phone1" style="<?php echo $sStyleHidden_phone1; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_phone1"><?php echo $this->nm_new_label['phone1']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['phone1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['phone1'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_postalcode" style="<?php echo $sStyleHidden_postalcode; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_postalcode"><?php echo $this->nm_new_label['postalcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['postalcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['php_cmp_required']['postalcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_address");
 parent.scAjaxDetailHeight("form_address", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
