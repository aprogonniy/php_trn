<?php  
  session_start() ;
  class form_customers_new_customer_form_teste
  {
   function form_customers_new_customer_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_customers_new_customer/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_customers_new_customer</FONT></B> 
<br> 
<form name="Fedit" method="post" 
               action="form_customers_new_customer.php" 
               target="_self"> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/><input type="hidden" name="nmgp_outra_jan" value="true"/><input type="hidden" name="NM_contr_var_session" value="Yes"> 
customersid&nbsp;&nbsp;<input type=text name=customersid size=20><br> 
<input type="submit" value="form_customers_new_customer"> 
</form> 
<script language=javascript> 
 document.Fedit.customersid.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_customers_new_customer_form_teste();
  $frm_teste->form_customers_new_customer_teste();
?>
