...
class grid_orders_customer_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_orders_customer_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['contr_total_geral'] == "OK")
      {
          $this->array_total_customerid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['arr_total']['customerid'];
      }
      else
      {
          $this->array_total_customerid = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['arr_total']['customerid'] = $this->array_total_customerid;
   ...
   function completeMatrix()
   {
       ...
       //-----
       $this->comp_field = array(
           "" . $this->Ini->Nm_lang['lang_orders_fild_customerid'] . "",
       );
       ...
       $this->comp_sum = array(
           ...
           2 => "" .  $this->Ini->Nm_lang['lang_orders_fild_total'] . "(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['summarizing_fields_control'] = array(
               'NM_Count' => array(
               ...
               'total' => array(
                   'label' => "" .  $this->Ini->Nm_lang['lang_orders_fild_total'] . "(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_orders_fild_total'] . "",
                   'options' => array(
                       array('op' => 'S', 'index' => '2', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "", 'abbrev' => "Sum"),
                   ),
                   'select' => "<select class=\"sc-ui-select-total\" onChange=\"scSummChange($(this))\"><option value=\"2\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
       }
       //-----
       ...
       //-----
       foreach ($this->array_total_customerid as $i_customerid => $d_customerid) {
           if (!in_array($i_customerid, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_customerid[3] ] = $d_customerid[2];
               $this->comp_label[0][ $d_customerid[3] ] = $d_customerid[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_customerid => $l_customerid) {
           if (isset($this->array_total_customerid[$i_customerid])) {
               $this->comp_group[$i_customerid] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_customerid;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("" . $this->Ini->Nm_lang['lang_orders_fild_customerid'] . ""),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           '0|1' => array(
               'title'    => $this->getChartText("" .  $this->Ini->Nm_lang['lang_orders_fild_total'] . "(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("" . $this->Ini->Nm_lang['lang_orders_fild_customerid'] . ""),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_orders_fild_total'] . "(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_orders_customer_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_orders_customer_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 1)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']);
       }
       return $valor_campo;
   }
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_orders_customer_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] = "print";
      ...
      $this->total   = new grid_orders_customer_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_groupby_1("res", $this->array_total_customerid);
      ksort($this->array_total_customerid);
      if ("out" == $this->tipo)
      {
         $this->total->quebra_geral();
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_orders_customer_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_orders_customer_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_orders_customer_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" <style type=\"text/css\">\r\n");
       ...
       $nm_saida->saida(" .res_total_sum_label { text-align: right; vertical-align: top }\r\n");
       $nm_saida->saida(" .res_total_sum_field { text-align: right; vertical-align: top }\r\n");
      $nm_saida->saida(" </style>\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_orders_customer/grid_orders_customer_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_orders_customer/grid_orders_customer_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&language=en_us&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_orders_customer/grid_orders_customer_config_graf_flash.php?nome_apl=grid_orders_customer&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
      ...
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_orders_customer_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_orders_customer_config_pivot.php?nome_apl=grid_orders_customer&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("}\r\n");
       $nm_saida->saida("</script>\r\n");
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"grid_orders_customer.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"grid_orders_customer.php\"\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_orders_customer/grid_orders_customer_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_orders_customer/grid_orders_customer_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_orders_customer_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['num_css'] . '.css', 'a');
           @fwrite($NM_css, " .res_NM_Count__field { text-align: right }\r\n");
           @fwrite($NM_css, " .res_total_sum_label { text-align: right; vertical-align: top }\r\n");
           @fwrite($NM_css, " .res_total_sum_field { text-align: right; vertical-align: top }\r\n");
           @fclose($NM_css);
       }
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['print_all'];
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_customerid, $quebra_customerid_orig)
   {
      //----- customerid
      if (!isset($this->array_total_customerid[$quebra_customerid_orig]))
      {
         $this->array_total_customerid[$quebra_customerid_orig][0] = 1;
         $this->array_total_customerid[$quebra_customerid_orig][1] = $sum_total;
         $this->array_total_customerid[$quebra_customerid_orig][2] = $quebra_customerid;
         $this->array_total_customerid[$quebra_customerid_orig][3] = $quebra_customerid_orig;
      }
      else
      {
         $this->array_total_customerid[$quebra_customerid_orig][0]++;
         $this->array_total_customerid[$quebra_customerid_orig][1] += $sum_total;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->orderid = $rs_res->fields[0] ;  
            $this->status = $rs_res->fields[1] ;  
            $this->total = $rs_res->fields[2] ;  
            $this->total =  str_replace(",", ".", $this->total);
            $this->customerid = $rs_res->fields[3] ;  
            $this->customerid_orig = $this->customerid;
            $this->look_customerid = $this->customerid; 
            $this->Lookup->lookup_customerid($this->look_customerid, $this->customerid) ; 
            $this->customerid = $this->look_customerid ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->customerid, $this->customerid_orig);
            }
   }
//
