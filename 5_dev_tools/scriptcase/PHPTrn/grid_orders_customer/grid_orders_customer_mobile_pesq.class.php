...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "order_date";$Nm_numeric[] = "orderid";$Nm_numeric[] = "customerid";$Nm_numeric[] = "status";$Nm_numeric[] = "total";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_customerid"  <?php echo $str_hide_customerid?>><INPUT  type="text" id="SC_customerid" name="customerid" value="<?php echo NM_encode_input($customerid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_status"  <?php echo $str_hide_status?>><INPUT  type="text" id="SC_status" name="status" value="<?php echo NM_encode_input($status) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_total"  <?php echo $str_hide_total?>><INPUT  type="text" id="SC_total" name="total" value="<?php echo NM_encode_input($total) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
