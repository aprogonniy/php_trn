...
class grid_orders_customer_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_orders_customer_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_orders_customer_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_orders_customer_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_orders_customer_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['decimal_db'] == ".")
         {
            $nm_aspas = "";
         }
         if ($condicao != "IN")
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_orders_customer.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_orders'] ?></TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_orders_customer_ajax_search.js"></script>
 <script type="text/javascript" src="grid_orders_customer_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_customerid_cond#NMF#' + search_get_sel_txt('SC_customerid_cond') + '@NMF@';
  str_out += 'SC_customerid#NMF#' + search_get_text('SC_customerid') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_orders_customer.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_orders'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $orderid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['orderid']; 
          $orderid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['orderid_cond']; 
          $customerid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['customerid']; 
          $customerid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['customerid_cond']; 
          $status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['status']; 
          $status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['status_cond']; 
          $total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['total']; 
          $total_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['total_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['NM_operador']; 
          ...
          if (strtoupper($customerid_cond) != "II" && strtoupper($customerid_cond) != "QP" && strtoupper($customerid_cond) != "NP" && strtoupper($customerid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($customerid, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($status_cond) != "II" && strtoupper($status_cond) != "QP" && strtoupper($status_cond) != "NP" && strtoupper($status_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($status, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
      ...
      if (!isset($customerid_cond) || empty($customerid_cond))
      {
         $customerid_cond = "eq";
      }
      if (!isset($status_cond) || empty($status_cond))
      {
         $status_cond = "eq";
      }
      ...
      $str_hide_customerid = (in_array($customerid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($customerid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $customerid = substr($customerid, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_orders_customer_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['orderid'])) ? $this->New_label['orderid'] : "" . $this->Ini->Nm_lang['lang_orders_fild_orderid'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<INPUT  type="text" id="SC_orderid" name="orderid" value="<?php echo NM_encode_input($orderid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['customerid'])) ? $this->New_label['customerid'] : "" . $this->Ini->Nm_lang['lang_orders_fild_customerid'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_customerid_cond" name="customerid_cond" onChange="nm_campos_between(document.getElementById('id_vis_customerid'), this, 'customerid')">
       <OPTION value="eq" <?php if ("eq" == $customerid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $customerid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $customerid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $customerid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_customerid" <?php echo $str_hide_customerid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['customerid'])) ? $this->New_label['customerid'] : "" . $this->Ini->Nm_lang['lang_orders_fild_customerid'] . "";
 $nmgp_tab_label .= "customerid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_customerid" name="customerid" value="<?php echo NM_encode_input($customerid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['status'])) ? $this->New_label['status'] : "" . $this->Ini->Nm_lang['lang_orders_fild_status'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_status_cond" name="status_cond" onChange="nm_campos_between(document.getElementById('id_vis_status'), this, 'status')">
       <OPTION value="eq" <?php if ("eq" == $status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_status" <?php echo $str_hide_status?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_status" name="status" value="<?php echo NM_encode_input($status) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['total'])) ? $this->New_label['total'] : "" . $this->Ini->Nm_lang['lang_orders_fild_total'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_total_cond" name="total_cond" onChange="nm_campos_between(document.getElementById('id_vis_total'), this, 'total')">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_total" name="total" value="<?php echo NM_encode_input($total) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_orders_customer']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_orders_customer']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_orders_customer.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_customerid'), document.F1.customerid_cond, 'customerid');
   document.F1.customerid.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "PHPTrn/grid_orders_customer";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_customerid_cond'] = 'cond';
      $tp_fields['SC_customerid'] = 'text';
      $tp_fields['SC_status_cond'] = 'cond';
      $tp_fields['SC_status'] = 'text';
   ...
   function trata_campos()
   {
      ...
      $customerid_cond_salva = $customerid_cond; 
      if (!isset($customerid_input_2) || $customerid_input_2 == "")
      {
          $customerid_input_2 = $customerid;
      }
      ...
      if ($customerid_cond != "in")
      {
          nm_limpa_numero($customerid, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $customerid);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, "."); 
          ...
          $customerid = implode(",", $Nm_sc_valores);
      }
      if ($status_cond != "in")
      {
          nm_limpa_numero($status, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $status);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, "."); 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['orderid'] = $orderid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['orderid_cond'] = $orderid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['customerid'] = $customerid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['customerid_cond'] = $customerid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['status'] = $status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['status_cond'] = $status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['total'] = $total; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['total_cond'] = $total_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['customerid'] = $Conteudo;
      $Conteudo = $status;
      if (strtoupper($status_cond) != "II" && strtoupper($status_cond) != "QP" && strtoupper($status_cond) != "NP" && strtoupper($status_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['status'] = $Conteudo;
      $Conteudo = $total;
      if (strtoupper($total_cond) != "II" && strtoupper($total_cond) != "QP" && strtoupper($total_cond) != "NP" && strtoupper($total_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      ...
      //----- $customerid
      $this->Date_part = false;
      if (isset($customerid) || $customerid_cond == "nu" || $customerid_cond == "nn" || $customerid_cond == "ep" || $customerid_cond == "ne")
      {
         $this->monta_condicao("customerid", $customerid_cond, $customerid, "", "customerid");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orders_customer']['fast_search']);
