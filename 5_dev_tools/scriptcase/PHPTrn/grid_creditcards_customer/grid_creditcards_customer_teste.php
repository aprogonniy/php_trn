<?php  
  ...
  session_start() ;
  class grid_creditcards_customer_form_teste
  {
  function grid_creditcards_customer_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_creditcards_customer</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_creditcards_customer.php" 
               target="_self"> 
v_cust&nbsp;&nbsp;<input type=text name="v_cust" size=20><br> 
...
<input type=submit value="grid_creditcards_customer"> 
</form> 
<script language=javascript> 
 document.FCons.v_cust.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_creditcards_customer_form_teste();
  $frm_teste->grid_creditcards_customer_teste();
?>
