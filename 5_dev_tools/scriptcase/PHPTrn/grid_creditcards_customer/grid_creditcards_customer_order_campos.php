<?php
   ...
   session_start();
    $Ord_Cmp = new grid_creditcards_customer_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_creditcards_customer_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['cardtypeid'] = "on";
   $tab_def_campos['cardtypeid'] = "cardtypeid";
   $tab_converte["cardtypeid"]   = "cardtypeid";
   $tab_labels["cardtypeid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['labels']["cardtypeid"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['labels']["cardtypeid"] : "" . $this->Nm_lang['lang_creditcards_fild_cardtypeid'] . "";
   $tab_ger_campos['cardholder'] = "on";
   $tab_def_campos['cardholder'] = "cardholder";
   $tab_converte["cardholder"]   = "cardholder";
   $tab_labels["cardholder"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['labels']["cardholder"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['labels']["cardholder"] : "" . $this->Nm_lang['lang_creditcards_fild_cardholder'] . "";
   $tab_ger_campos['cardnumber'] = "on";
   $tab_def_campos['cardnumber'] = "cardnumber";
   $tab_converte["cardnumber"]   = "cardnumber";
   $tab_labels["cardnumber"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['labels']["cardnumber"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['labels']["cardnumber"] : "" . $this->Nm_lang['lang_creditcards_fild_cardnumber'] . "";
   $tab_ger_campos['expirationdate'] = "on";
   $tab_def_campos['expirationdate'] = "expirationdate";
   $tab_converte["expirationdate"]   = "expirationdate";
   $tab_labels["expirationdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['labels']["expirationdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['labels']["expirationdate"] : "" . $this->Nm_lang['lang_creditcards_fild_expirationdate'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_tble_creditcards'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_creditcards_customer_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_creditcards_customer']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
