...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
      type: "POST",
      url: "grid_creditcards_customer.php",
      ...
      success: function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_creditcards_customer').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_creditcards_customer').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_creditcards_customer').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_creditcards_customer').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_creditcards_customer').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_creditcards_customer').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_creditcards_customer').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_creditcards_customer').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_creditcards_customer').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_creditcards_customer').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_creditcards_customer').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_creditcards_customer').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
