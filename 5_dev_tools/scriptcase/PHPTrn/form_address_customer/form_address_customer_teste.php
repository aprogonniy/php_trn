<?php  
  session_start() ;
  class form_address_customer_form_teste
  {
   function form_address_customer_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_address_customer/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_address_customer</FONT></B> 
<br> 
...
<input type="submit" value="form_address_customer"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_address_customer_form_teste();
  $frm_teste->form_address_customer_teste();
?>
