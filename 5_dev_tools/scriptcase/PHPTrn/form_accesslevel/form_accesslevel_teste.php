<?php  
  session_start() ;
  class form_accesslevel_form_teste
  {
   function form_accesslevel_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_accesslevel/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_accesslevel</FONT></B> 
<br> 
...
<input type="submit" value="form_accesslevel"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_accesslevel_form_teste();
  $frm_teste->form_accesslevel_teste();
?>
