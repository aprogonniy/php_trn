<?php  
  ...
  session_start() ;
  class grid_systemuser_form_teste
  {
  function grid_systemuser_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_systemuser_form_teste();
  $frm_teste->grid_systemuser_teste();
?>
