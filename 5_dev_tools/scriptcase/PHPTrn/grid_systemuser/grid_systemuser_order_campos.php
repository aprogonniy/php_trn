<?php
   ...
   session_start();
    $Ord_Cmp = new grid_systemuser_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_systemuser_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['accesslevelid'] = "on";
   $tab_def_campos['accesslevelid'] = "accesslevelid";
   $tab_converte["accesslevelid"]   = "accesslevelid";
   $tab_labels["accesslevelid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["accesslevelid"])) ? $_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["accesslevelid"] : "" . $this->Nm_lang['lang_systemuser_fild_accesslevelid'] . "";
   $tab_ger_campos['departmentid'] = "on";
   $tab_def_campos['departmentid'] = "departmentid";
   $tab_converte["departmentid"]   = "departmentid";
   $tab_labels["departmentid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["departmentid"])) ? $_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["departmentid"] : "" . $this->Nm_lang['lang_systemuser_fild_departmentid'] . "";
   $tab_ger_campos['login'] = "on";
   $tab_def_campos['login'] = "login";
   $tab_converte["login"]   = "login";
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["login"] : "" . $this->Nm_lang['lang_systemuser_fild_login'] . "";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_converte["name"]   = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["name"] : "" . $this->Nm_lang['lang_systemuser_fild_name'] . "";
   ...
   $tab_labels["changepassword"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["changepassword"])) ? $_SESSION['sc_session'][$sc_init]['grid_systemuser']['labels']["changepassword"] : " ";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_systemuser']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_systemuser']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_systemuser']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_systemuser']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_systemuser']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_systemuser']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_systemuser']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_systemuser']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_systemuser']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_tble_systemuser'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_systemuser_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_systemuser']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_systemuser']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
