...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "systemuserid";$Nm_numeric[] = "accesslevelid";$Nm_numeric[] = "departmentid";$Nm_numeric[] = "systemuserid";$Nm_numeric[] = "accesslevelid";$Nm_numeric[] = "departmentid";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_systemuserid"  <?php echo $str_hide_systemuserid?>><INPUT  type="text" id="SC_systemuserid" name="systemuserid" value="<?php echo NM_encode_input($systemuserid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_accesslevelid"  <?php echo $str_hide_accesslevelid?>><INPUT  type="text" id="SC_accesslevelid" name="accesslevelid" value="<?php echo NM_encode_input($accesslevelid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_departmentid"  <?php echo $str_hide_departmentid?>><INPUT  type="text" id="SC_departmentid" name="departmentid" value="<?php echo NM_encode_input($departmentid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_login"  <?php echo $str_hide_login?>><INPUT  type="text" id="SC_login" name="login" value="<?php echo NM_encode_input($login) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_passwd"  <?php echo $str_hide_passwd?>><INPUT  type="text" id="SC_passwd" name="passwd" value="<?php echo NM_encode_input($passwd) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_name"  <?php echo $str_hide_name?>><INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
