...
class grid_systemuser_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_systemuser_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_systemuser_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_systemuser_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "systemuserid";$Nm_numeric[] = "accesslevelid";$Nm_numeric[] = "departmentid";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['decimal_db'] == ".")
         {
            $nm_aspas = "";
         }
         if ($condicao != "IN")
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_systemuser.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_systemuser'] ?></TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_systemuser_ajax_search.js"></script>
 <script type="text/javascript" src="grid_systemuser_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_systemuserid_cond#NMF#' + search_get_sel_txt('SC_systemuserid_cond') + '@NMF@';
  str_out += 'SC_systemuserid#NMF#' + search_get_text('SC_systemuserid') + '@NMF@';
  str_out += 'SC_accesslevelid_cond#NMF#' + search_get_sel_txt('SC_accesslevelid_cond') + '@NMF@';
  str_out += 'SC_accesslevelid#NMF#' + search_get_text('SC_accesslevelid') + '@NMF@';
  str_out += 'SC_departmentid_cond#NMF#' + search_get_sel_txt('SC_departmentid_cond') + '@NMF@';
  str_out += 'SC_departmentid#NMF#' + search_get_text('SC_departmentid') + '@NMF@';
  str_out += 'SC_login_cond#NMF#' + search_get_sel_txt('SC_login_cond') + '@NMF@';
  str_out += 'SC_login#NMF#' + search_get_text('SC_login') + '@NMF@';
  str_out += 'SC_passwd_cond#NMF#' + search_get_sel_txt('SC_passwd_cond') + '@NMF@';
  str_out += 'SC_passwd#NMF#' + search_get_text('SC_passwd') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_systemuser.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_systemuser'] ?></span></td>
...
<?php
   ...
   {
      global 
             $systemuserid_cond, $systemuserid,
             $accesslevelid_cond, $accesslevelid,
             $departmentid_cond, $departmentid,
             $login_cond, $login,
             $passwd_cond, $passwd,
             $name_cond, $name,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $systemuserid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['systemuserid']; 
          $systemuserid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['systemuserid_cond']; 
          $accesslevelid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['accesslevelid']; 
          $accesslevelid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['accesslevelid_cond']; 
          $departmentid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['departmentid']; 
          $departmentid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['departmentid_cond']; 
          $login = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['login']; 
          $login_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['login_cond']; 
          $passwd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['passwd']; 
          $passwd_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['passwd_cond']; 
          $name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['name']; 
          $name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['name_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['NM_operador']; 
          if (strtoupper($systemuserid_cond) != "II" && strtoupper($systemuserid_cond) != "QP" && strtoupper($systemuserid_cond) != "NP" && strtoupper($systemuserid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($systemuserid, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($accesslevelid_cond) != "II" && strtoupper($accesslevelid_cond) != "QP" && strtoupper($accesslevelid_cond) != "NP" && strtoupper($accesslevelid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($accesslevelid, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($departmentid_cond) != "II" && strtoupper($departmentid_cond) != "QP" && strtoupper($departmentid_cond) != "NP" && strtoupper($departmentid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($departmentid, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
      } 
      if (!isset($systemuserid_cond) || empty($systemuserid_cond))
      {
         $systemuserid_cond = "eq";
      }
      if (!isset($accesslevelid_cond) || empty($accesslevelid_cond))
      {
         $accesslevelid_cond = "eq";
      }
      if (!isset($departmentid_cond) || empty($departmentid_cond))
      {
         $departmentid_cond = "eq";
      }
      if (!isset($login_cond) || empty($login_cond))
      {
         $login_cond = "eq";
      }
      if (!isset($passwd_cond) || empty($passwd_cond))
      {
         $passwd_cond = "eq";
      }
      if (!isset($name_cond) || empty($name_cond))
      {
         $name_cond = "eq";
      }
      ...
      $str_hide_systemuserid = (in_array($systemuserid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_accesslevelid = (in_array($accesslevelid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_departmentid = (in_array($departmentid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_login = (in_array($login_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_passwd = (in_array($passwd_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_name = (in_array($name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($systemuserid) || $systemuserid == "")
      {
          $systemuserid = "";
      }
      if (isset($systemuserid) && !empty($systemuserid))
      {
         $tmp_pos = strpos($systemuserid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $systemuserid = substr($systemuserid, 0, $tmp_pos);
         }
      }
      if (!isset($accesslevelid) || $accesslevelid == "")
      {
          $accesslevelid = "";
      }
      if (isset($accesslevelid) && !empty($accesslevelid))
      {
         $tmp_pos = strpos($accesslevelid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $accesslevelid = substr($accesslevelid, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($departmentid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $departmentid = substr($departmentid, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($passwd, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $passwd = substr($passwd, 0, $tmp_pos);
         }
      }
      if (!isset($name) || $name == "")
      {
...
<?php
   if (is_file("grid_systemuser_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['systemuserid'])) ? $this->New_label['systemuserid'] : "" . $this->Ini->Nm_lang['lang_systemuser_fild_systemuserid'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_systemuserid_cond" name="systemuserid_cond" onChange="nm_campos_between(document.getElementById('id_vis_systemuserid'), this, 'systemuserid')">
       <OPTION value="eq" <?php if ("eq" == $systemuserid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $systemuserid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $systemuserid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $systemuserid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_systemuserid" <?php echo $str_hide_systemuserid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['systemuserid'])) ? $this->New_label['systemuserid'] : "" . $this->Ini->Nm_lang['lang_systemuser_fild_systemuserid'] . "";
 $nmgp_tab_label .= "systemuserid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_systemuserid" name="systemuserid" value="<?php echo NM_encode_input($systemuserid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['accesslevelid'])) ? $this->New_label['accesslevelid'] : "" . $this->Ini->Nm_lang['lang_systemuser_fild_accesslevelid'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_accesslevelid_cond" name="accesslevelid_cond" onChange="nm_campos_between(document.getElementById('id_vis_accesslevelid'), this, 'accesslevelid')">
       <OPTION value="eq" <?php if ("eq" == $accesslevelid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $accesslevelid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $accesslevelid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $accesslevelid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_accesslevelid" <?php echo $str_hide_accesslevelid?> valign="top">
 ...
 $nmgp_tab_label .= "accesslevelid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_accesslevelid" name="accesslevelid" value="<?php echo NM_encode_input($accesslevelid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['departmentid'])) ? $this->New_label['departmentid'] : "" . $this->Ini->Nm_lang['lang_systemuser_fild_departmentid'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_departmentid_cond" name="departmentid_cond" onChange="nm_campos_between(document.getElementById('id_vis_departmentid'), this, 'departmentid')">
       <OPTION value="eq" <?php if ("eq" == $departmentid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $departmentid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $departmentid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $departmentid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_departmentid" <?php echo $str_hide_departmentid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 ...
 $nmgp_tab_label .= "departmentid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_departmentid" name="departmentid" value="<?php echo NM_encode_input($departmentid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['login'])) ? $this->New_label['login'] : "" . $this->Ini->Nm_lang['lang_systemuser_fild_login'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_login_cond" name="login_cond" onChange="nm_campos_between(document.getElementById('id_vis_login'), this, 'login')">
       <OPTION value="eq" <?php if ("eq" == $login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $login_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_login" name="login" value="<?php echo NM_encode_input($login) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['passwd'])) ? $this->New_label['passwd'] : "" . $this->Ini->Nm_lang['lang_systemuser_fild_passwd'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_passwd_cond" name="passwd_cond" onChange="nm_campos_between(document.getElementById('id_vis_passwd'), this, 'passwd')">
       <OPTION value="eq" <?php if ("eq" == $passwd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $passwd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $passwd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $passwd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_passwd" <?php echo $str_hide_passwd?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['passwd'])) ? $this->New_label['passwd'] : "" . $this->Ini->Nm_lang['lang_systemuser_fild_passwd'] . "";
 $nmgp_tab_label .= "passwd?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_passwd" name="passwd" value="<?php echo NM_encode_input($passwd) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['name'])) ? $this->New_label['name'] : "" . $this->Ini->Nm_lang['lang_systemuser_fild_name'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_name_cond" name="name_cond" onChange="nm_campos_between(document.getElementById('id_vis_name'), this, 'name')">
       <OPTION value="eq" <?php if ("eq" == $name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_systemuser']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_systemuser']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_systemuser.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_systemuserid'), document.F1.systemuserid_cond, 'systemuserid');
   document.F1.systemuserid.value = "";
   nm_campos_between(document.getElementById('id_vis_accesslevelid'), document.F1.accesslevelid_cond, 'accesslevelid');
   document.F1.accesslevelid.value = "";
   nm_campos_between(document.getElementById('id_vis_departmentid'), document.F1.departmentid_cond, 'departmentid');
   document.F1.departmentid.value = "";
   nm_campos_between(document.getElementById('id_vis_login'), document.F1.login_cond, 'login');
   document.F1.login.value = "";
   nm_campos_between(document.getElementById('id_vis_passwd'), document.F1.passwd_cond, 'passwd');
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "PHPTrn/grid_systemuser";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_systemuserid_cond'] = 'cond';
      $tp_fields['SC_systemuserid'] = 'text';
      $tp_fields['SC_accesslevelid_cond'] = 'cond';
      $tp_fields['SC_accesslevelid'] = 'text';
      $tp_fields['SC_departmentid_cond'] = 'cond';
      $tp_fields['SC_departmentid'] = 'text';
      $tp_fields['SC_login_cond'] = 'cond';
      $tp_fields['SC_login'] = 'text';
      $tp_fields['SC_passwd_cond'] = 'cond';
      $tp_fields['SC_passwd'] = 'text';
      $tp_fields['SC_name_cond'] = 'cond';
      $tp_fields['SC_name'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $systemuserid_cond, $systemuserid,
             $accesslevelid_cond, $accesslevelid,
             $departmentid_cond, $departmentid,
             $login_cond, $login,
             $passwd_cond, $passwd,
             $name_cond, $name, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $systemuserid_cond_salva = $systemuserid_cond; 
      if (!isset($systemuserid_input_2) || $systemuserid_input_2 == "")
      {
          $systemuserid_input_2 = $systemuserid;
      }
      $accesslevelid_cond_salva = $accesslevelid_cond; 
      if (!isset($accesslevelid_input_2) || $accesslevelid_input_2 == "")
      {
          $accesslevelid_input_2 = $accesslevelid;
      }
      $departmentid_cond_salva = $departmentid_cond; 
      if (!isset($departmentid_input_2) || $departmentid_input_2 == "")
      {
          $departmentid_input_2 = $departmentid;
      }
      ...
      $passwd_cond_salva = $passwd_cond; 
      if (!isset($passwd_input_2) || $passwd_input_2 == "")
      {
          $passwd_input_2 = $passwd;
      }
      ...
      if ($systemuserid_cond != "in")
      {
          nm_limpa_numero($systemuserid, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $systemuserid);
          ...
          $systemuserid = implode(",", $Nm_sc_valores);
      }
      if ($accesslevelid_cond != "in")
      {
          nm_limpa_numero($accesslevelid, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $accesslevelid);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, "."); 
          ...
          $accesslevelid = implode(",", $Nm_sc_valores);
      }
      if ($departmentid_cond != "in")
      {
          nm_limpa_numero($departmentid, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $departmentid);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, "."); 
          ...
          $departmentid = implode(",", $Nm_sc_valores);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['systemuserid'] = $systemuserid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['systemuserid_cond'] = $systemuserid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['accesslevelid'] = $accesslevelid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['accesslevelid_cond'] = $accesslevelid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['departmentid'] = $departmentid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['departmentid_cond'] = $departmentid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['login'] = $login; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['login_cond'] = $login_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['passwd'] = $passwd; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['passwd_cond'] = $passwd_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['name'] = $name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['name_cond'] = $name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $systemuserid;
      if (strtoupper($systemuserid_cond) != "II" && strtoupper($systemuserid_cond) != "QP" && strtoupper($systemuserid_cond) != "NP" && strtoupper($systemuserid_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['systemuserid'] = $Conteudo;
      $Conteudo = $accesslevelid;
      if (strtoupper($accesslevelid_cond) != "II" && strtoupper($accesslevelid_cond) != "QP" && strtoupper($accesslevelid_cond) != "NP" && strtoupper($accesslevelid_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['accesslevelid'] = $Conteudo;
      $Conteudo = $departmentid;
      if (strtoupper($departmentid_cond) != "II" && strtoupper($departmentid_cond) != "QP" && strtoupper($departmentid_cond) != "NP" && strtoupper($departmentid_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['departmentid'] = $Conteudo;
      $Conteudo = $login;
      $this->cmp_formatado['login'] = $Conteudo;
      $Conteudo = $passwd;
      $this->cmp_formatado['passwd'] = $Conteudo;
      $Conteudo = $name;
      $this->cmp_formatado['name'] = $Conteudo;

      //----- $systemuserid
      $this->Date_part = false;
      if (isset($systemuserid) || $systemuserid_cond == "nu" || $systemuserid_cond == "nn" || $systemuserid_cond == "ep" || $systemuserid_cond == "ne")
      {
         $this->monta_condicao("systemuserid", $systemuserid_cond, $systemuserid, "", "systemuserid");
      }

      //----- $accesslevelid
      $this->Date_part = false;
      if (isset($accesslevelid) || $accesslevelid_cond == "nu" || $accesslevelid_cond == "nn" || $accesslevelid_cond == "ep" || $accesslevelid_cond == "ne")
      {
         $this->monta_condicao("accesslevelid", $accesslevelid_cond, $accesslevelid, "", "accesslevelid");
      }

      //----- $departmentid
      $this->Date_part = false;
      if (isset($departmentid) || $departmentid_cond == "nu" || $departmentid_cond == "nn" || $departmentid_cond == "ep" || $departmentid_cond == "ne")
      {
         $this->monta_condicao("departmentid", $departmentid_cond, $departmentid, "", "departmentid");
      }
      ...
      //----- $passwd
      $this->Date_part = false;
      if (isset($passwd) || $passwd_cond == "nu" || $passwd_cond == "nn" || $passwd_cond == "ep" || $passwd_cond == "ne")
      {
         $this->monta_condicao("passwd", $passwd_cond, $passwd, "", "passwd");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_systemuser']['fast_search']);
