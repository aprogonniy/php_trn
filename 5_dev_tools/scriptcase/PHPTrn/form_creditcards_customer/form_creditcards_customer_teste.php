<?php  
  session_start() ;
  class form_creditcards_customer_form_teste
  {
   function form_creditcards_customer_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_creditcards_customer/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_creditcards_customer</FONT></B> 
<br> 
...
<input type="submit" value="form_creditcards_customer"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_creditcards_customer_form_teste();
  $frm_teste->form_creditcards_customer_teste();
?>
