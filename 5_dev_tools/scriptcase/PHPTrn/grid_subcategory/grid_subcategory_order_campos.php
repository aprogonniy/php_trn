<?php
   ...
   session_start();
    $Ord_Cmp = new grid_subcategory_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_subcategory_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subcategory']['labels']["description"])) ? $_SESSION['sc_session'][$sc_init]['grid_subcategory']['labels']["description"] : "" . $this->Nm_lang['lang_subcategory_fild_description'] . "";
   $tab_ger_campos['number_of_products'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['number_of_products'] = "number_of_products";
       $tab_converte["number_of_products"]   = "number_of_products";
   }
   else
   {
       $tab_def_campos['number_of_products'] = "";
       $tab_converte[""]   = "number_of_products";
   }
   $tab_labels["number_of_products"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subcategory']['labels']["number_of_products"])) ? $_SESSION['sc_session'][$sc_init]['grid_subcategory']['labels']["number_of_products"] : "" . $this->Nm_lang['lang_number_of_products'] . "";
   $tab_ger_campos['list_order'] = "on";
   $tab_def_campos['list_order'] = "list_order";
   $tab_converte["list_order"]   = "list_order";
   $tab_labels["list_order"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subcategory']['labels']["list_order"])) ? $_SESSION['sc_session'][$sc_init]['grid_subcategory']['labels']["list_order"] : "" . $this->Nm_lang['lang_list_order'] . "";
   $tab_ger_campos['number_of_products'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_subcategory']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_subcategory']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_subcategory']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_subcategory']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_subcategory']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_subcategory']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_subcategory']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_subcategory']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_subcategory']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_tble_subcategory'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_subcategory_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_subcategory']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_subcategory']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
