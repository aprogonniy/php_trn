...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "subcategoryid";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "list_order";$Nm_numeric[] = "";$Nm_numeric[] = "subcategoryid";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "list_order";$Nm_numeric[] = "";
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_description"  <?php echo $str_hide_description?>><INPUT  type="text" id="SC_description" name="description" value="<?php echo NM_encode_input($description) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
