...
$oExportPdf = new grid_subcategory_export_pdf;
$oExportPdf->exportPdf();

class grid_subcategory_export_pdf {
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_subcategory_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_subcategory']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_subcategory']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_subcategory.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_subcategory']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_subcategory']['pdf_name'] : "grid_subcategory.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
$NM_volta   = (!isset($aParams['nmgp_opcao']) || 'pdf_res' != $aParams['nmgp_opcao']) ? "volta_grid" : "resumo";
?>
<form name="F0" method="post" action="grid_subcategory.php" target="<?php echo $NM_target; ?>" style="display: none"> 
