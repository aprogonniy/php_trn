<?php  
  ...
  session_start() ;
  class grid_subcategory_form_teste
  {
  function grid_subcategory_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_subcategory_form_teste();
  $frm_teste->grid_subcategory_teste();
?>
