<?php  
  ...
  session_start() ;
  class grid_products_list_cat_search_form_teste
  {
  function grid_products_list_cat_search_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_products_list_cat_search</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_products_list_cat_search.php" 
               target="_self"> 
v_where&nbsp;&nbsp;<input type=text name="v_where" size=20><br> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/>
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_products_list_cat_search"> 
</form> 
<script language=javascript> 
 document.FCons.v_where.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_products_list_cat_search_form_teste();
  $frm_teste->grid_products_list_cat_search_teste();
?>
