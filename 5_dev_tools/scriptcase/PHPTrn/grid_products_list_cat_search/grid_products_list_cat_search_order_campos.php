<?php
   ...
   session_start();
    $Ord_Cmp = new grid_products_list_cat_search_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_products_list_cat_search_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["picture"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['labels']["picture"])) ? $_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['labels']["picture"] : "" . $this->Nm_lang['lang_products_fild_picture'] . "";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_converte["name"]   = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['labels']["name"] : "" . $this->Nm_lang['lang_products_fild_name'] . "";
   $tab_ger_campos['price'] = "on";
   $tab_def_campos['price'] = "price";
   $tab_converte["price"]   = "price";
   $tab_labels["price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['labels']["price"])) ? $_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['labels']["price"] : "" . $this->Nm_lang['lang_products_fild_price'] . "";
   $tab_ger_campos['picture'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_products_list_cat_search']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_products_list_cat_search']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_products_list_cat_search']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_products_list_cat_search_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_products_list_cat_search']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
