...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
      type: "POST",
      url: "grid_products_list_cat_search.php",
      ...
      success: function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_products_list_cat_search').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_products_list_cat_search').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_products_list_cat_search').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_products_list_cat_search').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_products_list_cat_search').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_products_list_cat_search').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_products_list_cat_search').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_products_list_cat_search').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_products_list_cat_search').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_products_list_cat_search').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_products_list_cat_search').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_products_list_cat_search').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
