<?php
   ...
   session_start();
    $Ord_Cmp = new grid_products_dependent_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_products_dependent_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_products_dependent']['labels']["name"] : "" . $this->Nm_lang['lang_products_fild_name'] . "";
   $tab_ger_campos['price'] = "on";
   $tab_def_campos['price'] = "price";
   $tab_converte["price"]   = "price";
   $tab_labels["price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['labels']["price"])) ? $_SESSION['sc_session'][$sc_init]['grid_products_dependent']['labels']["price"] : "" . $this->Nm_lang['lang_products_fild_price'] . "";
   $tab_ger_campos['picture'] = "on";
   $tab_def_campos['picture'] = "picture";
   $tab_converte["picture"]   = "picture";
   $tab_labels["picture"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['labels']["picture"])) ? $_SESSION['sc_session'][$sc_init]['grid_products_dependent']['labels']["picture"] : "" . $this->Nm_lang['lang_products_fild_picture'] . "";
   $tab_ger_campos['onhandquantity'] = "on";
   $tab_def_campos['onhandquantity'] = "onhandquantity";
   $tab_converte["onhandquantity"]   = "onhandquantity";
   $tab_labels["onhandquantity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['labels']["onhandquantity"])) ? $_SESSION['sc_session'][$sc_init]['grid_products_dependent']['labels']["onhandquantity"] : "" . $this->Nm_lang['lang_products_fild_onhandquantity'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_products_dependent']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_products_dependent']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_products_dependent']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_products_dependent']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_products_dependent']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_tble_products'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_products_dependent_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_products_dependent']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
