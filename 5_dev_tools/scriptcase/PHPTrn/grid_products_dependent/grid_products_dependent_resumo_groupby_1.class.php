...
class grid_products_dependent_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_categoryid;
   var $array_total_subcategoryid;
   ...
   //---- 
   function grid_products_dependent_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['contr_total_geral'] == "OK")
      {
          $this->array_total_categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['arr_total']['categoryid'];
          $this->array_total_subcategoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['arr_total']['subcategoryid'];
      }
      else
      {
          $this->array_total_categoryid = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['arr_total']['categoryid'] = $this->array_total_categoryid;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['arr_total']['subcategoryid'] = $this->array_total_subcategoryid;
   ...
   function completeMatrix()
   {
       ...
       //-----
       $this->comp_field = array(
           "" . $this->Ini->Nm_lang['lang_products_fild_categoryid'] . "",
           "" . $this->Ini->Nm_lang['lang_products_fild_subcategoryid'] . "",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['summarizing_fields_control'] = array(
               'NM_Count' => array(
       ...
       //-----
       foreach ($this->array_total_categoryid as $i_categoryid => $d_categoryid) {
           if (!in_array($i_categoryid, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_categoryid[2] ] = $d_categoryid[1];
               $this->comp_label[0][ $d_categoryid[2] ] = $d_categoryid[1];
           }
           foreach ($this->array_total_subcategoryid[$i_categoryid] as $i_subcategoryid => $d_subcategoryid) {
               if (!in_array($i_subcategoryid, $this->comp_label[1][ $d_categoryid[2] ], true)) {
                   $this->comp_index[1][ $d_subcategoryid[2] ] = $d_subcategoryid[1];
                   $this->comp_label[1][ $d_categoryid[2] ][ $d_subcategoryid[2] ] = $d_subcategoryid[1];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'categoryid', 'prot' => ''),
           array('name' => 'subcategoryid', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_categoryid => $l_categoryid) {
           if (isset($this->array_total_categoryid[$i_categoryid])) {
               $this->comp_group[$i_categoryid] = array();
           }
           foreach ($this->comp_label[1][$i_categoryid] as $i_subcategoryid => $l_subcategoryid) {
               if (isset($this->array_total_subcategoryid[$i_categoryid][$i_subcategoryid])) {
                   $this->comp_group[$i_categoryid][$i_subcategoryid] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_categoryid;
       }
       elseif (1 == $level) {
           $return = $this->array_total_subcategoryid;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("" . $this->Ini->Nm_lang['lang_products_fild_categoryid'] . ""),
           ...
           '1|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("" . $this->Ini->Nm_lang['lang_products_fild_subcategoryid'] . ""),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           'T|0' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_products_dependent_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_products_dependent_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_products_dependent_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] = "print";
      ...
      $this->total   = new grid_products_dependent_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_groupby_1("res", $this->array_total_categoryid, $this->array_total_subcategoryid);
      ksort($this->array_total_categoryid);
      ksort($this->array_total_subcategoryid);
      if ("out" == $this->tipo)
      {
         $this->total->quebra_geral();
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_products_dependent_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_products_dependent_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_products_dependent_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      $nm_saida->saida("<TABLE id=\"main_table_res\" cellspacing=0 cellpadding=0 align=\"center\" valign=\"top\" >\r\n");
      $nm_saida->saida(" <TR>\r\n");
      $nm_saida->saida("  <TD>\r\n");
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_products_dependent/grid_products_dependent_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_products_dependent/grid_products_dependent_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&language=en_us&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_products_dependent/grid_products_dependent_config_graf_flash.php?nome_apl=grid_products_dependent&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
      ...
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_products_dependent_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_products_dependent_config_pivot.php?nome_apl=grid_products_dependent&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("}\r\n");
       $nm_saida->saida("</script>\r\n");
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"grid_products_dependent.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"grid_products_dependent.php\"\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_products_dependent/grid_products_dependent_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_products_dependent/grid_products_dependent_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_products_dependent_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span></span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_categoryid, $quebra_subcategoryid, $quebra_categoryid_orig, $quebra_subcategoryid_orig)
   {
      //----- categoryid
      if (!isset($this->array_total_categoryid[$quebra_categoryid_orig]))
      {
         $this->array_total_categoryid[$quebra_categoryid_orig][0] = 1;
         $this->array_total_categoryid[$quebra_categoryid_orig][1] = $quebra_categoryid;
         $this->array_total_categoryid[$quebra_categoryid_orig][2] = $quebra_categoryid_orig;
      }
      else
      {
         $this->array_total_categoryid[$quebra_categoryid_orig][0]++;
      }
      //----- subcategoryid
      if (!isset($this->array_total_subcategoryid[$quebra_categoryid_orig][$quebra_subcategoryid_orig]))
      {
         $this->array_total_subcategoryid[$quebra_categoryid_orig][$quebra_subcategoryid_orig][0] = 1;
         $this->array_total_subcategoryid[$quebra_categoryid_orig][$quebra_subcategoryid_orig][1] = $quebra_subcategoryid;
         $this->array_total_subcategoryid[$quebra_categoryid_orig][$quebra_subcategoryid_orig][2] = $quebra_subcategoryid_orig;
      }
      else
      {
         $this->array_total_subcategoryid[$quebra_categoryid_orig][$quebra_subcategoryid_orig][0]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->name = $rs_res->fields[0] ;  
            $this->price = $rs_res->fields[1] ;  
            $this->price =  str_replace(",", ".", $this->price);
            $this->picture = $rs_res->fields[2] ;  
            $this->onhandquantity = $rs_res->fields[3] ;  
            $this->categoryid = $rs_res->fields[4] ;  
            $this->subcategoryid = $rs_res->fields[5] ;  
            $this->shippingid = $rs_res->fields[6] ;  
            $this->measure = $rs_res->fields[7] ;  
            $this->productid = $rs_res->fields[8] ;  
            $this->categoryid_orig = $this->categoryid;
            $this->subcategoryid_orig = $this->subcategoryid;
            $this->look_categoryid = $this->categoryid; 
            $this->Lookup->lookup_categoryid($this->look_categoryid, $this->categoryid) ; 
            $this->look_subcategoryid = $this->subcategoryid; 
            $this->Lookup->lookup_subcategoryid($this->look_subcategoryid, $this->categoryid, $this->subcategoryid) ; 
            $this->categoryid = $this->look_categoryid ;
            $this->subcategoryid = $this->look_subcategoryid ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->categoryid, $this->subcategoryid, $this->categoryid_orig,  $this->subcategoryid_orig);
            }
   }
//
