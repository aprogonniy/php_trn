...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "productid";$Nm_numeric[] = "shippingid";$Nm_numeric[] = "measure";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "subcategoryid";$Nm_numeric[] = "price";$Nm_numeric[] = "onhandquantity";$Nm_numeric[] = "productid";$Nm_numeric[] = "shippingid";$Nm_numeric[] = "measure";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "subcategoryid";$Nm_numeric[] = "price";$Nm_numeric[] = "onhandquantity";
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_categoryid"  <?php echo $str_hide_categoryid?>>
<?php
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_shippingid"  <?php echo $str_hide_shippingid?>>
<?php
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_measure"  <?php echo $str_hide_measure?>>
<?php
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_name"  <?php echo $str_hide_name?>><INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_taxable"  <?php echo $str_hide_taxable?>> 
<?php
