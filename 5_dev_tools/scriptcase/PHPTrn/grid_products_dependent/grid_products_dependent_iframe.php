...
$oExportPdf = new grid_products_dependent_export_pdf;
$oExportPdf->exportPdf();

class grid_products_dependent_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_tble_products'] ?> :: PDF</title>
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_products_dependent_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_products_dependent']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_products_dependent']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_products_dependent.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_products_dependent']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_products_dependent']['pdf_name'] : "grid_products_dependent.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
$NM_volta   = (!isset($aParams['nmgp_opcao']) || 'pdf_res' != $aParams['nmgp_opcao']) ? "volta_grid" : "resumo";
?>
<form name="F0" method="post" action="grid_products_dependent.php" target="<?php echo $NM_target; ?>" style="display: none"> 
