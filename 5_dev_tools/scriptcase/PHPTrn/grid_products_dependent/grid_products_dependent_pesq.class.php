...
class grid_products_dependent_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_products_dependent_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_products_dependent_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_products_dependent_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_products_dependent_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "productid";$Nm_numeric[] = "shippingid";$Nm_numeric[] = "measure";$Nm_numeric[] = "categoryid";$Nm_numeric[] = "subcategoryid";$Nm_numeric[] = "price";$Nm_numeric[] = "onhandquantity";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['decimal_db'] == ".")
         {
            $nm_aspas = "";
         }
         if ($condicao != "IN")
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_products_dependent.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_tble_products'] ?></TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_products_dependent_ajax_search.js"></script>
 <script type="text/javascript" src="grid_products_dependent_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_categoryid_cond#NMF#' + search_get_sel_txt('SC_categoryid_cond') + '@NMF@';
  str_out += 'SC_categoryid#NMF#' + search_get_select('SC_categoryid') + '@NMF@';
  str_out += 'SC_shippingid_cond#NMF#' + search_get_sel_txt('SC_shippingid_cond') + '@NMF@';
  str_out += 'SC_shippingid#NMF#' + search_get_select('SC_shippingid') + '@NMF@';
  str_out += 'SC_measure_cond#NMF#' + search_get_sel_txt('SC_measure_cond') + '@NMF@';
  str_out += 'SC_measure#NMF#' + search_get_select('SC_measure') + '@NMF@';
  str_out += 'SC_name_cond#NMF#' + search_get_sel_txt('SC_name_cond') + '@NMF@';
  str_out += 'SC_name#NMF#' + search_get_text('SC_name') + '@NMF@';
  str_out += 'SC_taxable_cond#NMF#' + search_get_sel_txt('SC_taxable_cond') + '@NMF@';
  str_out += 'SC_taxable#NMF#' + search_get_radio('SC_taxable') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_products_dependent.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<TABLE id="main_table" align="center" valign="top" width="500px">
<tr>
<td>
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_tble_products'] ?></span></td>
...
<?php
   ...
   {
      global 
             $categoryid_cond, $categoryid,
             $shippingid_cond, $shippingid,
             $measure_cond, $measure,
             $name_cond, $name,
             $taxable_cond, $taxable,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $categoryid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['categoryid']; 
          $categoryid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['categoryid_cond']; 
          $shippingid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['shippingid']; 
          $shippingid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['shippingid_cond']; 
          $measure = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['measure']; 
          $measure_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['measure_cond']; 
          $name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['name']; 
          $name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['name_cond']; 
          $taxable = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['taxable']; 
          $taxable_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['taxable_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['NM_operador']; 
      } 
      if (!isset($categoryid_cond) || empty($categoryid_cond))
      {
         $categoryid_cond = "eq";
      }
      if (!isset($shippingid_cond) || empty($shippingid_cond))
      {
         $shippingid_cond = "eq";
      }
      if (!isset($measure_cond) || empty($measure_cond))
      {
         $measure_cond = "eq";
      }
      ...
      if (!isset($taxable_cond) || empty($taxable_cond))
      {
         $taxable_cond = "eq";
      }
      ...
      $str_hide_categoryid = (in_array($categoryid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_shippingid = (in_array($shippingid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_measure = (in_array($measure_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_name = (in_array($name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_taxable = (in_array($taxable_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($categoryid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $categoryid = substr($categoryid, 0, $tmp_pos);
         }
      }
      ...
      if (isset($shippingid) && !empty($shippingid))
      {
         $tmp_pos = strpos($shippingid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $shippingid = substr($shippingid, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($measure, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $measure = substr($measure, 0, $tmp_pos);
         }
      }
      if (!isset($name) || $name == "")
      {
      ...
      if (!isset($taxable) || $taxable == "")
      {
          $taxable = "";
      }
      if (isset($taxable) && !empty($taxable))
      {
         $tmp_pos = strpos($taxable, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $taxable = substr($taxable, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_products_dependent_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['categoryid'])) ? $this->New_label['categoryid'] : "" . $this->Ini->Nm_lang['lang_products_fild_categoryid'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_categoryid_cond" name="categoryid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_categoryid" <?php echo $str_hide_categoryid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['categoryid'])) ? $this->New_label['categoryid'] : "" . $this->Ini->Nm_lang['lang_products_fild_categoryid'] . "";
 $nmgp_tab_label .= "categoryid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>

<?php
      $categoryid_look = substr($this->Db->qstr($categoryid), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "select categoryid, description  from category  order by description"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['categoryid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['categoryid'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_categoryid">
      <SELECT class="scFilterObjectOdd" id="SC_categoryid" name="categoryid"  size="1">
       <OPTION value=""></OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $categoryid)
            {
                    $categoryid_sel = ($nm_opc_cod === $categoryid) ? "selected" : "";
            }
            else
            {
               $categoryid_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $categoryid_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['shippingid'])) ? $this->New_label['shippingid'] : "" . $this->Ini->Nm_lang['lang_products_fild_shippingid'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_shippingid_cond" name="shippingid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_shippingid" <?php echo $str_hide_shippingid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['shippingid'])) ? $this->New_label['shippingid'] : "" . $this->Ini->Nm_lang['lang_products_fild_shippingid'] . "";
 $nmgp_tab_label .= "shippingid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>

<?php
      $shippingid_look = substr($this->Db->qstr($shippingid), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "select shippingid, description  from shipping  order by description"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['shippingid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['shippingid'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_shippingid">
      <SELECT class="scFilterObjectEven" id="SC_shippingid" name="shippingid"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoes = explode("?@?", $nmgp_def_dados);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $shippingid)
            {
                    $shippingid_sel = ($nm_opc_cod === $shippingid) ? "selected" : "";
            }
            else
            {
               $shippingid_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $shippingid_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['measure'])) ? $this->New_label['measure'] : "" . $this->Ini->Nm_lang['lang_products_fild_measure'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_measure_cond" name="measure_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_measure" <?php echo $str_hide_measure?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['measure'])) ? $this->New_label['measure'] : "" . $this->Ini->Nm_lang['lang_products_fild_measure'] . "";
 $nmgp_tab_label .= "measure?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>

<?php
      $measure_look = substr($this->Db->qstr($measure), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "select measureid, description  from measure  order by description"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['measure'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['measure'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_measure">
      <SELECT class="scFilterObjectOdd" id="SC_measure" name="measure"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoes = explode("?@?", $nmgp_def_dados);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $measure)
            {
                    $measure_sel = ($nm_opc_cod === $measure) ? "selected" : "";
            }
            else
            {
               $measure_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $measure_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['name'])) ? $this->New_label['name'] : "" . $this->Ini->Nm_lang['lang_products_fild_name'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_name_cond" name="name_cond" value="qp">
...
<INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['taxable'])) ? $this->New_label['taxable'] : "" . $this->Ini->Nm_lang['lang_products_fild_taxable'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_taxable_cond" name="taxable_cond" onChange="nm_campos_between(document.getElementById('id_vis_taxable'), this, 'taxable')">
       <OPTION value="eq"><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_taxable" <?php echo $str_hide_taxable?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['taxable'])) ? $this->New_label['taxable'] : "" . $this->Ini->Nm_lang['lang_products_fild_taxable'] . "";
 $nmgp_tab_label .= "taxable?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  if (!isset($taxable)) {$taxable = $taxable;}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['taxable'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['taxable'][] = "Y";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['taxable'][] = "N";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_taxable" name="taxable" value="Y##@@Yes"  <?php if ("Y" == $taxable)  { echo " checked" ;} ?>>Yes</TD>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_taxable" name="taxable" value="N##@@No"  <?php if ("N" == $taxable)  { echo " checked" ;} ?>>No</TD>
</TR></TABLE>
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_products_dependent']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_products_dependent']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_products_dependent.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_categoryid'), document.F1.categoryid_cond, 'categoryid');
   document.F1.categoryid.value = "";
   nm_campos_between(document.getElementById('id_vis_shippingid'), document.F1.shippingid_cond, 'shippingid');
   document.F1.shippingid.value = "";
   nm_campos_between(document.getElementById('id_vis_measure'), document.F1.measure_cond, 'measure');
   document.F1.measure.value = "";
   nm_campos_between(document.getElementById('id_vis_name'), document.F1.name_cond, 'name');
   document.F1.name.value = "";
   nm_campos_between(document.getElementById('id_vis_taxable'), document.F1.taxable_cond, 'taxable');
   for (i = 0; i < document.F1.taxable.length; i++)
   {
      if (document.F1.taxable[i].checked)
      {
          document.F1.taxable[i].checked = false;
      }
   }
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "PHPTrn/grid_products_dependent";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_products_dependent/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_categoryid_cond'] = 'cond';
      $tp_fields['SC_categoryid'] = 'select';
      $tp_fields['SC_shippingid_cond'] = 'cond';
      $tp_fields['SC_shippingid'] = 'select';
      $tp_fields['SC_measure_cond'] = 'cond';
      $tp_fields['SC_measure'] = 'select';
      $tp_fields['SC_name_cond'] = 'cond';
      $tp_fields['SC_name'] = 'text';
      $tp_fields['SC_taxable_cond'] = 'cond';
      $tp_fields['SC_taxable'] = 'radio';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $categoryid_cond, $categoryid,
             $shippingid_cond, $shippingid,
             $measure_cond, $measure,
             $name_cond, $name,
             $taxable_cond, $taxable, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $categoryid_cond_salva = $categoryid_cond; 
      if (!isset($categoryid_input_2) || $categoryid_input_2 == "")
      {
          $categoryid_input_2 = $categoryid;
      }
      $shippingid_cond_salva = $shippingid_cond; 
      if (!isset($shippingid_input_2) || $shippingid_input_2 == "")
      {
          $shippingid_input_2 = $shippingid;
      }
      $measure_cond_salva = $measure_cond; 
      if (!isset($measure_input_2) || $measure_input_2 == "")
      {
          $measure_input_2 = $measure;
      }
      ...
      $taxable_cond_salva = $taxable_cond; 
      if (!isset($taxable_input_2) || $taxable_input_2 == "")
      {
          $taxable_input_2 = $taxable;
      }
      $tmp_pos = strpos($categoryid, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $categoryid;
          ...
          $L_lookup = substr($categoryid, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['categoryid'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_products_fild_categoryid'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($shippingid, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $shippingid;
          ...
          $L_lookup = substr($shippingid, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['shippingid'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_products_fild_shippingid'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($measure, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $measure;
          ...
          $L_lookup = substr($measure, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['measure'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_products_fild_measure'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($taxable, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $taxable;
          ...
          $L_lookup = substr($taxable, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['psq_check_ret']['taxable'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_products_fild_taxable'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['categoryid'] = $categoryid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['categoryid_cond'] = $categoryid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['shippingid'] = $shippingid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['shippingid_cond'] = $shippingid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['measure'] = $measure; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['measure_cond'] = $measure_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['name'] = $name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['name_cond'] = $name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['taxable'] = $taxable; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['taxable_cond'] = $taxable_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['categoryid'] = $Conteudo;
      $Conteudo = $shippingid;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['shippingid'] = $Conteudo;
      $Conteudo = $measure;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['measure'] = $Conteudo;
      $Conteudo = $name;
      $this->cmp_formatado['name'] = $Conteudo;
      $this->cmp_formatado['taxable'] = $taxable;
      if (strpos($this->cmp_formatado['taxable'], "##@@") !== false)
      {
          $this->cmp_formatado['taxable'] = substr($this->cmp_formatado['taxable'], strpos($this->cmp_formatado['taxable'], "##@@") + 4);
      }
      $this->cmp_formatado['taxable_input_2'] = $taxable_input_2;

      //----- $categoryid
      $this->Date_part = false;
      if (isset($categoryid))
      {
         $this->monta_condicao("categoryid", $categoryid_cond, $categoryid, "", "categoryid");
      }
      ...
      if (isset($shippingid))
      {
         $this->monta_condicao("shippingid", $shippingid_cond, $shippingid, "", "shippingid");
      }
      ...
      if (isset($measure))
      {
         $this->monta_condicao("measure", $measure_cond, $measure, "", "measure");
      }
      ...
      if (isset($taxable))
      {
         $this->monta_condicao("taxable", $taxable_cond, $taxable, "", "taxable");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_products_dependent']['fast_search']);
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "categoryid" : return ('class="scFilterObjectOdd"'); break;
         case "shippingid" : return ('class="scFilterObjectEven"'); break;
         case "measure" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
