...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate backoffice
  function do_ajax_index_mob_validate_backoffice()
  {
    var nomeCampo_backoffice = "backoffice";
    var var_backoffice = scAjaxGetFieldText(nomeCampo_backoffice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_index_mob_validate_backoffice(var_backoffice, var_script_case_init, do_ajax_index_mob_validate_backoffice_cb);
  } // do_ajax_index_mob_validate_backoffice

  function do_ajax_index_mob_validate_backoffice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "backoffice";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_index_mob_validate_backoffice_cb

  // ---------- Validate frontend
  function do_ajax_index_mob_validate_frontend()
  {
    var nomeCampo_frontend = "frontend";
    var var_frontend = scAjaxGetFieldText(nomeCampo_frontend);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_index_mob_validate_frontend(var_frontend, var_script_case_init, do_ajax_index_mob_validate_frontend_cb);
  } // do_ajax_index_mob_validate_frontend

  function do_ajax_index_mob_validate_frontend_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "frontend";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_index_mob_validate_frontend_cb

  // ---------- Validate language
  function do_ajax_index_mob_validate_language()
  {
    var nomeCampo_language = "language";
    var var_language = scAjaxGetFieldText(nomeCampo_language);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_index_mob_validate_language(var_language, var_script_case_init, do_ajax_index_mob_validate_language_cb);
  } // do_ajax_index_mob_validate_language

  function do_ajax_index_mob_validate_language_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_index_mob_validate_language_cb
  // ---------- Form
  function do_ajax_index_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_index_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_backoffice = "";
    var var_frontend = "";
    var var_language = scAjaxGetFieldText("language");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_index_mob_submit_form(var_backoffice, var_frontend, var_language, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_index_mob_submit_form_cb);
  } // do_ajax_index_mob_submit_form

  function do_ajax_index_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("backoffice");
      scAjaxHideErrorDisplay("frontend");
      scAjaxHideErrorDisplay("language");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_index_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_index_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_index_mob_navigate_form

  function do_ajax_index_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_index_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_index_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "backoffice";
  ajax_field_list[1] = "frontend";
  ajax_field_list[2] = "language";
  ...
  var ajax_error_list = {
    "backoffice": {"label": "<?php echo $this->Ini->Nm_lang['lang_index_backoffice'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "frontend": {"label": "<?php echo $this->Ini->Nm_lang['lang_index_frontend'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "language": {"label": "<?php echo $this->Ini->Nm_lang['lang_select_language'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "backoffice": new Array(),
    "frontend": new Array(),
    "language": new Array()
  };
  ajax_field_mult["backoffice"][1] = "backoffice";
  ajax_field_mult["frontend"][1] = "frontend";
  ajax_field_mult["language"][1] = "language";

  var ajax_field_id = {
    "backoffice": new Array("hidden_field_label_backoffice", "hidden_field_data_backoffice"),
    "frontend": new Array("hidden_field_label_frontend", "hidden_field_data_frontend"),
