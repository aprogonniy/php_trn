...
$old_error_handler = set_error_handler("index_mob_scriptcase_error_handler");

function index_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['index_mob']['contr_erro']) && $_SESSION['scriptcase']['index_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_index_mob->contr_index_mob->Apl_com_erro = true;
            if ($inicial_index_mob->contr_index_mob->NM_ajax_flag)
            {
                $inicial_index_mob->contr_index_mob->NM_ajax_info['errList']['geral_index_mob'][] = $msg;
                return;
            }
            index_mob_scriptcase_error_display($msg, $err_no);
        }
...
function index_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['index_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['index_mob'])  ? $_SESSION['scriptcase']['error_icon']['index_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['index_mob']) && '' != $_SESSION['scriptcase']['error_close']['index_mob']) ? $_SESSION['scriptcase']['error_close']['index_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['index_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['index_mob']) ? $_SESSION['scriptcase']['error_span_title']['index_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['index_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['index_mob']) ? $_SESSION['scriptcase']['error_icon_title']['index_mob'] : '';
?>
