...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate backoffice
  function do_ajax_index_validate_backoffice()
  {
    var nomeCampo_backoffice = "backoffice";
    var var_backoffice = scAjaxGetFieldText(nomeCampo_backoffice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_index_validate_backoffice(var_backoffice, var_script_case_init, do_ajax_index_validate_backoffice_cb);
  } // do_ajax_index_validate_backoffice

  function do_ajax_index_validate_backoffice_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_index_validate_backoffice_cb

  // ---------- Validate frontend
  function do_ajax_index_validate_frontend()
  {
    var nomeCampo_frontend = "frontend";
    var var_frontend = scAjaxGetFieldText(nomeCampo_frontend);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_index_validate_frontend(var_frontend, var_script_case_init, do_ajax_index_validate_frontend_cb);
  } // do_ajax_index_validate_frontend

  function do_ajax_index_validate_frontend_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_index_validate_frontend_cb

  // ---------- Validate language
  function do_ajax_index_validate_language()
  {
    var nomeCampo_language = "language";
    var var_language = scAjaxGetFieldText(nomeCampo_language);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_index_validate_language(var_language, var_script_case_init, do_ajax_index_validate_language_cb);
  } // do_ajax_index_validate_language

  function do_ajax_index_validate_language_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_index_validate_language_cb
  // ---------- Form
  function do_ajax_index_submit_form()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_index_submit_form(var_backoffice, var_frontend, var_language, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_index_submit_form_cb);
