...
$old_error_handler = set_error_handler("index_scriptcase_error_handler");

function index_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['index']['contr_erro']) && $_SESSION['scriptcase']['index']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_index->contr_index->Apl_com_erro = true;
            if ($inicial_index->contr_index->NM_ajax_flag)
            {
                $inicial_index->contr_index->NM_ajax_info['errList']['geral_index'][] = $msg;
                return;
            }
            index_scriptcase_error_display($msg, $err_no);
        }
...
function index_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['index'])  && '' != $_SESSION['scriptcase']['error_icon']['index'])  ? $_SESSION['scriptcase']['error_icon']['index']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['index']) && '' != $_SESSION['scriptcase']['error_close']['index']) ? $_SESSION['scriptcase']['error_close']['index'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['index']) && '' != $_SESSION['scriptcase']['error_span_title']['index']) ? $_SESSION['scriptcase']['error_span_title']['index'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['index']) && '' != $_SESSION['scriptcase']['error_icon_title']['index']) ? $_SESSION['scriptcase']['error_icon_title']['index'] : '';
?>
