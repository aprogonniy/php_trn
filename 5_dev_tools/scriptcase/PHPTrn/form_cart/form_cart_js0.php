<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="cartid_" value="<?php echo NM_encode_input($this->nmgp_dados_form['cartid_']); ?>">
...
function sc_btn_buy_now()
{
    if (scEventControl_active_all()) {
      setTimeout(function() { sc_btn_buy_now(); }, 500);
      return;
    }
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?buy_now?@?";
    document.F1.action = "form_cart.php";
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_cart_submit_form(y, z); 
} 
<?php
}
?>
