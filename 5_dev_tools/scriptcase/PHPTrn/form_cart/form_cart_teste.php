<?php  
  session_start() ;
  class form_cart_form_teste
  {
   function form_cart_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_cart/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_cart</FONT></B> 
<br> 
...
v_session&nbsp;&nbsp;<input type="text" name="v_session" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="form_cart"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_cart_form_teste();
  $frm_teste->form_cart_teste();
?>
