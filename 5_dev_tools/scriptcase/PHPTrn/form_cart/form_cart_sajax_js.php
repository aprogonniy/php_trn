...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate productid_
  function do_ajax_form_cart_validate_productid_(iNumLinha)
  {
    var nomeCampo_productid_ = "productid_" + iNumLinha;
    var var_productid_ = scAjaxGetFieldSelect(nomeCampo_productid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cart_validate_productid_(var_productid_, iNumLinha, var_script_case_init, do_ajax_form_cart_validate_productid__cb);
  } // do_ajax_form_cart_validate_productid_

  function do_ajax_form_cart_validate_productid__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cart_validate_productid__cb

  // ---------- Validate quantity_
  function do_ajax_form_cart_validate_quantity_(iNumLinha)
  {
    var nomeCampo_quantity_ = "quantity_" + iNumLinha;
    var var_quantity_ = scAjaxGetFieldText(nomeCampo_quantity_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cart_validate_quantity_(var_quantity_, iNumLinha, var_script_case_init, do_ajax_form_cart_validate_quantity__cb);
  } // do_ajax_form_cart_validate_quantity_

  function do_ajax_form_cart_validate_quantity__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cart_validate_quantity__cb

  // ---------- Validate vl_unit_
  function do_ajax_form_cart_validate_vl_unit_(iNumLinha)
  {
    var nomeCampo_vl_unit_ = "vl_unit_" + iNumLinha;
    var var_vl_unit_ = scAjaxGetFieldHidden(nomeCampo_vl_unit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cart_validate_vl_unit_(var_vl_unit_, iNumLinha, var_script_case_init, do_ajax_form_cart_validate_vl_unit__cb);
  } // do_ajax_form_cart_validate_vl_unit_

  function do_ajax_form_cart_validate_vl_unit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "vl_unit_" + iLineNumber;
    }
    else
    {
      sFieldValid = "vl_unit_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "vl_unit_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "vl_unit_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cart_validate_vl_unit__cb

  // ---------- Validate total_
  function do_ajax_form_cart_validate_total_(iNumLinha)
  {
    var nomeCampo_total_ = "total_" + iNumLinha;
    var var_total_ = scAjaxGetFieldHidden(nomeCampo_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cart_validate_total_(var_total_, iNumLinha, var_script_case_init, do_ajax_form_cart_validate_total__cb);
  } // do_ajax_form_cart_validate_total_

  function do_ajax_form_cart_validate_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cart_validate_total__cb

  // ---------- Event onchange quantity_
  function do_ajax_form_cart_event_quantity__onchange(iSeqForm)
  {
    ...
    var var_vl_unit_ = scAjaxGetFieldHidden("vl_unit_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_cart_event_quantity__onchange(var_productid_, var_quantity_, var_total_, var_vl_unit_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_cart_event_quantity__onchange_cb);
  } // do_ajax_form_cart_event_quantity__onchange

  function do_ajax_form_cart_event_quantity__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cart_event_quantity__onchange_cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cart_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cart_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cart_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cart_add_new_line_cb);
  } // do_ajax_form_cart_add_new_line

  function do_ajax_form_cart_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_cart_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cart_backup_line(iNumLinha)
  {
    var var_cartid_ = scAjaxGetFieldText("cartid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cart_backup_line(var_cartid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cart_backup_line_cb);
  } // do_ajax_form_cart_backup_line

  function do_ajax_form_cart_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_cart_backup_line_cb

  function do_ajax_form_cart_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cart_cancel_insert

  function do_ajax_form_cart_cancel_update(iSeqVert)
  {
    do_ajax_form_cart_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cart_cancel_update

  function do_ajax_form_cart_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cart_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cart_table_refresh()
  {
    var var_cartid_ = document.F2.cartid_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cart_table_refresh(var_cartid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cart_table_refresh_cb);
  } //  do_ajax_form_cart_table_refresh

  function do_ajax_form_cart_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.cartid_.value = scAjaxGetKeyValue("cartid_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_cart_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cart_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cart_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_vl_unit_ = scAjaxGetFieldHidden("vl_unit_" + iNumLinha);
...
?>
    x_ajax_form_cart_submit_form(var_productid_, var_quantity_, var_vl_unit_, var_total_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_cart_submit_form_cb);
  } // do_ajax_form_cart_submit_form

  function do_ajax_form_cart_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("vl_unit_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_cart_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_cart_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("vl_unit_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cart_navigate_form(var_cartid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cart_navigate_form_cb);
  } // do_ajax_form_cart_navigate_form

  function do_ajax_form_cart_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.cartid_.value = scAjaxGetKeyValue("cartid_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_cart_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "vl_unit_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "total_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["productid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cart_fild_productid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["quantity_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cart_fild_quantity'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["vl_unit_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cart_unit_price'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["total_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cart_total'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["productid_"][iNumLinha] = "productid_" + iNumLinha;
    ajax_field_mult["quantity_"][iNumLinha] = "quantity_" + iNumLinha;
    ajax_field_mult["vl_unit_"][iNumLinha] = "vl_unit_" + iNumLinha;
    ...
    ajax_field_id["vl_unit_" + iNumLinha] = new Array("hidden_field_label_vl_unit_", "hidden_field_data_vl_unit_" + iNumLinha);
    ...
    ajax_error_count["vl_unit_" + iNumLinha] = "off";
    ajax_error_count["total_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["productid_" + iNumLinha] = "off";
    ajax_read_only["quantity_" + iNumLinha] = "off";
    ajax_read_only["vl_unit_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["vl_unit_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["vl_unit_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["vl_unit_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["vl_unit_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["vl_unit_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["vl_unit_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["vl_unit_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['productid_'])) ? $this->nmgp_cmp_readonly['productid_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['vl_unit_'])) ? $this->nmgp_cmp_readonly['vl_unit_'] : 'off';
?>
    scAjaxFieldRead("vl_unit_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("vl_unit_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["productid_" + iRow] || "on" == ajax_error_count["quantity_" + iRow] || "on" == ajax_error_count["vl_unit_" + iRow] || "on" == ajax_error_count["total_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_vl_unit_" + iRow))
        document.getElementById("hidden_field_data_vl_unit_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["productid_" + iRow] && "off" == ajax_error_count["quantity_" + iRow] && "off" == ajax_error_count["vl_unit_" + iRow] && "off" == ajax_error_count["total_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["productid_" + iRow] = "off";
        ajax_error_count["quantity_" + iRow] = "off";
        ajax_error_count["vl_unit_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_vl_unit_" + iRow))
        document.getElementById("hidden_field_data_vl_unit_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_total_" + iRow))
