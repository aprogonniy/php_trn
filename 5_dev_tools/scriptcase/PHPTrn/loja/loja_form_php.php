...
class loja_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['loja']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['loja']['glo_nm_path_prod']))
      {
...
<?php
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "loja")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("treemenu_home") . "/treemenu_home.php?nm_run_menu=1&nm_apl_menu=loja&script_case_init=1&script_case_session=" . session_id() . "";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['loja']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['loja'] as $id_item => $arr_item)
         {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="loja"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "loja")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'loja', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
