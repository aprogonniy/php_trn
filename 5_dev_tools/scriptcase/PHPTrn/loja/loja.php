...
else
{
    ...
    $_SESSION['scriptcase']['loja']['glo_nm_path_prod'] = "/scriptcase/prod";
    $_SESSION['scriptcase']['loja']['glo_nm_perfil']    = "";
    $_SESSION['scriptcase']['loja']['glo_nm_conexao']   = "conn_example";
    $_SESSION['scriptcase']['loja']['glo_nm_usa_grupo'] = "S";
    ...
    global $loja_menuData;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['loja']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['loja']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['loja']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
$path_libs      = $str_root . $_SESSION['scriptcase']['loja']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['loja']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['loja']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "loja/img";
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('loja');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/loja_erro.php");
}
include_once(dirname(__FILE__) . "/loja_erro.class.php"); 
$this->Erro = new loja_erro();
$str_path = substr($_SESSION['scriptcase']['loja']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['loja']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['loja']['glo_nm_conexao']);
}

/* Path definitions */
$loja_menuData         = array();
$loja_menuData['path'] = array();
$loja_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $loja_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $loja_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $loja_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $loja_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$loja_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$loja_menuData['url']['web']   = str_replace("\\", '/', $loja_menuData['url']['web']);
$loja_menuData['path']['root'] = substr($loja_menuData['path']['sys'],  0, -1 * strlen($loja_menuData['url']['web']));
$loja_menuData['path']['app']  = substr($loja_menuData['path']['sys'],  0, strrpos($loja_menuData['path']['sys'],  '/'));
$loja_menuData['path']['link'] = substr($loja_menuData['path']['app'],  0, strrpos($loja_menuData['path']['app'],  '/'));
$loja_menuData['path']['link'] = substr($loja_menuData['path']['link'], 0, strrpos($loja_menuData['path']['link'], '/')) . '/';
$loja_menuData['path']['app'] .= '/';
$loja_menuData['url']['app']   = substr($loja_menuData['url']['web'],  0, strrpos($loja_menuData['url']['web'],  '/'));
$loja_menuData['url']['link']  = substr($loja_menuData['url']['app'],  0, strrpos($loja_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['loja']['glo_nm_usa_grupo'] == "S")
{
    $loja_menuData['url']['link']  = substr($loja_menuData['url']['link'], 0, strrpos($loja_menuData['url']['link'], '/'));
}
$loja_menuData['url']['link']  .= '/';
$loja_menuData['url']['app']   .= '/';
...
$path_apls     .= "/";
$this->str_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "sc_gray/sc_gray";
...
$str_button = (isset($_SESSION['scriptcase']['str_button_all'])) ? $_SESSION['scriptcase']['str_button_all'] : "sc_gray";
...
if ($_SESSION['scriptcase']['loja']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "loja";
     $_SESSION['scriptcase']['menu_apls']['loja'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['loja']['glo_nm_conexao']) && $_SESSION['scriptcase']['loja']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['loja']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['loja']['glo_nm_perfil']) && $_SESSION['scriptcase']['loja']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['loja']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['loja']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['loja']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['loja']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['loja']['init']))
{
    $_SESSION['sc_session'][1]['loja']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['loja']['init'];
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_loja'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_loja'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_loja'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['loja']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['loja']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['loja']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['loja']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['loja']['glo_nm_path_prod'], 'PHPTrn', 2); 
}
if (isset($_SESSION['scriptcase']['loja']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['loja']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['loja']['glo_nm_perfil'];
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['loja']['sc_outra_jan']) && $_SESSION['sc_session'][1]['loja']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['loja']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['loja']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['loja']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['loja']['glo_nm_path_prod'], 'PHPTrn'); 
} 
else 
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['loja']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['loja']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'loja'))
{
    $_SESSION['sc_session'][1]['loja']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_loja'] = "javascript:window.close()";
}
/* Menu configuration variables */
$loja_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("treemenu_home") . "/treemenu_home_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['treemenu_home']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['treemenu_home'] = "on";
    }
}
...
/* Menu items */
$_SESSION['scriptcase']['loja']['contr_erro'] = 'on';
 unset($_SESSION['scriptcase']['sc_def_menu']["loja"]);
if (!isset($_SESSION['scriptcase']['sc_def_menu']))
{
    $_SESSION['scriptcase']['sc_def_menu'] = array();
}
if (!isset($_SESSION['scriptcase']['sc_def_menu']["loja"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["loja"] = array();
}
$nm_select = "
              SELECT DISTINCT
                 cat.categoryid,
                 cat.description
              FROM
                 category cat INNER JOIN products prod ON cat.categoryid = prod.categoryid
              "; 
...
if (isset($_SESSION['scriptcase']['sc_def_menu']["loja"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['pai']            = "";
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['label']          = "" . $this->Nm_lang['lang_all_cateogires'] . "";
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['link']           = "treemenu_home";
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['icon']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['hint']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['target']         = "_self";
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['name']           = "treemenu_home";
    $Temp_url = "treemenu_home";
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/" . $Temp_url . ".php";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "loja" . "&script_case_session=" . session_id();
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['sc_init'] = $this->Gera_sc_init('treemenu_home');
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "loja" . "&script_case_init=" . $this->Gera_sc_init('treemenu_home') . "&script_case_session=" . session_id();
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["loja"]['init'] . "&script_case_session=" . session_id();
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["loja"]["home"]['url'] = $Temp_url;
}
foreach($this->rs  as $cat)
{
  ...
  if (isset($_SESSION['scriptcase']['sc_def_menu']["loja"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['pai']            = "";
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['label']          = $cat[1];
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['link']           = "treemenu_home";
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['parm']           = "v_cat*scin" . $cat[0] . "*scout" . "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['icon']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['hint']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['target']         = "_self";
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['name']           = "treemenu_home";
    $Temp_url = "treemenu_home";
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/" . $Temp_url . ".php";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "loja" . "&script_case_session=" . session_id();
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['sc_init'] = $this->Gera_sc_init('treemenu_home');
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "loja" . "&script_case_init=" . $this->Gera_sc_init('treemenu_home') . "&script_case_session=" . session_id();
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["loja"]['init'] . "&script_case_session=" . session_id();
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["loja"][$id]['url'] = $Temp_url;
}
}
$_SESSION['scriptcase']['loja']['contr_erro'] = 'off';
if ($this->Db)
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_loja'];

$loja_menuData['data'] = array();

if (isset($_SESSION['scriptcase']['sc_def_menu']['loja']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['loja']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'loja');
    $loja_menuData['data'] = $str_menu_usu;
}
if (is_file("loja_help.txt"))
{
    $Arq_WebHelp = file("loja_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $loja_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->loja_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => "N",
                );
            }
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['loja']) && !empty($_SESSION['scriptcase']['sc_menu_del']['loja']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($loja_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['loja']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($loja_menuData['data'][$i_menu]);
       }
    ...
    $loja_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['loja']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['loja']))
{
    $disable_menu = false;
    foreach ($loja_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['loja']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $loja_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
{
    $_SESSION['scriptcase']['menu_mobile'] = "loja";
    include('loja_mobile.php');
    exit;
}
/* HTML header */
if ($loja_menuData['iframe'])
{
    $loja_menuData['height'] = '100%';
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?> style="height: 100%">
<head>
 <title>ScriptCase Shop</title>
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/scriptcase_Scriptcase_GrayWhite_hor_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . scriptcase_Scriptcase_GrayWhite . '_' . hor . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . scriptcase_Scriptcase_GrayWhite . '_' . hor . '.css'); } ?>" />
</head>
...
{
    $loja_menuData['height'] = '30px';
}

/* JS files */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['loja']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<?php
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        <TD align="left" rowspan="3" class="scMenuHHeaderFont">
             <IMG SRC="<?php echo $path_imag_cab ?>/scriptcase__NM__bg__NM__shop.png" BORDER="0"/>
        </TD>
       ...
       <TR valign="middle">
        ...
        <TD align="center" class="scMenuHHeaderFont">
          <?php echo "<form name='search' action='../grid_products_list_cat_search/grid_products_list_cat_search.php' target='loja_iframe' method='post'>Product <input type='text' name='search_fld' value=''><input type='submit' value='" . $this->Nm_lang['lang_header_search'] . "'></form>" ?>
        </TD>
        <TD style="font-size: 5px">
          &nbsp; &nbsp;
        </TD>
        <TD align="right" class="scMenuHHeaderFont">
          <?php echo "<a href='../login_customer/login_customer.php' target='loja_iframe'>" . $this->Nm_lang['lang_myaccount'] . "</a> | <a href='../form_cart/form_cart.php' target='loja_iframe'>" . $this->Nm_lang['lang_cart'] . "</a>" ?>
        </TD>
       </TR>
      </TABLE>
     </TD>
...
<div id="idDivMenu">
<?php
echo $this->loja_escreveMenu($loja_menuData['data']);
?>
</div>
       </td></tr></table>
<?php
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $loja_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
    <td style="border-width: 1px; height: 100%; padding: 0px">
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['treemenu_home']) && $_SESSION['scriptcase']['sc_apl_seg']['treemenu_home'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_loja');\" item-href=\"loja_form_php.php?sc_item_menu=loja&sc_apl_menu=treemenu_home&sc_apl_link=" . urlencode($loja_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['loja']['glo_nm_usa_grupo'] . "\"  item-target=\"loja_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "loja_pag_ini.php");
} 
?>
      <iframe id="iframe_loja" name="loja_iframe" frameborder="0" class="scMenuIframe"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_loja').click()";
    echo "</script>";
}
...
/* Target control */
function loja_escreveMenu($arr_menu)
{
    $last      = '';
    $itemClass = ' topfirst';
    $subSize   = 2;
...
function loja_target($str_target)
{
    global $loja_menuData;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $loja_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "loja_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($loja_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['loja']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "loja_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($loja_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['loja']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->loja_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['loja']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
$contr_loja = new loja_class;
$contr_loja->loja_menu();
