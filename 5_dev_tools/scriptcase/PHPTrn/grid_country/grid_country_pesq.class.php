...
class grid_country_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_country_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_country_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_country_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['decimal_db'] == ".")
         {
            $nm_aspas = "";
         }
         if ($condicao != "IN")
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_country.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_country'] ?></TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_country_ajax_search.js"></script>
 <script type="text/javascript" src="grid_country_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_countrycode_cond#NMF#' + search_get_sel_txt('SC_countrycode_cond') + '@NMF@';
  str_out += 'SC_countrycode#NMF#' + search_get_text('SC_countrycode') + '@NMF@';
  str_out += 'SC_name_cond#NMF#' + search_get_sel_txt('SC_name_cond') + '@NMF@';
  str_out += 'SC_name#NMF#' + search_get_text('SC_name') + '@NMF@';
  str_out += 'SC_tax_cond#NMF#' + search_get_sel_txt('SC_tax_cond') + '@NMF@';
  str_out += 'SC_tax#NMF#' + search_get_text('SC_tax') + '@NMF@';
  str_out += 'SC_taxpercent_cond#NMF#' + search_get_sel_txt('SC_taxpercent_cond') + '@NMF@';
  str_out += 'SC_taxpercent#NMF#' + search_get_text('SC_taxpercent') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_country.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_country'] ?></span></td>
...
<?php
   ...
   {
      global 
             $countrycode_cond, $countrycode,
             $name_cond, $name,
             $tax_cond, $tax,
             $taxpercent_cond, $taxpercent,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $countrycode = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['countrycode']; 
          $countrycode_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['countrycode_cond']; 
          $name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['name']; 
          $name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['name_cond']; 
          $tax = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['tax']; 
          $tax_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['tax_cond']; 
          $taxpercent = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['taxpercent']; 
          $taxpercent_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['taxpercent_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['NM_operador']; 
          if (strtoupper($taxpercent_cond) != "II" && strtoupper($taxpercent_cond) != "QP" && strtoupper($taxpercent_cond) != "NP" && strtoupper($taxpercent_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($taxpercent, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
      } 
      if (!isset($countrycode_cond) || empty($countrycode_cond))
      {
         $countrycode_cond = "eq";
      }
      ...
      if (!isset($tax_cond) || empty($tax_cond))
      {
         $tax_cond = "eq";
      }
      if (!isset($taxpercent_cond) || empty($taxpercent_cond))
      {
         $taxpercent_cond = "eq";
      }
      ...
      $str_hide_countrycode = (in_array($countrycode_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_name = (in_array($name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tax = (in_array($tax_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_taxpercent = (in_array($taxpercent_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($countrycode, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $countrycode = substr($countrycode, 0, $tmp_pos);
         }
      }
      if (!isset($name) || $name == "")
      {
      ...
      if (isset($tax) && !empty($tax))
      {
         ...
         {
         $tax = substr($tax, 0, $tmp_pos);
         }
      }
      if (!isset($taxpercent) || $taxpercent == "")
      {
          $taxpercent = "";
      }
      if (isset($taxpercent) && !empty($taxpercent))
      {
         $tmp_pos = strpos($taxpercent, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $taxpercent = substr($taxpercent, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_country_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['countrycode'])) ? $this->New_label['countrycode'] : "" . $this->Ini->Nm_lang['lang_country_fild_countrycode'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_countrycode_cond" name="countrycode_cond" onChange="nm_campos_between(document.getElementById('id_vis_countrycode'), this, 'countrycode')">
       <OPTION value="eq" <?php if ("eq" == $countrycode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $countrycode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $countrycode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $countrycode_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_countrycode" <?php echo $str_hide_countrycode?> valign="top">
 ...
 $nmgp_tab_label .= "countrycode?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_countrycode" name="countrycode" value="<?php echo NM_encode_input($countrycode) ?>" size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['name'])) ? $this->New_label['name'] : "" . $this->Ini->Nm_lang['lang_country_fild_name'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tax'])) ? $this->New_label['tax'] : "" . $this->Ini->Nm_lang['lang_country_fild_tax'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tax_cond" name="tax_cond" onChange="nm_campos_between(document.getElementById('id_vis_tax'), this, 'tax')">
       <OPTION value="eq" <?php if ("eq" == $tax_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $tax_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $tax_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $tax_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tax" <?php echo $str_hide_tax?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tax'])) ? $this->New_label['tax'] : "" . $this->Ini->Nm_lang['lang_country_fild_tax'] . "";
 $nmgp_tab_label .= "tax?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_tax" name="tax" value="<?php echo NM_encode_input($tax) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['taxpercent'])) ? $this->New_label['taxpercent'] : "" . $this->Ini->Nm_lang['lang_country_fild_taxpercent'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_taxpercent_cond" name="taxpercent_cond" onChange="nm_campos_between(document.getElementById('id_vis_taxpercent'), this, 'taxpercent')">
       <OPTION value="eq" <?php if ("eq" == $taxpercent_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $taxpercent_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $taxpercent_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $taxpercent_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_taxpercent" <?php echo $str_hide_taxpercent?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['taxpercent'])) ? $this->New_label['taxpercent'] : "" . $this->Ini->Nm_lang['lang_country_fild_taxpercent'] . "";
 $nmgp_tab_label .= "taxpercent?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_taxpercent" name="taxpercent" value="<?php echo NM_encode_input($taxpercent) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_country']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_country']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_country.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_countrycode'), document.F1.countrycode_cond, 'countrycode');
   document.F1.countrycode.value = "";
   nm_campos_between(document.getElementById('id_vis_name'), document.F1.name_cond, 'name');
   document.F1.name.value = "";
   nm_campos_between(document.getElementById('id_vis_tax'), document.F1.tax_cond, 'tax');
   document.F1.tax.value = "";
   nm_campos_between(document.getElementById('id_vis_taxpercent'), document.F1.taxpercent_cond, 'taxpercent');
   document.F1.taxpercent.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_countrycode_cond'] = 'cond';
      $tp_fields['SC_countrycode'] = 'text';
      $tp_fields['SC_name_cond'] = 'cond';
      $tp_fields['SC_name'] = 'text';
      $tp_fields['SC_tax_cond'] = 'cond';
      $tp_fields['SC_tax'] = 'text';
      $tp_fields['SC_taxpercent_cond'] = 'cond';
      $tp_fields['SC_taxpercent'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $countrycode_cond, $countrycode,
             $name_cond, $name,
             $tax_cond, $tax,
             $taxpercent_cond, $taxpercent, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $countrycode_cond_salva = $countrycode_cond; 
      if (!isset($countrycode_input_2) || $countrycode_input_2 == "")
      {
          $countrycode_input_2 = $countrycode;
      }
      ...
      $tax_cond_salva = $tax_cond; 
      if (!isset($tax_input_2) || $tax_input_2 == "")
      {
          $tax_input_2 = $tax;
      }
      $taxpercent_cond_salva = $taxpercent_cond; 
      if (!isset($taxpercent_input_2) || $taxpercent_input_2 == "")
      {
          $taxpercent_input_2 = $taxpercent;
      }
      if ($taxpercent_cond != "in")
      {
          nm_limpa_numero($taxpercent, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $taxpercent);
          ...
          $taxpercent = implode(",", $Nm_sc_valores);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['countrycode'] = $countrycode; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['countrycode_cond'] = $countrycode_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['name'] = $name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['name_cond'] = $name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['tax'] = $tax; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['tax_cond'] = $tax_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['taxpercent'] = $taxpercent; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['taxpercent_cond'] = $taxpercent_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $countrycode;
      $this->cmp_formatado['countrycode'] = $Conteudo;
      $Conteudo = $name;
      $this->cmp_formatado['name'] = $Conteudo;
      $Conteudo = $tax;
      $this->cmp_formatado['tax'] = $Conteudo;
      $Conteudo = $taxpercent;
      if (strtoupper($taxpercent_cond) != "II" && strtoupper($taxpercent_cond) != "QP" && strtoupper($taxpercent_cond) != "NP" && strtoupper($taxpercent_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['taxpercent'] = $Conteudo;

      //----- $countrycode
      $this->Date_part = false;
      if (isset($countrycode) || $countrycode_cond == "nu" || $countrycode_cond == "nn" || $countrycode_cond == "ep" || $countrycode_cond == "ne")
      {
         $this->monta_condicao("countrycode", $countrycode_cond, $countrycode, "", "countrycode");
      }
      ...
      //----- $tax
      $this->Date_part = false;
      if (isset($tax) || $tax_cond == "nu" || $tax_cond == "nn" || $tax_cond == "ep" || $tax_cond == "ne")
      {
         $this->monta_condicao("tax", $tax_cond, $tax, "", "tax");
      }

      //----- $taxpercent
      $this->Date_part = false;
      if (isset($taxpercent) || $taxpercent_cond == "nu" || $taxpercent_cond == "nn" || $taxpercent_cond == "ep" || $taxpercent_cond == "ne")
      {
         $this->monta_condicao("taxpercent", $taxpercent_cond, $taxpercent, "", "taxpercent");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_country']['fast_search']);
