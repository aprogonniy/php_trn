<?php  
  ...
  session_start() ;
  class grid_country_form_teste
  {
  function grid_country_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_country_form_teste();
  $frm_teste->grid_country_teste();
?>
