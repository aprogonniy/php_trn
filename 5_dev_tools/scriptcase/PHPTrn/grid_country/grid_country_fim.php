...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_country"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_country"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_country'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_country']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_country']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_country']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_country']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_country']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_country']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_country']['embutida_filho'] as $ind => $sc_init)
          {
