...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "taxpercent";$Nm_numeric[] = "taxpercent";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_countrycode"  <?php echo $str_hide_countrycode?>><INPUT  type="text" id="SC_countrycode" name="countrycode" value="<?php echo NM_encode_input($countrycode) ?>" size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tax"  <?php echo $str_hide_tax?>><INPUT  type="text" id="SC_tax" name="tax" value="<?php echo NM_encode_input($tax) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_taxpercent"  <?php echo $str_hide_taxpercent?>><INPUT  type="text" id="SC_taxpercent" name="taxpercent" value="<?php echo NM_encode_input($taxpercent) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
