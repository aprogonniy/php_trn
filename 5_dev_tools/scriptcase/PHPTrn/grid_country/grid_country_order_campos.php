<?php
   ...
   session_start();
    $Ord_Cmp = new grid_country_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_country_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['countrycode'] = "on";
   $tab_def_campos['countrycode'] = "countrycode";
   $tab_converte["countrycode"]   = "countrycode";
   $tab_labels["countrycode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_country']['labels']["countrycode"])) ? $_SESSION['sc_session'][$sc_init]['grid_country']['labels']["countrycode"] : "" . $this->Nm_lang['lang_country_fild_countrycode'] . "";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_converte["name"]   = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_country']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_country']['labels']["name"] : "" . $this->Nm_lang['lang_country_fild_name'] . "";
   $tab_ger_campos['tax'] = "on";
   $tab_def_campos['tax'] = "tax";
   $tab_converte["tax"]   = "tax";
   $tab_labels["tax"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_country']['labels']["tax"])) ? $_SESSION['sc_session'][$sc_init]['grid_country']['labels']["tax"] : "" . $this->Nm_lang['lang_country_fild_tax'] . "";
   $tab_ger_campos['taxpercent'] = "on";
   $tab_def_campos['taxpercent'] = "taxpercent";
   $tab_converte["taxpercent"]   = "taxpercent";
   $tab_labels["taxpercent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_country']['labels']["taxpercent"])) ? $_SESSION['sc_session'][$sc_init]['grid_country']['labels']["taxpercent"] : "" . $this->Nm_lang['lang_country_fild_taxpercent'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_country']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_country']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_country']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_country']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_country']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_country']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_country']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_country']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_country']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tble_country'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_country_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_country']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_country']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
