<?php  
  ...
  session_start() ;
  class blank_bg_form_teste
  {
  function blank_bg_teste()
  {
...
<input type=submit value="blank_bg"> 
</form> 
...
<?php
  ...
  $frm_teste = new blank_bg_form_teste();
  $frm_teste->blank_bg_teste();
?>
