<?php  
  ...
  session_start() ;
  class grid_subcategory_dependent_form_teste
  {
  function grid_subcategory_dependent_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_subcategory_dependent</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_subcategory_dependent.php" 
               target="_self"> 
...
<input type=submit value="grid_subcategory_dependent"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_subcategory_dependent_form_teste();
  $frm_teste->grid_subcategory_dependent_teste();
?>
