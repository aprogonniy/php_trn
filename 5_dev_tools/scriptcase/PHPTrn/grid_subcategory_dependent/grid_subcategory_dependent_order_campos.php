<?php
   ...
   session_start();
    $Ord_Cmp = new grid_subcategory_dependent_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_subcategory_dependent_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['labels']["description"])) ? $_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['labels']["description"] : "" . $this->Nm_lang['lang_subcategory_fild_description'] . "";
   ...
   $tab_labels["number_of_products"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['labels']["number_of_products"])) ? $_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['labels']["number_of_products"] : "" . $this->Nm_lang['lang_number_of_products'] . "";
   $tab_ger_campos['list_order'] = "on";
   $tab_def_campos['list_order'] = "list_order";
   $tab_converte["list_order"]   = "list_order";
   $tab_labels["list_order"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['labels']["list_order"])) ? $_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['labels']["list_order"] : "" . $this->Nm_lang['lang_list_order'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_subcategory_dependent_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_subcategory_dependent']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
