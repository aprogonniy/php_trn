<?php  
  ...
  session_start() ;
  class grid_creditcards_form_teste
  {
  function grid_creditcards_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_creditcards</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_creditcards.php" 
               target="_self"> 
v_customer&nbsp;&nbsp;<input type=text name="v_customer" size=20><br> 
v_customername&nbsp;&nbsp;<input type=text name="v_customername" size=20><br> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/>
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_creditcards"> 
</form> 
<script language=javascript> 
 document.FCons.v_customer.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_creditcards_form_teste();
  $frm_teste->grid_creditcards_teste();
?>
