<?php  
  ...
  session_start() ;
  class blank_add_cart_form_teste
  {
  function blank_add_cart_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">blank_add_cart</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="blank_add_cart.php" 
               target="_self"> 
...
<input type=submit value="blank_add_cart"> 
</form> 
...
<?php
  ...
  $frm_teste = new blank_add_cart_form_teste();
  $frm_teste->blank_add_cart_teste();
?>
