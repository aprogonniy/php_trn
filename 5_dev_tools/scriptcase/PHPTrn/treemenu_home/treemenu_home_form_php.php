...
class treemenu_home_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['treemenu_home']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['treemenu_home']['glo_nm_path_prod']))
      {
      ...
      $this->nm_location .= "treemenu_home.php"; 
      $this->menu_sc_init = 1;
...
<?php
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "treemenu_home")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("container") . "/container.php?nm_run_menu=1&nm_apl_menu=treemenu_home&script_case_init=1&script_case_session=" . session_id() . "";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['treemenu_home']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['treemenu_home'] as $id_item => $arr_item)
         {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="treemenu_home"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "treemenu_home")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'treemenu_home', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
SC_dir_app_ini('PHPTrn');
$controle = new treemenu_home_form_php();
$controle->init();
?>
