<?php
   ...
   session_start();
    $Ord_Cmp = new grid_customers_customer_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_customers_customer_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["name"] : "" . $this->Nm_lang['lang_customers_fild_name'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["email"] : "" . $this->Nm_lang['lang_customers_fild_email'] . "";
   $tab_ger_campos['changepassword'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['changepassword'] = "changepassword";
       $tab_converte["changepassword"]   = "changepassword";
   }
   else
   {
       $tab_def_campos['changepassword'] = "";
       $tab_converte[""]   = "changepassword";
   }
   $tab_labels["changepassword"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["changepassword"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["changepassword"] : " ";
   $tab_ger_campos['address_link'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['address_link'] = "address_link";
       $tab_converte["address_link"]   = "address_link";
   }
   else
   {
       $tab_def_campos['address_link'] = "";
       $tab_converte[""]   = "address_link";
   }
   $tab_labels["address_link"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["address_link"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["address_link"] : "";
   $tab_ger_campos['creditcards_link'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['creditcards_link'] = "creditcards_link";
       $tab_converte["creditcards_link"]   = "creditcards_link";
   }
   else
   {
       $tab_def_campos['creditcards_link'] = "";
       $tab_converte[""]   = "creditcards_link";
   }
   $tab_labels["creditcards_link"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["creditcards_link"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["creditcards_link"] : "";
   $tab_ger_campos['orders_link'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['orders_link'] = "orders_link";
       $tab_converte["orders_link"]   = "orders_link";
   }
   else
   {
       $tab_def_campos['orders_link'] = "";
       $tab_converte[""]   = "orders_link";
   }
   $tab_labels["orders_link"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["orders_link"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['labels']["orders_link"] : "&nbsp;";
   $tab_ger_campos['changepassword'] = "none";
   $tab_ger_campos['address_link'] = "none";
   $tab_ger_campos['creditcards_link'] = "none";
   $tab_ger_campos['orders_link'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_customers_customer']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_customers_customer']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_customers_customer']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_customers_customer']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_tble_customers'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_customers_customer_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_customers_customer']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
...
?>
     <li class="sc_ui_litem scAppDivSelectFieldsEnabled" id="sc_id_itemord_<?php echo $NM_cada_field; ?>">
      ...
      <select id="sc_id_class_<?php echo NM_encode_input($tab_def_campos[ $tab_converte[$NM_cada_field] ]); ?>" class="scAppDivToolbarInput">
...
<?php
   ...
   {
?>
   <?php echo nmButtonOutput($this->arr_buttons, "bapply", "scSubmitOrderCampos('" . $tbar_pos . "', 'cmp')", "scSubmitOrderCampos('" . $tbar_pos . "', 'cmp')", "f_sel_sub", "", "", "display: none;", "absmiddle", "", "0px", $path_btn, "", "", "", "", "", "only_text", "text_right", "", "", "", "");
?>
<?php
   }
?>
...
<?php
   ...
   {
?>
   <?php echo nmButtonOutput($this->arr_buttons, "bcancelar", "scBtnOrderCamposHide('" . $tbar_pos . "')", "scBtnOrderCamposHide('" . $tbar_pos . "')", "Bsair", "", "", "", "absmiddle", "", "0px", $path_btn, "", "", "", "", "", "only_text", "text_right", "", "", "", "");
?>
<?php
   }
?>
