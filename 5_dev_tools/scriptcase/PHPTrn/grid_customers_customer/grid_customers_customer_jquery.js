...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
      type: "POST",
      url: "grid_customers_customer.php",
      ...
      success: function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_customers_customer').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_customers_customer').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_customers_customer').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_customers_customer').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_customers_customer').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_customers_customer').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_customers_customer').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_customers_customer').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_customers_customer').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_customers_customer').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_customers_customer').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_customers_customer').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
