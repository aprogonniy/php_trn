...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "customersid";$Nm_numeric[] = "customersid";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_email"  <?php echo $str_hide_email?>><INPUT  type="text" id="SC_email" name="email" value="<?php echo NM_encode_input($email) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_passwd"  <?php echo $str_hide_passwd?>><INPUT  type="text" id="SC_passwd" name="passwd" value="<?php echo NM_encode_input($passwd) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
