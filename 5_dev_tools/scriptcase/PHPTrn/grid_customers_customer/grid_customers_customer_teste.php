<?php  
  ...
  session_start() ;
  class grid_customers_customer_form_teste
  {
  function grid_customers_customer_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_customers_customer</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_customers_customer.php" 
               target="_self"> 
...
<input type=submit value="grid_customers_customer"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_customers_customer_form_teste();
  $frm_teste->grid_customers_customer_teste();
?>
