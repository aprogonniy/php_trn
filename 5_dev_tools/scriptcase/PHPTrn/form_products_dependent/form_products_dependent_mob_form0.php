...
<?php
include_once("form_products_dependent_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_products_dependent_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['recarga'];
}
?>
...
<?php
 include_once("form_products_dependent_mob_js0.php");
?>
...
<form name="F1" method="post" enctype="multipart/form-data" 
               action="form_products_dependent_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_products_dependent_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_products_dependent_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_products_dependent_mob_form0";
</script>
<ul class="scTabLine">
<?php
    if ($nmgp_num_form == "form_products_dependent_mob_form0")
    {
...
?>
   <li id="id_form_products_dependent_mob_form0" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_mob_form0')">
     <?php echo $this->Ini->Nm_lang['lang_products_fild_name']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_mob_form1")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_mob_form1" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_mob_form1')">
     <?php echo $this->Ini->Nm_lang['lang_description']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_mob_form2")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_mob_form2" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_mob_form2')">
     <?php echo $this->Ini->Nm_lang['lang_products_fild_picture']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_mob_form3")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_mob_form3" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_mob_form3')">
     <?php echo $this->Ini->Nm_lang['lang_overview']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_mob_form4")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_mob_form4" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_mob_form4')">
     <?php echo $this->Ini->Nm_lang['lang_specifications']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_mob_form5")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_mob_form5" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_mob_form5')">
...
<div id="form_products_dependent_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
