<?php  
  session_start() ;
  class form_products_dependent_form_teste
  {
   function form_products_dependent_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_products_dependent/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_products_dependent</FONT></B> 
<br> 
<form name="Fedit" method="post" 
               action="form_products_dependent.php" 
               target="_self"> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/><input type="hidden" name="nmgp_outra_jan" value="true"/>v_category&nbsp;&nbsp;<input type="text" name="v_category" size=20><br> 
v_subcategory&nbsp;&nbsp;<input type="text" name="v_subcategory" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="form_products_dependent"> 
</form> 
<script language=javascript> 
 document.Fedit.v_category.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_products_dependent_form_teste();
  $frm_teste->form_products_dependent_teste();
?>
