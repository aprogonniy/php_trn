...
<?php
include_once("form_products_dependent_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_products_dependent_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['recarga'];
}
?>
...
<?php
 include_once("form_products_dependent_js0.php");
?>
...
<form name="F1" method="post" enctype="multipart/form-data" 
               action="form_products_dependent.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_products_dependent'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_products_dependent'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products_dependent']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_products_dependent_form0";
</script>
<ul class="scTabLine">
<?php
    if (empty($nmgp_num_form) || $nmgp_num_form == "form_products_dependent_form0")
    {
...
?>
   <li id="id_form_products_dependent_form0" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_form0')">
     <?php echo $this->Ini->Nm_lang['lang_products_fild_name']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_form1")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_form1" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_form1')">
     <?php echo $this->Ini->Nm_lang['lang_description']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_form2")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_form2" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_form2')">
     <?php echo $this->Ini->Nm_lang['lang_products_fild_picture']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_form3")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_form3" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_form3')">
     <?php echo $this->Ini->Nm_lang['lang_overview']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_form4")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_form4" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_form4')">
     <?php echo $this->Ini->Nm_lang['lang_specifications']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_dependent_form5")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_dependent_form5" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_dependent_form5')">
...
<div id="form_products_dependent_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
order by description";
   ...
   while (!empty($todo[$x])) 
   {
          ...
          elseif (trim($this->categoryid) === trim($cadaselect[1])) { $categoryid_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="categoryid" value="<?php echo NM_encode_input($categoryid) . "\">" . $categoryid_look . ""; ?>
<?php } else { ?>
...
order by description";
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_categoryid\" style=\";" .  $sStyleReadLab_categoryid . "\">" . NM_encode_input($categoryid_look) . "</span><span id=\"id_read_off_categoryid\" style=\"" . $sStyleReadInp_categoryid . "\">";
   echo " <span id=\"idAjaxSelect_categoryid\"><select class=\"sc-js-input scFormObjectOdd\" style=\";\" id=\"id_sc_field_categoryid\" name=\"categoryid\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   ...
   echo " </select></span>" ; 
   echo "\r" ; 
 ?>&nbsp;<?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_categoryid", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_category_edit . "?script_case_init=" . $this->Ini->sc_page . "&script_case_session=" . session_id() . "&nmgp_url_saida=modal&nmgp_parms=sc_redir_atualiz*scinok*scout&nmgp_outra_jan=true&nm_evt_ret_edit=do_ajax_form_products_dependent_lkpedt_refresh_categoryid&KeepThis=true&TB_iframe=true&height=250&width=300&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
<input type=hidden name="subcategoryid" value="<?php echo NM_encode_input($this->subcategoryid) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
order by description";
   ...
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->subcategoryid_1))
          {
              foreach ($this->subcategoryid_1 as $tmp_subcategoryid)
              {
                  if (trim($tmp_subcategoryid) === trim($cadaselect[1])) { $subcategoryid_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->subcategoryid) === trim($cadaselect[1])) { $subcategoryid_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="subcategoryid" value="<?php echo NM_encode_input($subcategoryid) . "\">" . $subcategoryid_look . ""; ?>
<?php } else { ?>
...
order by description";
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_subcategoryid\" style=\";" .  $sStyleReadLab_subcategoryid . "\">" . NM_encode_input($subcategoryid_look) . "</span><span id=\"id_read_off_subcategoryid\" style=\"" . $sStyleReadInp_subcategoryid . "\">";
   echo " <span id=\"idAjaxSelect_subcategoryid\"><select class=\"sc-js-input scFormObjectOdd\" style=\";\" id=\"id_sc_field_subcategoryid\" name=\"subcategoryid\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->subcategoryid) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
   ...
   echo " </select></span>" ; 
   echo "\r" ; 
 ?>&nbsp;<?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_subcategoryid", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_subcategory_edit . "?script_case_init=" . $this->Ini->sc_page . "&script_case_session=" . session_id() . "&nmgp_url_saida=modal&nmgp_parms=sc_redir_atualiz*scinok*scout&nmgp_outra_jan=true&nm_evt_ret_edit=do_ajax_form_products_dependent_lkpedt_refresh_subcategoryid&KeepThis=true&TB_iframe=true&height=300&width=550&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
order by description";
   ...
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->shippingid_1))
          {
              foreach ($this->shippingid_1 as $tmp_shippingid)
              {
                  if (trim($tmp_shippingid) === trim($cadaselect[1])) { $shippingid_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->shippingid) === trim($cadaselect[1])) { $shippingid_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="shippingid" value="<?php echo NM_encode_input($shippingid) . "\">" . $shippingid_look . ""; ?>
<?php } else { ?>
...
order by description";
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_shippingid\" style=\";" .  $sStyleReadLab_shippingid . "\">" . NM_encode_input($shippingid_look) . "</span><span id=\"id_read_off_shippingid\" style=\"" . $sStyleReadInp_shippingid . "\">";
   echo " <span id=\"idAjaxSelect_shippingid\"><select class=\"sc-js-input scFormObjectOdd\" style=\";\" id=\"id_sc_field_shippingid\" name=\"shippingid\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   ...
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->shippingid) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
   ...
   echo " </select></span>" ; 
   echo "\r" ; 
 ?>&nbsp;<?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_shippingid", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_shipping_edit . "?script_case_init=" . $this->Ini->sc_page . "&script_case_session=" . session_id() . "&nmgp_url_saida=modal&nmgp_parms=sc_redir_atualiz*scinok*scout&nmgp_outra_jan=true&nm_evt_ret_edit=do_ajax_form_products_dependent_lkpedt_refresh_shippingid&KeepThis=true&TB_iframe=true&height=430&width=610&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
<span id="id_read_on_onhandquantity" class="sc-ui-readonly-onhandquantity" style=";<?php echo $sStyleReadLab_onhandquantity; ?>"><?php echo NM_encode_input($this->onhandquantity); ?></span><span id="id_read_off_onhandquantity" style="white-space: nowrap;<?php echo $sStyleReadInp_onhandquantity; ?>">
 <input class="sc-js-input scFormObjectOdd" style="text-align:right;" id="id_sc_field_onhandquantity" type=text name="onhandquantity" value="<?php echo NM_encode_input($onhandquantity) ?>"
 size=30 maxlength=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['onhandquantity']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['onhandquantity']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
