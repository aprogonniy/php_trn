...
function scFocusField(sField) {
  ...
  if (0 < $oField.length) {
    switch ($oField[0].name) {
      ...
      case 'onhandquantity':
      case 'measure':
        sc_exib_ocult_pag('form_products_dependent_mob_form0');
        break;
      case 'description':
        sc_exib_ocult_pag('form_products_dependent_mob_form1');
        break;
      case 'picture':
        sc_exib_ocult_pag('form_products_dependent_mob_form2');
        break;
      case 'overview':
        sc_exib_ocult_pag('form_products_dependent_mob_form3');
        break;
      case 'specifications':
        sc_exib_ocult_pag('form_products_dependent_mob_form4');
        break;
      case 'acessories':
        sc_exib_ocult_pag('form_products_dependent_mob_form5');
        break;
    }
  }
