  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_shippingrates" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate shippingid
  function do_ajax_form_shippingrates_validate_shippingid()
  {
    var nomeCampo_shippingid = "shippingid";
    var var_shippingid = scAjaxGetFieldSelect(nomeCampo_shippingid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_shippingrates_validate_shippingid(var_shippingid, var_script_case_init, do_ajax_form_shippingrates_validate_shippingid_cb);
  } // do_ajax_form_shippingrates_validate_shippingid

  function do_ajax_form_shippingrates_validate_shippingid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_shippingrates_validate_shippingid_cb

  // ---------- Validate weightfrom
  function do_ajax_form_shippingrates_validate_weightfrom()
  {
    var nomeCampo_weightfrom = "weightfrom";
    var var_weightfrom = scAjaxGetFieldText(nomeCampo_weightfrom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_shippingrates_validate_weightfrom(var_weightfrom, var_script_case_init, do_ajax_form_shippingrates_validate_weightfrom_cb);
  } // do_ajax_form_shippingrates_validate_weightfrom

  function do_ajax_form_shippingrates_validate_weightfrom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_shippingrates_validate_weightfrom_cb

  // ---------- Validate weightto
  function do_ajax_form_shippingrates_validate_weightto()
  {
    var nomeCampo_weightto = "weightto";
    var var_weightto = scAjaxGetFieldText(nomeCampo_weightto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_shippingrates_validate_weightto(var_weightto, var_script_case_init, do_ajax_form_shippingrates_validate_weightto_cb);
  } // do_ajax_form_shippingrates_validate_weightto

  function do_ajax_form_shippingrates_validate_weightto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_shippingrates_validate_weightto_cb

  // ---------- Validate price
  function do_ajax_form_shippingrates_validate_price()
  {
    var nomeCampo_price = "price";
    var var_price = scAjaxGetFieldText(nomeCampo_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_shippingrates_validate_price(var_price, var_script_case_init, do_ajax_form_shippingrates_validate_price_cb);
  } // do_ajax_form_shippingrates_validate_price

  function do_ajax_form_shippingrates_validate_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "price";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_shippingrates_validate_price_cb
  // ---------- Form
  function do_ajax_form_shippingrates_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_shippingrates_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_shippingrates_submit_form(var_shippingid, var_weightfrom, var_weightto, var_price, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_shippingrates_submit_form_cb);
  } // do_ajax_form_shippingrates_submit_form

  function do_ajax_form_shippingrates_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_shippingrates_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_shippingrates_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_shippingrates_navigate_form(var_shippingratesid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_shippingrates_navigate_form_cb);
  } // do_ajax_form_shippingrates_navigate_form

  function do_ajax_form_shippingrates_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_shippingrates_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_shippingrates_navigate_form_cb
