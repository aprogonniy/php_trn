<?php  
  session_start() ;
  class form_shippingrates_form_teste
  {
   function form_shippingrates_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_shippingrates/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_shippingrates</FONT></B> 
<br> 
...
<input type="submit" value="form_shippingrates"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_shippingrates_form_teste();
  $frm_teste->form_shippingrates_teste();
?>
