<?php  
  ...
  session_start() ;
  class grid_orders_success_form_teste
  {
  function grid_orders_success_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_orders_success</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_orders_success.php" 
               target="_self"> 
...
<input type=submit value="grid_orders_success"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_orders_success_form_teste();
  $frm_teste->grid_orders_success_teste();
?>
