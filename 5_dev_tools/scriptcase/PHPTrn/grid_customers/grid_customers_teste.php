<?php  
  ...
  session_start() ;
  class grid_customers_form_teste
  {
  function grid_customers_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_customers_form_teste();
  $frm_teste->grid_customers_teste();
?>
