<?php
   ...
   session_start();
    $Ord_Cmp = new grid_customers_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_customers_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["name"] : "" . $this->Nm_lang['lang_customers_fild_name'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["email"] : "" . $this->Nm_lang['lang_customers_fild_email'] . "";
   ...
   $tab_labels["changepassword"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["changepassword"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["changepassword"] : " ";
   ...
   $tab_labels["address_link"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["address_link"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["address_link"] : "";
   ...
   $tab_labels["creditcards_link"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["creditcards_link"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["creditcards_link"] : "";
   ...
   $tab_labels["orders_link"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["orders_link"])) ? $_SESSION['sc_session'][$sc_init]['grid_customers']['labels']["orders_link"] : "&nbsp;";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_customers']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_customers']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_customers']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_customers_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_customers']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
