<?php
   ...
   $_SESSION['scriptcase']['blank']['glo_nm_path_conf']       = "C:/development-PHPTRN/src/5_dev_tools/scriptcase/wwwroot/scriptcase/conf";
   ...
   $_SESSION['scriptcase']['blank']['glo_nm_path_doc']        = "C:/development-PHPTRN/src/5_dev_tools/scriptcase/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['blank']['glo_nm_conexao']         = "conn_example";
//
class blank_ini
{
   var $nm_cod_apl;
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      ob_start();
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank']['glo_nm_conexao'], $this->root . $this->path_prod, 'PHPTrn'); 
      } 
      else 
      { 
...
//----- 
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank']['sc_outra_jan']))
      {
          ...
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank') . "/blank.php";
      ...
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "blank.php"; 
...
<body style="margin: 0px">
  <center>
    <div id="slider1">
        ...
        {
          ?>
            <li class="slider1Image" style="width:650px; height:150px;">
                <img src="<?php echo $img['img']; ?>" width="650" height="150">
                <span class="left"><?php echo $img['desc']; ?></span>
            </li>
          <?php
        }
        ?>
...
$_SESSION['scriptcase']['blank']['contr_erro'] = 'on';
      ...
      $nm_select = "SELECT producthomeid , picture, description FROM producthome ORDER BY list_order"; 
...
if(isset($rs[0][0]))
{
  include_once($this->Ini->root . $this->Ini->path_prod . "/lib/php/nm_trata_img.php");
  $cont=0;
  foreach($rs  as $pr)
  {
        $conteudo = $pr[1];
	...
	$out_picture = $this->Ini->path_imag_temp . "/sc_slide_product_" . $pr[0] . md5($pr[0]) . ".jpg" ;    
	$arq_picture = fopen($this->Ini->root . $out_picture, "w") ;   
	if ((strstr(strtoupper($this->Ini->nm_tpbanco),"MSSQL") || strstr(strtoupper($this->Ini->nm_tpbanco),"PDOSQLITE")) && substr($conteudo, 0, 4) == "*nm*")  
	{  
	...
	$arr_images[$cont]['img']   = $out_picture;
	$arr_images[$cont]['desc']   = $pr[2];
    }
}
