  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cardtype" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_cardtype_validate_description_(iNumLinha)
  {
    ...
    x_ajax_form_cardtype_validate_description_(var_description_, iNumLinha, var_script_case_init, do_ajax_form_cardtype_validate_description__cb);
  } // do_ajax_form_cardtype_validate_description_

  function do_ajax_form_cardtype_validate_description__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cardtype_validate_description__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cardtype_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cardtype_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cardtype_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cardtype_add_new_line_cb);
  } // do_ajax_form_cardtype_add_new_line

  function do_ajax_form_cardtype_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_cardtype_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cardtype_backup_line(iNumLinha)
  {
    var var_cardtypeid_ = scAjaxGetFieldText("cardtypeid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cardtype_backup_line(var_cardtypeid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cardtype_backup_line_cb);
  } // do_ajax_form_cardtype_backup_line

  function do_ajax_form_cardtype_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_cardtype_backup_line_cb

  function do_ajax_form_cardtype_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cardtype_cancel_insert

  function do_ajax_form_cardtype_cancel_update(iSeqVert)
  {
    do_ajax_form_cardtype_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cardtype_cancel_update

  function do_ajax_form_cardtype_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cardtype_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cardtype_table_refresh()
  {
    var var_cardtypeid_ = document.F2.cardtypeid_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cardtype_table_refresh(var_cardtypeid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cardtype_table_refresh_cb);
  } //  do_ajax_form_cardtype_table_refresh

  function do_ajax_form_cardtype_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.cardtypeid_.value = scAjaxGetKeyValue("cardtypeid_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_cardtype_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cardtype_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cardtype_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_cardtype_submit_form(var_description_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_cardtype_submit_form_cb);
  } // do_ajax_form_cardtype_submit_form

  function do_ajax_form_cardtype_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_cardtype_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_cardtype_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_cardtype_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cardtype_navigate_form(var_cardtypeid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cardtype_navigate_form_cb);
  } // do_ajax_form_cardtype_navigate_form

  function do_ajax_form_cardtype_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.cardtypeid_.value = scAjaxGetKeyValue("cardtypeid_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_cardtype_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_error_list["description_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cardtype_fild_description'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
