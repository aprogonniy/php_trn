<?php  
  session_start() ;
  class form_cardtype_form_teste
  {
   function form_cardtype_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_cardtype/img";
...
<?php
  ...
  $frm_teste = new form_cardtype_form_teste();
  $frm_teste->form_cardtype_teste();
?>
