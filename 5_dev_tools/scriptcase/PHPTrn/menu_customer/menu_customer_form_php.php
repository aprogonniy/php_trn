...
class menu_customer_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['menu_customer']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_customer']['glo_nm_path_prod']))
      {
      ...
      $this->nm_location .= "menu_customer.php"; 
      $this->menu_sc_init = 1;
...
<?php
      ...
      $_SESSION['scriptcase']['menu_customer']['contr_erro'] = 'on';
 if($this->sc_menu_item == "item_2"){

echo "<script>parent.location.href='../login_customer/login_customer.php';</script>";
...
$_SESSION['scriptcase']['menu_customer']['contr_erro'] = 'off';
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "menu_customer")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_orders_customer") . "/grid_orders_customer.php?nm_run_menu=1&nm_apl_menu=menu_customer&script_case_init=1&script_case_session=" . session_id() . "";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['menu_customer']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_customer'] as $id_item => $arr_item)
         {
      ...
      {
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "grid_customers_customer")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_customers_customer") . "/grid_customers_customer.php?nm_run_menu=1&nm_apl_menu=menu_customer&script_case_init=" . $this->Gera_sc_init('grid_customers_customer') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "grid_orders_customer")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_orders_customer") . "/grid_orders_customer.php?nm_run_menu=1&nm_apl_menu=menu_customer&script_case_init=" . $this->Gera_sc_init('grid_orders_customer') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "grid_address_customer")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_address_customer") . "/grid_address_customer.php?nm_run_menu=1&nm_apl_menu=menu_customer&script_case_init=" . $this->Gera_sc_init('grid_address_customer') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "grid_creditcards_customer")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_creditcards_customer") . "/grid_creditcards_customer.php?nm_run_menu=1&nm_apl_menu=menu_customer&script_case_init=" . $this->Gera_sc_init('grid_creditcards_customer') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_apl_menu'] == "login_customer")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("login_customer") . "/login_customer.php?nm_run_menu=1&nm_apl_menu=menu_customer&script_case_init=" . $this->Gera_sc_init('login_customer') . "&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_customer"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_customer")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_customer', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
SC_dir_app_ini('PHPTrn');
$controle = new menu_customer_form_php();
$controle->init();
?>
