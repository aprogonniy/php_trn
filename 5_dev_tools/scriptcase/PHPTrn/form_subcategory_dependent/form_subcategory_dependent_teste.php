<?php  
  session_start() ;
  class form_subcategory_dependent_form_teste
  {
   function form_subcategory_dependent_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_subcategory_dependent/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_subcategory_dependent</FONT></B> 
<br> 
...
<input type="submit" value="form_subcategory_dependent"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_subcategory_dependent_form_teste();
  $frm_teste->form_subcategory_dependent_teste();
?>
