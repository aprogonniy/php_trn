<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="customersid" value="<?php echo NM_encode_input($this->nmgp_dados_form['customersid']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
function sc_btn_ship()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_ship(); }, 500);
      return;
    }
  nm_gp_submit('<?php echo $this->Ini->link_grid_cart_confirm_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo ""; ?>', 'inicio', '_self');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase']['where_detal']))
  {
?>  
