...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_tble_address'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_tble_address'] . ""); } ?></TITLE>
...
<?php
include_once("form_address_purchase_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_address_purchase_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['recarga'];
}
?>
...
<?php
 include_once("form_address_purchase_mob_js0.php");
?>
...
<form name="F1" method="post" 
               action="form_address_purchase_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['insert_validation']; ?>">
<?php
}
?>
...
<input type="hidden" name="customersid" value="<?php  echo NM_encode_input($this->customersid) ?>">
<input type="hidden" name="_sc_force_mobile" id="sc-id-mobile-control" value="" />
<?php
$_SESSION['scriptcase']['error_span_title']['form_address_purchase_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_address_purchase_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php echo "" . $_SESSION['v_custname'] . "" ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
?>
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%; border-width: 1px; border-color: #E9E9E9;">   <tr>


    <TD colspan="1" height="20" class="scFormBlock" style="background-color: #E9E9E9">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php echo $this->Ini->Nm_lang['lang_address_fild_description'] ?></TD>
...
<?php $sStyleHidden_phone2_dumb = ('' == $sStyleHidden_phone2) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_phone2_dumb" style="<?php echo $sStyleHidden_phone2_dumb; ?>"></TD>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable" width="100%" style="height: 100%; border-width: 1px; border-color: #E9E9E9;">   <tr>


    <TD colspan="1" height="20" class="scFormBlock" style="background-color: #E9E9E9">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php echo $this->Ini->Nm_lang['lang_tble_address'] ?></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['address1'] = "address1";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_address1" style="<?php echo $sStyleHidden_address1; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_address1"><?php echo $this->nm_new_label['address1']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['address1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['address1'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_address1_dumb = ('' == $sStyleHidden_address1) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_address1_dumb" style="<?php echo $sStyleHidden_address1_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
   ...
   <?php
    ...
    {
        $this->nm_new_label['address2'] = "address2";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } 
?> 
<?php $sStyleHidden_address2_dumb = ('' == $sStyleHidden_address2) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_address2_dumb" style="<?php echo $sStyleHidden_address2_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_country" style="<?php echo $sStyleHidden_country; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_country"><?php echo $this->nm_new_label['country']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['country']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['country'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['states']))
   {
       $this->nm_new_label['states'] = "states";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $states = $this->states;
   $sStyleHidden_states = '';
   if (isset($this->nmgp_cmp_hidden['states']) && $this->nmgp_cmp_hidden['states'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['states']);
       $sStyleHidden_states = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_states = 'display: none;';
   $sStyleReadInp_states = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['states']) && $this->nmgp_cmp_readonly['states'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['states']);
       $sStyleReadLab_states = '';
       $sStyleReadInp_states = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['states']) && $this->nmgp_cmp_hidden['states'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="states" value="<?php echo NM_encode_input($this->states) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd" id="hidden_field_data_states" style="<?php echo $sStyleHidden_states; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_states"><?php echo $this->nm_new_label['states']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["states"]) &&  $this->nmgp_cmp_readonly["states"] == "on") { 
...
order by name";
   ...
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->states_1))
          {
              foreach ($this->states_1 as $tmp_states)
              {
                  if (trim($tmp_states) === trim($cadaselect[1])) { $states_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->states) === trim($cadaselect[1])) { $states_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="states" value="<?php echo NM_encode_input($states) . "\">" . $states_look . ""; ?>
<?php } else { ?>
...
order by name";
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_states\" style=\";" .  $sStyleReadLab_states . "\">" . NM_encode_input($states_look) . "</span><span id=\"id_read_off_states\" style=\"" . $sStyleReadInp_states . "\">";
   echo " <span id=\"idAjaxSelect_states\"><select class=\"sc-js-input scFormObjectOdd\" style=\";\" id=\"id_sc_field_states\" name=\"states\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->states) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
...
?> 
<?php  }?>
</td><td style="vertical-align: top; padding: 0px 0px 0px 2px"><table class="scFormFieldErrorTable" style="display: none; position: absolute" id="id_error_display_states_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_states_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } 
?> 
<?php $sStyleHidden_states_dumb = ('' == $sStyleHidden_states) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_states_dumb" style="<?php echo $sStyleHidden_states_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_city" style="<?php echo $sStyleHidden_city; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_city"><?php echo $this->nm_new_label['city']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['city']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['city'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['phone1']))
    {
        $this->nm_new_label['phone1'] = "phone1";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $phone1 = $this->phone1;
   $sStyleHidden_phone1 = '';
   if (isset($this->nmgp_cmp_hidden['phone1']) && $this->nmgp_cmp_hidden['phone1'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['phone1']);
       $sStyleHidden_phone1 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_phone1 = 'display: none;';
   $sStyleReadInp_phone1 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['phone1']) && $this->nmgp_cmp_readonly['phone1'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['phone1']);
       $sStyleReadLab_phone1 = '';
       $sStyleReadInp_phone1 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['phone1']) && $this->nmgp_cmp_hidden['phone1'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="phone1" value="<?php echo NM_encode_input($phone1) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd" id="hidden_field_data_phone1" style="<?php echo $sStyleHidden_phone1; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_phone1"><?php echo $this->nm_new_label['phone1']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['phone1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['phone1'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["phone1"]) &&  $this->nmgp_cmp_readonly["phone1"] == "on") { 

 ?>
<input type="hidden" name="phone1" value="<?php echo NM_encode_input($phone1) . "\">" . $phone1 . ""; ?>
<?php } else { ?>
<span id="id_read_on_phone1" class="sc-ui-readonly-phone1" style=";<?php echo $sStyleReadLab_phone1; ?>"><?php echo NM_encode_input($this->phone1); ?></span><span id="id_read_off_phone1" style="white-space: nowrap;<?php echo $sStyleReadInp_phone1; ?>">
 <input class="sc-js-input scFormObjectOdd" style=";" id="id_sc_field_phone1" type=text name="phone1" value="<?php echo NM_encode_input($phone1) ?>"
 size=20 maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td><td style="vertical-align: top; padding: 0px 0px 0px 2px"><table class="scFormFieldErrorTable" style="display: none; position: absolute" id="id_error_display_phone1_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_phone1_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } 
?> 
<?php $sStyleHidden_phone1_dumb = ('' == $sStyleHidden_phone1) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_phone1_dumb" style="<?php echo $sStyleHidden_phone1_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>


   <?php
    if (!isset($this->nm_new_label['phone2']))
    {
        $this->nm_new_label['phone2'] = "phone2";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $phone2 = $this->phone2;
   $sStyleHidden_phone2 = '';
   if (isset($this->nmgp_cmp_hidden['phone2']) && $this->nmgp_cmp_hidden['phone2'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['phone2']);
       $sStyleHidden_phone2 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_phone2 = 'display: none;';
   $sStyleReadInp_phone2 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['phone2']) && $this->nmgp_cmp_readonly['phone2'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['phone2']);
       $sStyleReadLab_phone2 = '';
       $sStyleReadInp_phone2 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['phone2']) && $this->nmgp_cmp_hidden['phone2'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="phone2" value="<?php echo NM_encode_input($phone2) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd" id="hidden_field_data_phone2" style="<?php echo $sStyleHidden_phone2; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_phone2"><?php echo $this->nm_new_label['phone2']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["phone2"]) &&  $this->nmgp_cmp_readonly["phone2"] == "on") { 

 ?>
<input type="hidden" name="phone2" value="<?php echo NM_encode_input($phone2) . "\">" . $phone2 . ""; ?>
<?php } else { ?>
<span id="id_read_on_phone2" class="sc-ui-readonly-phone2" style=";<?php echo $sStyleReadLab_phone2; ?>"><?php echo NM_encode_input($this->phone2); ?></span><span id="id_read_off_phone2" style="white-space: nowrap;<?php echo $sStyleReadInp_phone2; ?>">
 <input class="sc-js-input scFormObjectOdd" style=";" id="id_sc_field_phone2" type=text name="phone2" value="<?php echo NM_encode_input($phone2) ?>"
 size=20 maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td><td style="vertical-align: top; padding: 0px 0px 0px 2px"><table class="scFormFieldErrorTable" style="display: none; position: absolute" id="id_error_display_phone2_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_phone2_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['postalcode'] = "postalcode";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_postalcode" style="<?php echo $sStyleHidden_postalcode; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_postalcode"><?php echo $this->nm_new_label['postalcode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['postalcode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['php_cmp_required']['postalcode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_address_purchase_mob']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_address_purchase_mob");
 parent.scAjaxDetailHeight("form_address_purchase_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
