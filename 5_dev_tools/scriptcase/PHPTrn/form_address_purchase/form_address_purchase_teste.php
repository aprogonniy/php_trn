<?php  
  session_start() ;
  class form_address_purchase_form_teste
  {
   function form_address_purchase_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_address_purchase/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_address_purchase</FONT></B> 
<br> 
...
v_custname&nbsp;&nbsp;<input type="text" name="v_custname" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="form_address_purchase"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_address_purchase_form_teste();
  $frm_teste->form_address_purchase_teste();
?>
