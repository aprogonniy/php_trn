<?php
   ...
   session_start();
    $Ord_Cmp = new grid_address_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_address_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_address']['labels']["description"])) ? $_SESSION['sc_session'][$sc_init]['grid_address']['labels']["description"] : "" . $this->Nm_lang['lang_address_fild_description'] . "";
   $tab_ger_campos['country'] = "on";
   $tab_def_campos['country'] = "country";
   $tab_converte["country"]   = "country";
   $tab_labels["country"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_address']['labels']["country"])) ? $_SESSION['sc_session'][$sc_init]['grid_address']['labels']["country"] : "" . $this->Nm_lang['lang_address_fild_country'] . "";
   $tab_ger_campos['states'] = "on";
   $tab_def_campos['states'] = "states";
   $tab_converte["states"]   = "states";
   $tab_labels["states"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_address']['labels']["states"])) ? $_SESSION['sc_session'][$sc_init]['grid_address']['labels']["states"] : "" . $this->Nm_lang['lang_address_fild_state'] . "";
   $tab_ger_campos['city'] = "on";
   $tab_def_campos['city'] = "city";
   $tab_converte["city"]   = "city";
   $tab_labels["city"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_address']['labels']["city"])) ? $_SESSION['sc_session'][$sc_init]['grid_address']['labels']["city"] : "" . $this->Nm_lang['lang_address_fild_city'] . "";
   $tab_ger_campos['address1'] = "on";
   $tab_def_campos['address1'] = "address1";
   $tab_converte["address1"]   = "address1";
   $tab_labels["address1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_address']['labels']["address1"])) ? $_SESSION['sc_session'][$sc_init]['grid_address']['labels']["address1"] : "" . $this->Nm_lang['lang_address_fild_address1'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_address']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_address']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_address']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_address']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_address']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_address']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_address']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_address']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_address']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_address_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_address']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_address']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
