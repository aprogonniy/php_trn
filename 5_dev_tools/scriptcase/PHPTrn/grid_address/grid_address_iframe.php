...
$oExportPdf = new grid_address_export_pdf;
$oExportPdf->exportPdf();

class grid_address_export_pdf {
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_address_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_address']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_address']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_address.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_address']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_address']['pdf_name'] : "grid_address.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="grid_address.php" target="<?php echo $NM_target; ?>" style="display: none"> 
