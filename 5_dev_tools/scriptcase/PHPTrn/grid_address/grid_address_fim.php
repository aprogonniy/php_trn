...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_address"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_address"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_address'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_address']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_address']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_address']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_address']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_address']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_address']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_address']['embutida_filho'] as $ind => $sc_init)
          {
