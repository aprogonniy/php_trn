<?php  
  ...
  session_start() ;
  class grid_address_form_teste
  {
  function grid_address_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_address</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_address.php" 
               target="_self"> 
...
<input type=submit value="grid_address"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_address_form_teste();
  $frm_teste->grid_address_teste();
?>
