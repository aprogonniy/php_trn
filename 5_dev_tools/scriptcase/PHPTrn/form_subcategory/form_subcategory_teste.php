<?php  
  session_start() ;
  class form_subcategory_form_teste
  {
   function form_subcategory_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_subcategory/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_subcategory</FONT></B> 
<br> 
...
<input type="submit" value="form_subcategory"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_subcategory_form_teste();
  $frm_teste->form_subcategory_teste();
?>
