<?php  
  session_start() ;
  class form_orderitens_form_teste
  {
   function form_orderitens_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_orderitens/img";
...
<?php
  ...
  $frm_teste = new form_orderitens_form_teste();
  $frm_teste->form_orderitens_teste();
?>
