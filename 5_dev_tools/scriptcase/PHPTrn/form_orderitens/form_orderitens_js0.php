<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="orderid_" value="<?php echo NM_encode_input($this->nmgp_dados_form['orderid_']); ?>">
<input type="hidden" name="productid_" value="<?php echo NM_encode_input($this->nmgp_dados_form['productid_']); ?>">
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_orderitens_submit_form(y, z); 
} 
<?php
}
?>
