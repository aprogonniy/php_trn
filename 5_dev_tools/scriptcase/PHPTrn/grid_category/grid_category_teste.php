<?php  
  ...
  session_start() ;
  class grid_category_form_teste
  {
  function grid_category_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_category_form_teste();
  $frm_teste->grid_category_teste();
?>
