...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_category"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_category"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_category'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_category']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_category']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_category']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_category']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_category']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_category']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_category']['embutida_filho'] as $ind => $sc_init)
          {
