<?php  
  session_start() ;
  class form_address_restore_form_teste
  {
   function form_address_restore_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_address_restore/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_address_restore</FONT></B> 
<br> 
...
<input type="submit" value="form_address_restore"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_address_restore_form_teste();
  $frm_teste->form_address_restore_teste();
?>
