<?php  
  session_start() ;
  class form_producthome_form_teste
  {
   function form_producthome_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_producthome/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_producthome</FONT></B> 
<br> 
...
<input type="submit" value="form_producthome"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_producthome_form_teste();
  $frm_teste->form_producthome_teste();
?>
