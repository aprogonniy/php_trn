  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_producthome_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate picture
  function do_ajax_form_producthome_mob_validate_picture()
  {
    var nomeCampo_picture = "picture";
    var var_picture = scAjaxGetFieldText(nomeCampo_picture);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producthome_mob_validate_picture(var_picture, var_script_case_init, do_ajax_form_producthome_mob_validate_picture_cb);
  } // do_ajax_form_producthome_mob_validate_picture

  function do_ajax_form_producthome_mob_validate_picture_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producthome_mob_validate_picture_cb

  // ---------- Validate list_order
  function do_ajax_form_producthome_mob_validate_list_order()
  {
    var nomeCampo_list_order = "list_order";
    var var_list_order = scAjaxGetFieldText(nomeCampo_list_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producthome_mob_validate_list_order(var_list_order, var_script_case_init, do_ajax_form_producthome_mob_validate_list_order_cb);
  } // do_ajax_form_producthome_mob_validate_list_order

  function do_ajax_form_producthome_mob_validate_list_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producthome_mob_validate_list_order_cb

  // ---------- Validate description
  function do_ajax_form_producthome_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producthome_mob_validate_description(var_description, var_script_case_init, do_ajax_form_producthome_mob_validate_description_cb);
  } // do_ajax_form_producthome_mob_validate_description

  function do_ajax_form_producthome_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producthome_mob_validate_description_cb
  // ---------- Form
  function do_ajax_form_producthome_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_producthome_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_producthomeid = scAjaxGetFieldText("producthomeid");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_producthome_mob_submit_form(var_picture, var_list_order, var_description, var_producthomeid, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_producthome_mob_submit_form_cb);
  } // do_ajax_form_producthome_mob_submit_form

  function do_ajax_form_producthome_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_producthome_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_producthome_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("list_order");
    scAjaxHideErrorDisplay("description");
    var var_producthomeid = document.F2.producthomeid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_producthome_mob_navigate_form(var_producthomeid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_producthome_mob_navigate_form_cb);
  } // do_ajax_form_producthome_mob_navigate_form

  function do_ajax_form_producthome_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.producthomeid.value = scAjaxGetKeyValue("producthomeid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_producthome_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_producthome_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "picture";
  ajax_field_list[1] = "list_order";
  ajax_field_list[2] = "description";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "picture": {"label": "<?php echo $this->Ini->Nm_lang['lang_producthome_fild_image'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "list_order": {"label": "<?php echo $this->Ini->Nm_lang['lang_producthome_fild_list_order'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "description": {"label": "<?php echo $this->Ini->Nm_lang['lang_producthome_fild_desc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
