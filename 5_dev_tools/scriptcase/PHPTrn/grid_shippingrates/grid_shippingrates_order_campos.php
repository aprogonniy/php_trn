<?php
   ...
   session_start();
    $Ord_Cmp = new grid_shippingrates_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_shippingrates_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['weightfrom'] = "on";
   $tab_def_campos['weightfrom'] = "weightfrom";
   $tab_converte["weightfrom"]   = "weightfrom";
   $tab_labels["weightfrom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_shippingrates']['labels']["weightfrom"])) ? $_SESSION['sc_session'][$sc_init]['grid_shippingrates']['labels']["weightfrom"] : "" . $this->Nm_lang['lang_shippingrates_fild_weightfrom'] . "";
   $tab_ger_campos['weightto'] = "on";
   $tab_def_campos['weightto'] = "weightto";
   $tab_converte["weightto"]   = "weightto";
   $tab_labels["weightto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_shippingrates']['labels']["weightto"])) ? $_SESSION['sc_session'][$sc_init]['grid_shippingrates']['labels']["weightto"] : "" . $this->Nm_lang['lang_shippingrates_fild_weightto'] . "";
   $tab_ger_campos['price'] = "on";
   $tab_def_campos['price'] = "price";
   $tab_converte["price"]   = "price";
   $tab_labels["price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_shippingrates']['labels']["price"])) ? $_SESSION['sc_session'][$sc_init]['grid_shippingrates']['labels']["price"] : "" . $this->Nm_lang['lang_shippingrates_fild_price'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_shippingrates']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_shippingrates']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_shippingrates']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_shippingrates']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_shippingrates']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_shippingrates']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_shippingrates']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_shippingrates']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_shippingrates']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_tble_shippingrates'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_shippingrates_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_shippingrates']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_shippingrates']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
