<?php  
  ...
  session_start() ;
  class grid_shippingrates_form_teste
  {
  function grid_shippingrates_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_shippingrates_form_teste();
  $frm_teste->grid_shippingrates_teste();
?>
