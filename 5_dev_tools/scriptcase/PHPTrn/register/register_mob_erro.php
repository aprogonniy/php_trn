...
$old_error_handler = set_error_handler("register_mob_scriptcase_error_handler");

function register_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['register_mob']['contr_erro']) && $_SESSION['scriptcase']['register_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_register_mob->contr_register_mob->Apl_com_erro = true;
            if ($inicial_register_mob->contr_register_mob->NM_ajax_flag)
            {
                $inicial_register_mob->contr_register_mob->NM_ajax_info['errList']['geral_register_mob'][] = $msg;
                return;
            }
            register_mob_scriptcase_error_display($msg, $err_no);
        }
...
function register_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['register_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['register_mob'])  ? $_SESSION['scriptcase']['error_icon']['register_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['register_mob']) && '' != $_SESSION['scriptcase']['error_close']['register_mob']) ? $_SESSION['scriptcase']['error_close']['register_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['register_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['register_mob']) ? $_SESSION['scriptcase']['error_span_title']['register_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['register_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['register_mob']) ? $_SESSION['scriptcase']['error_icon_title']['register_mob'] : '';
?>
