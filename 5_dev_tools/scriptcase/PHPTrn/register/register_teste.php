<?php  
  session_start() ;
  class register_form_teste
  {
   function register_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "register/img";
...
<?php
  ...
  $frm_teste = new register_form_teste();
  $frm_teste->register_teste();
?>
