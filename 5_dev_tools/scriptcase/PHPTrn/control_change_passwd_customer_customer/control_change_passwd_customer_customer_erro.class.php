...
class control_change_passwd_customer_customer_erro
{
   var $Ini;
   ...
   //----- 
   function control_change_passwd_customer_customer_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return control_change_passwd_customer_customer_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
