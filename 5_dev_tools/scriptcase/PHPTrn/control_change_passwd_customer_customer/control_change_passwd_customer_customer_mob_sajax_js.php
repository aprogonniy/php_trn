  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_change_passwd_customer_customer_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_control_change_passwd_customer_customer_mob_validate_new_password1()
  {
    var nomeCampo_new_password1 = "new_password1";
    var var_new_password1 = scAjaxGetFieldText(nomeCampo_new_password1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_change_passwd_customer_customer_mob_validate_new_password1(var_new_password1, var_script_case_init, do_ajax_control_change_passwd_customer_customer_mob_validate_new_password1_cb);
  } // do_ajax_control_change_passwd_customer_customer_mob_validate_new_password1

  function do_ajax_control_change_passwd_customer_customer_mob_validate_new_password1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "new_password1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_change_passwd_customer_customer_mob_validate_new_password1_cb

  // ---------- Validate new_password2
  function do_ajax_control_change_passwd_customer_customer_mob_validate_new_password2()
  {
    var nomeCampo_new_password2 = "new_password2";
    var var_new_password2 = scAjaxGetFieldText(nomeCampo_new_password2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_change_passwd_customer_customer_mob_validate_new_password2(var_new_password2, var_script_case_init, do_ajax_control_change_passwd_customer_customer_mob_validate_new_password2_cb);
  } // do_ajax_control_change_passwd_customer_customer_mob_validate_new_password2

  function do_ajax_control_change_passwd_customer_customer_mob_validate_new_password2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "new_password2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_change_passwd_customer_customer_mob_validate_new_password2_cb
  // ---------- Form
  function do_ajax_control_change_passwd_customer_customer_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_change_passwd_customer_customer_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_new_password1 = scAjaxGetFieldText("new_password1");
    var var_new_password2 = scAjaxGetFieldText("new_password2");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_change_passwd_customer_customer_mob_submit_form(var_new_password1, var_new_password2, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_change_passwd_customer_customer_mob_submit_form_cb);
  } // do_ajax_control_change_passwd_customer_customer_mob_submit_form

  function do_ajax_control_change_passwd_customer_customer_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("new_password1");
      scAjaxHideErrorDisplay("new_password2");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_control_change_passwd_customer_customer_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_change_passwd_customer_customer_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_change_passwd_customer_customer_mob_navigate_form

  function do_ajax_control_change_passwd_customer_customer_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_change_passwd_customer_customer_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_change_passwd_customer_customer_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "new_password1";
  ajax_field_list[1] = "new_password2";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "new_password1": {"label": "<?php echo $this->Ini->Nm_lang['lang_password'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "new_password2": {"label": "<?php echo $this->Ini->Nm_lang['lang_password_confirmation'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "new_password1": new Array(),
    "new_password2": new Array()
  };
  ajax_field_mult["new_password1"][1] = "new_password1";
  ajax_field_mult["new_password2"][1] = "new_password2";

  var ajax_field_id = {
    "new_password1": new Array("hidden_field_label_new_password1", "hidden_field_data_new_password1"),
    "new_password2": new Array("hidden_field_label_new_password2", "hidden_field_data_new_password2")
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("new_password1" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("new_password2" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
