<?php  
  session_start() ;
  class form_shipping_form_teste
  {
   function form_shipping_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_shipping/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_shipping</FONT></B> 
<br> 
...
<input type="submit" value="form_shipping"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_shipping_form_teste();
  $frm_teste->form_shipping_teste();
?>
