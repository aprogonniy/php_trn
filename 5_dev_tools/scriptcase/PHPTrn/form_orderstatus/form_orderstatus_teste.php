<?php  
  session_start() ;
  class form_orderstatus_form_teste
  {
   function form_orderstatus_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_orderstatus/img";
...
<?php
  ...
  $frm_teste = new form_orderstatus_form_teste();
  $frm_teste->form_orderstatus_teste();
?>
