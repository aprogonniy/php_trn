<?php  
  ...
  session_start() ;
  class grid_products_list_cat_form_teste
  {
  function grid_products_list_cat_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_products_list_cat</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_products_list_cat.php" 
               target="_self"> 
...
<input type=submit value="grid_products_list_cat"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_products_list_cat_form_teste();
  $frm_teste->grid_products_list_cat_teste();
?>
