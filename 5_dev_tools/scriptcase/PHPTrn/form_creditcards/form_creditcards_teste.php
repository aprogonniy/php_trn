<?php  
  session_start() ;
  class form_creditcards_form_teste
  {
   function form_creditcards_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_creditcards/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_creditcards</FONT></B> 
<br> 
...
<input type="submit" value="form_creditcards"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_creditcards_form_teste();
  $frm_teste->form_creditcards_teste();
?>
