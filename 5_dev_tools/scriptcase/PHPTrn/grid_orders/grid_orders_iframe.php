...
$oExportPdf = new grid_orders_export_pdf;
$oExportPdf->exportPdf();

class grid_orders_export_pdf {
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_orders_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_orders']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_orders']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_orders.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_orders']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_orders']['pdf_name'] : "grid_orders.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
$NM_volta   = (!isset($aParams['nmgp_opcao']) || 'pdf_res' != $aParams['nmgp_opcao']) ? "volta_grid" : "resumo";
?>
<form name="F0" method="post" action="grid_orders.php" target="<?php echo $NM_target; ?>" style="display: none"> 
