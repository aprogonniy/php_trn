...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_orderid"  <?php echo $str_hide_orderid?>><INPUT  type="text" id="SC_orderid" name="orderid" value="<?php echo NM_encode_input($orderid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_customerid"  <?php echo $str_hide_customerid?>>
<?php
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_status"  <?php echo $str_hide_status?>>
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_total"  <?php echo $str_hide_total?>><INPUT  type="text" id="SC_total" name="total" value="<?php echo NM_encode_input($total) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">         <BR>
        <SPAN id="id_vis_total"  <?php echo $str_display_total; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_total_input_2" name="total_input_2" value="<?php echo NM_encode_input($total_input_2) ?>" size=5 alt="{datatype: 'decimal', maxLength: 10, precision: 0, decimalSep: ',', thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
