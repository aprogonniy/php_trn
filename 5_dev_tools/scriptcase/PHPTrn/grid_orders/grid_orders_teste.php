<?php  
  ...
  session_start() ;
  class grid_orders_form_teste
  {
  function grid_orders_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_orders_form_teste();
  $frm_teste->grid_orders_teste();
?>
