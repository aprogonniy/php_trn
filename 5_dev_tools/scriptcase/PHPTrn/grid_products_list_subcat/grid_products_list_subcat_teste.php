<?php  
  ...
  session_start() ;
  class grid_products_list_subcat_form_teste
  {
  function grid_products_list_subcat_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_products_list_subcat</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_products_list_subcat.php" 
               target="_self"> 
v_category&nbsp;&nbsp;<input type=text name="v_category" size=20><br> 
...
<input type=submit value="grid_products_list_subcat"> 
</form> 
<script language=javascript> 
 document.FCons.v_category.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_products_list_subcat_form_teste();
  $frm_teste->grid_products_list_subcat_teste();
?>
