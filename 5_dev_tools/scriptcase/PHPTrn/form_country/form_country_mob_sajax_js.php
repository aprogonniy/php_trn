  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_country_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_country_mob_validate_countrycode()
  {
    var nomeCampo_countrycode = "countrycode";
    var var_countrycode = scAjaxGetFieldText(nomeCampo_countrycode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_country_mob_validate_countrycode(var_countrycode, var_script_case_init, do_ajax_form_country_mob_validate_countrycode_cb);
  } // do_ajax_form_country_mob_validate_countrycode

  function do_ajax_form_country_mob_validate_countrycode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "countrycode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_country_mob_validate_countrycode_cb

  // ---------- Validate name
  function do_ajax_form_country_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_country_mob_validate_name(var_name, var_script_case_init, do_ajax_form_country_mob_validate_name_cb);
  } // do_ajax_form_country_mob_validate_name

  function do_ajax_form_country_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "name";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_country_mob_validate_name_cb

  // ---------- Validate tax
  function do_ajax_form_country_mob_validate_tax()
  {
    var nomeCampo_tax = "tax";
    var var_tax = scAjaxGetFieldRadio(nomeCampo_tax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_country_mob_validate_tax(var_tax, var_script_case_init, do_ajax_form_country_mob_validate_tax_cb);
  } // do_ajax_form_country_mob_validate_tax

  function do_ajax_form_country_mob_validate_tax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tax";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_country_mob_validate_tax_cb

  // ---------- Validate taxpercent
  function do_ajax_form_country_mob_validate_taxpercent()
  {
    var nomeCampo_taxpercent = "taxpercent";
    var var_taxpercent = scAjaxGetFieldText(nomeCampo_taxpercent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_country_mob_validate_taxpercent(var_taxpercent, var_script_case_init, do_ajax_form_country_mob_validate_taxpercent_cb);
  } // do_ajax_form_country_mob_validate_taxpercent

  function do_ajax_form_country_mob_validate_taxpercent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "taxpercent";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_country_mob_validate_taxpercent_cb
  // ---------- Form
  function do_ajax_form_country_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_country_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_countrycode = scAjaxGetFieldText("countrycode");
    var var_name = scAjaxGetFieldText("name");
    var var_tax = scAjaxGetFieldRadio("tax");
    var var_taxpercent = scAjaxGetFieldText("taxpercent");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_country_mob_submit_form(var_countrycode, var_name, var_tax, var_taxpercent, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_country_mob_submit_form_cb);
  } // do_ajax_form_country_mob_submit_form

  function do_ajax_form_country_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("countrycode");
      scAjaxHideErrorDisplay("name");
      scAjaxHideErrorDisplay("tax");
      scAjaxHideErrorDisplay("taxpercent");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_country_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_country_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tax");
    scAjaxHideErrorDisplay("taxpercent");
    var var_countrycode = document.F2.countrycode.value;
    ...
    scAjaxProcOn();
    x_ajax_form_country_mob_navigate_form(var_countrycode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_country_mob_navigate_form_cb);
  } // do_ajax_form_country_mob_navigate_form

  function do_ajax_form_country_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.countrycode.value = scAjaxGetKeyValue("countrycode");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_country_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_country_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "countrycode";
  ajax_field_list[1] = "name";
  ajax_field_list[2] = "tax";
  ajax_field_list[3] = "taxpercent";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "countrycode": {"label": "<?php echo $this->Ini->Nm_lang['lang_country_fild_countrycode'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "name": {"label": "<?php echo $this->Ini->Nm_lang['lang_country_fild_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tax": {"label": "<?php echo $this->Ini->Nm_lang['lang_country_fild_tax'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "taxpercent": {"label": "<?php echo $this->Ini->Nm_lang['lang_country_fild_taxpercent'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "name": new Array(),
    "tax": new Array(),
    "taxpercent": new Array()
  };
  ajax_field_mult["countrycode"][1] = "countrycode";
  ajax_field_mult["name"][1] = "name";
  ajax_field_mult["tax"][1] = "tax";
  ajax_field_mult["taxpercent"][1] = "taxpercent";

  var ajax_field_id = {
    "countrycode": new Array("hidden_field_label_countrycode", "hidden_field_data_countrycode"),
    "name": new Array("hidden_field_label_name", "hidden_field_data_name"),
    "tax": new Array("hidden_field_label_tax", "hidden_field_data_tax"),
    "taxpercent": new Array("hidden_field_label_taxpercent", "hidden_field_data_taxpercent")
  };
