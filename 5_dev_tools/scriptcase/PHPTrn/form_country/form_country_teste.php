<?php  
  session_start() ;
  class form_country_form_teste
  {
   function form_country_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_country/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_country</FONT></B> 
<br> 
...
<input type="submit" value="form_country"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_country_form_teste();
  $frm_teste->form_country_teste();
?>
