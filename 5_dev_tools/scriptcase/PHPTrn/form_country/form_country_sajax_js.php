  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_country" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_country_validate_countrycode()
  {
    var nomeCampo_countrycode = "countrycode";
    var var_countrycode = scAjaxGetFieldText(nomeCampo_countrycode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_country_validate_countrycode(var_countrycode, var_script_case_init, do_ajax_form_country_validate_countrycode_cb);
  } // do_ajax_form_country_validate_countrycode

  function do_ajax_form_country_validate_countrycode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_country_validate_countrycode_cb

  // ---------- Validate name
  function do_ajax_form_country_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_country_validate_name(var_name, var_script_case_init, do_ajax_form_country_validate_name_cb);
  } // do_ajax_form_country_validate_name

  function do_ajax_form_country_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "name";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_country_validate_name_cb

  // ---------- Validate tax
  function do_ajax_form_country_validate_tax()
  {
    var nomeCampo_tax = "tax";
    var var_tax = scAjaxGetFieldRadio(nomeCampo_tax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_country_validate_tax(var_tax, var_script_case_init, do_ajax_form_country_validate_tax_cb);
  } // do_ajax_form_country_validate_tax

  function do_ajax_form_country_validate_tax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tax";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_country_validate_tax_cb

  // ---------- Validate taxpercent
  function do_ajax_form_country_validate_taxpercent()
  {
    var nomeCampo_taxpercent = "taxpercent";
    var var_taxpercent = scAjaxGetFieldText(nomeCampo_taxpercent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_country_validate_taxpercent(var_taxpercent, var_script_case_init, do_ajax_form_country_validate_taxpercent_cb);
  } // do_ajax_form_country_validate_taxpercent

  function do_ajax_form_country_validate_taxpercent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_country_validate_taxpercent_cb
  // ---------- Form
  function do_ajax_form_country_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_country_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_country_submit_form(var_countrycode, var_name, var_tax, var_taxpercent, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_country_submit_form_cb);
  } // do_ajax_form_country_submit_form

  function do_ajax_form_country_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_country_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_country_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_country_navigate_form(var_countrycode, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_country_navigate_form_cb);
  } // do_ajax_form_country_navigate_form

  function do_ajax_form_country_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_country_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_country_navigate_form_cb
