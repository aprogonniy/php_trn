<?php  
  ...
  session_start() ;
  class grid_products_form_teste
  {
  function grid_products_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_products_form_teste();
  $frm_teste->grid_products_teste();
?>
