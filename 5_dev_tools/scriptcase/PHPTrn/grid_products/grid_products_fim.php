...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_products"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_products"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_products'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_products']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_products']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_products']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_products']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_products']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_products']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_products']['embutida_filho'] as $ind => $sc_init)
          {
