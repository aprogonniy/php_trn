<?php  
  ...
  session_start() ;
  class grid_state_form_teste
  {
  function grid_state_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_state_form_teste();
  $frm_teste->grid_state_teste();
?>
