...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_state"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_state"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_state'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_state']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_state']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_state']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_state']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_state']['sc_modal']);
           $saida_final = "self.parent.tb_remove()";
       }
       else
       {
           $saida_final = "parent.window.close()";
       }
       nm_limpa_arr_session();
?>
<HTML>
<HEAD>
 <TITLE>grid_state</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_state']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_state']['embutida_filho'] as $ind => $sc_init)
          {
