<?php  
  session_start() ;
  class form_orders_form_teste
  {
   function form_orders_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_orders/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_orders</FONT></B> 
<br> 
...
<input type="submit" value="form_orders"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_orders_form_teste();
  $frm_teste->form_orders_teste();
?>
