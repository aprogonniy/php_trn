<?php  
  session_start() ;
  class form_measure_form_teste
  {
   function form_measure_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_measure/img";
...
<?php
  ...
  $frm_teste = new form_measure_form_teste();
  $frm_teste->form_measure_teste();
?>
