  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_measure" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate measureid_
  function do_ajax_form_measure_validate_measureid_(iNumLinha)
  {
    var nomeCampo_measureid_ = "measureid_" + iNumLinha;
    var var_measureid_ = scAjaxGetFieldHidden(nomeCampo_measureid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_measure_validate_measureid_(var_measureid_, iNumLinha, var_script_case_init, do_ajax_form_measure_validate_measureid__cb);
  } // do_ajax_form_measure_validate_measureid_

  function do_ajax_form_measure_validate_measureid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "measureid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "measureid_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "measureid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "measureid_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_measure_validate_measureid__cb

  // ---------- Validate description_
  function do_ajax_form_measure_validate_description_(iNumLinha)
  {
    var nomeCampo_description_ = "description_" + iNumLinha;
    var var_description_ = scAjaxGetFieldText(nomeCampo_description_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_measure_validate_description_(var_description_, iNumLinha, var_script_case_init, do_ajax_form_measure_validate_description__cb);
  } // do_ajax_form_measure_validate_description_

  function do_ajax_form_measure_validate_description__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "description_" + iLineNumber;
    }
    else
    {
      sFieldValid = "description_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "description_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "description_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_measure_validate_description__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_measure_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_measure_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_measure_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_measure_add_new_line_cb);
  } // do_ajax_form_measure_add_new_line

  function do_ajax_form_measure_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_measure_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_measure_backup_line(iNumLinha)
  {
    var var_measureid_ = scAjaxGetFieldHidden("measureid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_measure_backup_line(var_measureid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_measure_backup_line_cb);
  } // do_ajax_form_measure_backup_line

  function do_ajax_form_measure_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_measure_backup_line_cb

  function do_ajax_form_measure_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_measure_cancel_insert

  function do_ajax_form_measure_cancel_update(iSeqVert)
  {
    do_ajax_form_measure_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_measure_cancel_update

  function do_ajax_form_measure_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_measure_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_measure_table_refresh()
  {
    var var_measureid_ = document.F2.measureid_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_measure_table_refresh(var_measureid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_measure_table_refresh_cb);
  } //  do_ajax_form_measure_table_refresh

  function do_ajax_form_measure_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.measureid_.value = scAjaxGetKeyValue("measureid_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_measure_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_measure_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_measure_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_measureid_ = scAjaxGetFieldHidden("measureid_" + iNumLinha);
    var var_description_ = scAjaxGetFieldText("description_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_measure_submit_form(var_measureid_, var_description_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_measure_submit_form_cb);
  } // do_ajax_form_measure_submit_form

  function do_ajax_form_measure_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("measureid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("description_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_measure_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_measure_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_measure_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("measureid_" + iNavForm);
      scAjaxHideErrorDisplay("description_" + iNavForm);
    }
    var var_measureid_ = document.F2.measureid_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_measure_navigate_form(var_measureid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_measure_navigate_form_cb);
  } // do_ajax_form_measure_navigate_form

  function do_ajax_form_measure_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.measureid_.value = scAjaxGetKeyValue("measureid_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_measure_navigate_form_cb
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "measureid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "description_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["measureid_" + iNumLinha] = {"label": "Measureid<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["description_" + iNumLinha] = {"label": "Description<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["measureid_"][iNumLinha] = "measureid_" + iNumLinha;
    ajax_field_mult["description_"][iNumLinha] = "description_" + iNumLinha;
    ajax_field_id["measureid_" + iNumLinha] = new Array("hidden_field_label_measureid_", "hidden_field_data_measureid_" + iNumLinha);
    ajax_field_id["description_" + iNumLinha] = new Array("hidden_field_label_description_", "hidden_field_data_description_" + iNumLinha);
    ajax_error_count["measureid_" + iNumLinha] = "off";
    ajax_error_count["description_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["measureid_" + iNumLinha] = "off";
    ajax_read_only["description_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["measureid_" + iNumLinha] = "on";
    ajax_read_only["description_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["measureid_" + iNumLinha] = null;
    ajax_error_list["description_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "measureid_": new Array(),
    "description_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["measureid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["measureid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["measureid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["measureid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["measureid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["description_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["description_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["description_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["description_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["description_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['measureid_'])) ? $this->nmgp_cmp_readonly['measureid_'] : 'off';
?>
    scAjaxFieldRead("measureid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['description_'])) ? $this->nmgp_cmp_readonly['description_'] : 'off';
?>
    scAjaxFieldRead("description_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("measureid_" + iSeq, "on");
    scAjaxFieldRead("description_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["measureid_" + iRow] || "on" == ajax_error_count["description_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_measureid_" + iRow))
        document.getElementById("hidden_field_data_measureid_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_description_" + iRow))
        document.getElementById("hidden_field_data_description_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["measureid_" + iRow] && "off" == ajax_error_count["description_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["measureid_" + iRow] = "off";
        ajax_error_count["description_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_measureid_" + iRow))
        document.getElementById("hidden_field_data_measureid_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_description_" + iRow))
        document.getElementById("hidden_field_data_description_" + iRow).className = sCssLine;
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("measureid_" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("description_" == sIndex)
    {
