...
class grid_address_customer_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_address_customer_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_address_customer_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_address_customer_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_address_customer_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "addressid";$Nm_numeric[] = "customersid";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['decimal_db'] == ".")
         {
            $nm_aspas = "";
         }
         if ($condicao != "IN")
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_address_customer.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_address'] ?></TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_address_customer_ajax_search.js"></script>
 <script type="text/javascript" src="grid_address_customer_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_addressid_cond#NMF#' + search_get_sel_txt('SC_addressid_cond') + '@NMF@';
  str_out += 'SC_addressid#NMF#' + search_get_text('SC_addressid') + '@NMF@';
  ...
  str_out += 'SC_description_cond#NMF#' + search_get_sel_txt('SC_description_cond') + '@NMF@';
  str_out += 'SC_description#NMF#' + search_get_text('SC_description') + '@NMF@';
  str_out += 'SC_address1_cond#NMF#' + search_get_sel_txt('SC_address1_cond') + '@NMF@';
  str_out += 'SC_address1#NMF#' + search_get_text('SC_address1') + '@NMF@';
  str_out += 'SC_address2_cond#NMF#' + search_get_sel_txt('SC_address2_cond') + '@NMF@';
  str_out += 'SC_address2#NMF#' + search_get_text('SC_address2') + '@NMF@';
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_address_customer.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tble_address'] ?></span></td>
...
<?php
   ...
   {
      global 
             $addressid_cond, $addressid,
             $customersid_cond, $customersid,
             $description_cond, $description,
             $address1_cond, $address1,
             $address2_cond, $address2,
             $city_cond, $city,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $addressid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['addressid']; 
          $addressid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['addressid_cond']; 
          $customersid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['customersid']; 
          $customersid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['customersid_cond']; 
          $description = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['description']; 
          $description_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['description_cond']; 
          $address1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['address1']; 
          $address1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['address1_cond']; 
          $address2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['address2']; 
          $address2_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['address2_cond']; 
          $city = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['city']; 
          $city_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['city_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['NM_operador']; 
          if (strtoupper($addressid_cond) != "II" && strtoupper($addressid_cond) != "QP" && strtoupper($addressid_cond) != "NP" && strtoupper($addressid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($addressid, ".", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
      ...
      if (!isset($addressid_cond) || empty($addressid_cond))
      {
         $addressid_cond = "eq";
      }
      ...
      if (!isset($description_cond) || empty($description_cond))
      {
         $description_cond = "eq";
      }
      if (!isset($address1_cond) || empty($address1_cond))
      {
         $address1_cond = "eq";
      }
      if (!isset($address2_cond) || empty($address2_cond))
      {
         $address2_cond = "eq";
      }
      if (!isset($city_cond) || empty($city_cond))
      {
         $city_cond = "eq";
      }
      ...
      $str_hide_addressid = (in_array($addressid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_customersid = (in_array($customersid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_description = (in_array($description_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_address1 = (in_array($address1_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_address2 = (in_array($address2_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($addressid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $addressid = substr($addressid, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($description, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $description = substr($description, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($address1, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $address1 = substr($address1, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($address2, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $address2 = substr($address2, 0, $tmp_pos);
         }
      }
      if (!isset($city) || $city == "")
      {
...
<?php
   if (is_file("grid_address_customer_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['addressid'])) ? $this->New_label['addressid'] : "" . $this->Ini->Nm_lang['lang_address_fild_addressid'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_addressid_cond" name="addressid_cond" onChange="nm_campos_between(document.getElementById('id_vis_addressid'), this, 'addressid')">
       <OPTION value="eq" <?php if ("eq" == $addressid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $addressid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $addressid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $addressid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_addressid" <?php echo $str_hide_addressid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['addressid'])) ? $this->New_label['addressid'] : "" . $this->Ini->Nm_lang['lang_address_fild_addressid'] . "";
 $nmgp_tab_label .= "addressid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_addressid" name="addressid" value="<?php echo NM_encode_input($addressid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['customersid'])) ? $this->New_label['customersid'] : "" . $this->Ini->Nm_lang['lang_address_fild_customersid'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_customersid_cond" name="customersid_cond" onChange="nm_campos_between(document.getElementById('id_vis_customersid'), this, 'customersid')">
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_customersid" <?php echo $str_hide_customersid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['customersid'])) ? $this->New_label['customersid'] : "" . $this->Ini->Nm_lang['lang_address_fild_customersid'] . "";
 $nmgp_tab_label .= "customersid?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_customersid" name="customersid" value="<?php echo NM_encode_input($customersid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['description'])) ? $this->New_label['description'] : "" . $this->Ini->Nm_lang['lang_address_fild_description'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_description_cond" name="description_cond" onChange="nm_campos_between(document.getElementById('id_vis_description'), this, 'description')">
       <OPTION value="eq" <?php if ("eq" == $description_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $description_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $description_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $description_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_description" <?php echo $str_hide_description?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['description'])) ? $this->New_label['description'] : "" . $this->Ini->Nm_lang['lang_address_fild_description'] . "";
 $nmgp_tab_label .= "description?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_description" name="description" value="<?php echo NM_encode_input($description) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['address1'])) ? $this->New_label['address1'] : "" . $this->Ini->Nm_lang['lang_address_fild_address1'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_address1_cond" name="address1_cond" onChange="nm_campos_between(document.getElementById('id_vis_address1'), this, 'address1')">
       <OPTION value="eq" <?php if ("eq" == $address1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $address1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $address1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $address1_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_address1" <?php echo $str_hide_address1?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['address1'])) ? $this->New_label['address1'] : "" . $this->Ini->Nm_lang['lang_address_fild_address1'] . "";
 $nmgp_tab_label .= "address1?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_address1" name="address1" value="<?php echo NM_encode_input($address1) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['address2'])) ? $this->New_label['address2'] : "" . $this->Ini->Nm_lang['lang_address_fild_address2'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_address2_cond" name="address2_cond" onChange="nm_campos_between(document.getElementById('id_vis_address2'), this, 'address2')">
       <OPTION value="eq" <?php if ("eq" == $address2_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $address2_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $address2_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $address2_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_address2" <?php echo $str_hide_address2?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['address2'])) ? $this->New_label['address2'] : "" . $this->Ini->Nm_lang['lang_address_fild_address2'] . "";
 $nmgp_tab_label .= "address2?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_address2" name="address2" value="<?php echo NM_encode_input($address2) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['city'])) ? $this->New_label['city'] : "" . $this->Ini->Nm_lang['lang_address_fild_city'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_city_cond" name="city_cond" onChange="nm_campos_between(document.getElementById('id_vis_city'), this, 'city')">
       <OPTION value="eq" <?php if ("eq" == $city_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $city_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $city_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $city_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_city" name="city" value="<?php echo NM_encode_input($city) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_address_customer']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_address_customer']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_address_customer.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_addressid'), document.F1.addressid_cond, 'addressid');
   document.F1.addressid.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_description'), document.F1.description_cond, 'description');
   document.F1.description.value = "";
   nm_campos_between(document.getElementById('id_vis_address1'), document.F1.address1_cond, 'address1');
   document.F1.address1.value = "";
   nm_campos_between(document.getElementById('id_vis_address2'), document.F1.address2_cond, 'address2');
   document.F1.address2.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "PHPTrn/grid_address_customer";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_address_customer/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_addressid_cond'] = 'cond';
      $tp_fields['SC_addressid'] = 'text';
      $tp_fields['SC_customersid_cond'] = 'cond';
      $tp_fields['SC_customersid'] = 'text';
      $tp_fields['SC_description_cond'] = 'cond';
      $tp_fields['SC_description'] = 'text';
      $tp_fields['SC_address1_cond'] = 'cond';
      $tp_fields['SC_address1'] = 'text';
      $tp_fields['SC_address2_cond'] = 'cond';
      $tp_fields['SC_address2'] = 'text';
      $tp_fields['SC_city_cond'] = 'cond';
      $tp_fields['SC_city'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $addressid_cond, $addressid,
             $customersid_cond, $customersid,
             $description_cond, $description,
             $address1_cond, $address1,
             $address2_cond, $address2,
             $city_cond, $city, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $addressid_cond_salva = $addressid_cond; 
      if (!isset($addressid_input_2) || $addressid_input_2 == "")
      {
          $addressid_input_2 = $addressid;
      }
      ...
      $description_cond_salva = $description_cond; 
      if (!isset($description_input_2) || $description_input_2 == "")
      {
          $description_input_2 = $description;
      }
      $address1_cond_salva = $address1_cond; 
      if (!isset($address1_input_2) || $address1_input_2 == "")
      {
          $address1_input_2 = $address1;
      }
      $address2_cond_salva = $address2_cond; 
      if (!isset($address2_input_2) || $address2_input_2 == "")
      {
          $address2_input_2 = $address2;
      }
      ...
      if ($addressid_cond != "in")
      {
          nm_limpa_numero($addressid, ".") ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $addressid);
          ...
          $addressid = implode(",", $Nm_sc_valores);
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['addressid'] = $addressid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['addressid_cond'] = $addressid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['customersid'] = $customersid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['customersid_cond'] = $customersid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['description'] = $description; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['description_cond'] = $description_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['address1'] = $address1; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['address1_cond'] = $address1_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['address2'] = $address2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['address2_cond'] = $address2_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['city'] = $city; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['city_cond'] = $city_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['addressid'] = $Conteudo;
      ...
      $this->cmp_formatado['description'] = $Conteudo;
      $Conteudo = $address1;
      $this->cmp_formatado['address1'] = $Conteudo;
      $Conteudo = $address2;
      $this->cmp_formatado['address2'] = $Conteudo;
      $Conteudo = $city;
      $this->cmp_formatado['city'] = $Conteudo;

      //----- $addressid
      $this->Date_part = false;
      if (isset($addressid) || $addressid_cond == "nu" || $addressid_cond == "nn" || $addressid_cond == "ep" || $addressid_cond == "ne")
      {
         $this->monta_condicao("addressid", $addressid_cond, $addressid, "", "addressid");
      }
      ...
      //----- $description
      $this->Date_part = false;
      if (isset($description) || $description_cond == "nu" || $description_cond == "nn" || $description_cond == "ep" || $description_cond == "ne")
      {
         $this->monta_condicao("description", $description_cond, $description, "", "description");
      }

      //----- $address1
      $this->Date_part = false;
      if (isset($address1) || $address1_cond == "nu" || $address1_cond == "nn" || $address1_cond == "ep" || $address1_cond == "ne")
      {
         $this->monta_condicao("address1", $address1_cond, $address1, "", "address1");
      }

      //----- $address2
      $this->Date_part = false;
      if (isset($address2) || $address2_cond == "nu" || $address2_cond == "nn" || $address2_cond == "ep" || $address2_cond == "ne")
      {
         $this->monta_condicao("address2", $address2_cond, $address2, "", "address2");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_address_customer']['fast_search']);
