...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "addressid";$Nm_numeric[] = "customersid";$Nm_numeric[] = "addressid";$Nm_numeric[] = "customersid";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_addressid"  <?php echo $str_hide_addressid?>><INPUT  type="text" id="SC_addressid" name="addressid" value="<?php echo NM_encode_input($addressid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_customersid"  <?php echo $str_hide_customersid?>><INPUT  type="text" id="SC_customersid" name="customersid" value="<?php echo NM_encode_input($customersid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_description"  <?php echo $str_hide_description?>><INPUT  type="text" id="SC_description" name="description" value="<?php echo NM_encode_input($description) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_address1"  <?php echo $str_hide_address1?>><INPUT  type="text" id="SC_address1" name="address1" value="<?php echo NM_encode_input($address1) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_address2"  <?php echo $str_hide_address2?>><INPUT  type="text" id="SC_address2" name="address2" value="<?php echo NM_encode_input($address2) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_city"  <?php echo $str_hide_city?>><INPUT  type="text" id="SC_city" name="city" value="<?php echo NM_encode_input($city) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
