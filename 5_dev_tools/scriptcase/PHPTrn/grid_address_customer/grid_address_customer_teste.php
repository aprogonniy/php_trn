<?php  
  ...
  session_start() ;
  class grid_address_customer_form_teste
  {
  function grid_address_customer_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_address_customer</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_address_customer.php" 
               target="_self"> 
...
<input type=submit value="grid_address_customer"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_address_customer_form_teste();
  $frm_teste->grid_address_customer_teste();
?>
