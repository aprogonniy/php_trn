<?php  
  session_start() ;
  class form_systemuser_form_teste
  {
   function form_systemuser_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_systemuser/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_systemuser</FONT></B> 
<br> 
...
<input type="submit" value="form_systemuser"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_systemuser_form_teste();
  $frm_teste->form_systemuser_teste();
?>
