  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_systemuser_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate accesslevelid
  function do_ajax_form_systemuser_mob_validate_accesslevelid()
  {
    var nomeCampo_accesslevelid = "accesslevelid";
    var var_accesslevelid = scAjaxGetFieldSelect(nomeCampo_accesslevelid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemuser_mob_validate_accesslevelid(var_accesslevelid, var_script_case_init, do_ajax_form_systemuser_mob_validate_accesslevelid_cb);
  } // do_ajax_form_systemuser_mob_validate_accesslevelid

  function do_ajax_form_systemuser_mob_validate_accesslevelid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "accesslevelid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemuser_mob_validate_accesslevelid_cb

  // ---------- Validate departmentid
  function do_ajax_form_systemuser_mob_validate_departmentid()
  {
    var nomeCampo_departmentid = "departmentid";
    var var_departmentid = scAjaxGetFieldSelect(nomeCampo_departmentid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemuser_mob_validate_departmentid(var_departmentid, var_script_case_init, do_ajax_form_systemuser_mob_validate_departmentid_cb);
  } // do_ajax_form_systemuser_mob_validate_departmentid

  function do_ajax_form_systemuser_mob_validate_departmentid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "departmentid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemuser_mob_validate_departmentid_cb

  // ---------- Validate login
  function do_ajax_form_systemuser_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemuser_mob_validate_login(var_login, var_script_case_init, do_ajax_form_systemuser_mob_validate_login_cb);
  } // do_ajax_form_systemuser_mob_validate_login

  function do_ajax_form_systemuser_mob_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemuser_mob_validate_login_cb

  // ---------- Validate name
  function do_ajax_form_systemuser_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemuser_mob_validate_name(var_name, var_script_case_init, do_ajax_form_systemuser_mob_validate_name_cb);
  } // do_ajax_form_systemuser_mob_validate_name

  function do_ajax_form_systemuser_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "name";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemuser_mob_validate_name_cb
  // ---------- Form
  function do_ajax_form_systemuser_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_systemuser_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_accesslevelid = scAjaxGetFieldSelect("accesslevelid");
    var var_departmentid = scAjaxGetFieldSelect("departmentid");
    var var_login = scAjaxGetFieldText("login");
    var var_name = scAjaxGetFieldText("name");
    var var_systemuserid = scAjaxGetFieldText("systemuserid");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_systemuser_mob_submit_form(var_accesslevelid, var_departmentid, var_login, var_name, var_systemuserid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_systemuser_mob_submit_form_cb);
  } // do_ajax_form_systemuser_mob_submit_form

  function do_ajax_form_systemuser_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("accesslevelid");
      scAjaxHideErrorDisplay("departmentid");
  ...
  } // do_ajax_form_systemuser_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_systemuser_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("login");
    scAjaxHideErrorDisplay("name");
    var var_systemuserid = document.F2.systemuserid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_systemuser_mob_navigate_form(var_systemuserid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_systemuser_mob_navigate_form_cb);
  } // do_ajax_form_systemuser_mob_navigate_form

  function do_ajax_form_systemuser_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.systemuserid.value = scAjaxGetKeyValue("systemuserid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_systemuser_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_systemuser_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "accesslevelid";
  ajax_field_list[1] = "departmentid";
  ajax_field_list[2] = "login";
  ...
  var ajax_error_list = {
    "accesslevelid": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemuser_fild_accesslevelid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "departmentid": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemuser_fild_departmentid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemuser_fild_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "name": {"label": "<?php echo $this->Ini->Nm_lang['lang_systemuser_fild_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "accesslevelid": new Array(),
    "departmentid": new Array(),
    "login": new Array(),
    "name": new Array()
  };
  ajax_field_mult["accesslevelid"][1] = "accesslevelid";
  ajax_field_mult["departmentid"][1] = "departmentid";
  ajax_field_mult["login"][1] = "login";
  ajax_field_mult["name"][1] = "name";

  var ajax_field_id = {
    "accesslevelid": new Array("hidden_field_label_accesslevelid", "hidden_field_data_accesslevelid"),
    "departmentid": new Array("hidden_field_label_departmentid", "hidden_field_data_departmentid"),
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("accesslevelid" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("departmentid" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
      return;
