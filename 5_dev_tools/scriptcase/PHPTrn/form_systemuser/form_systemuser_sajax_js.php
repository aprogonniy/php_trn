  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_systemuser" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_systemuser_validate_accesslevelid()
  {
    var nomeCampo_accesslevelid = "accesslevelid";
    var var_accesslevelid = scAjaxGetFieldSelect(nomeCampo_accesslevelid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemuser_validate_accesslevelid(var_accesslevelid, var_script_case_init, do_ajax_form_systemuser_validate_accesslevelid_cb);
  } // do_ajax_form_systemuser_validate_accesslevelid

  function do_ajax_form_systemuser_validate_accesslevelid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemuser_validate_accesslevelid_cb

  // ---------- Validate departmentid
  function do_ajax_form_systemuser_validate_departmentid()
  {
    var nomeCampo_departmentid = "departmentid";
    var var_departmentid = scAjaxGetFieldSelect(nomeCampo_departmentid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemuser_validate_departmentid(var_departmentid, var_script_case_init, do_ajax_form_systemuser_validate_departmentid_cb);
  } // do_ajax_form_systemuser_validate_departmentid

  function do_ajax_form_systemuser_validate_departmentid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemuser_validate_departmentid_cb

  // ---------- Validate login
  function do_ajax_form_systemuser_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemuser_validate_login(var_login, var_script_case_init, do_ajax_form_systemuser_validate_login_cb);
  } // do_ajax_form_systemuser_validate_login

  function do_ajax_form_systemuser_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemuser_validate_login_cb

  // ---------- Validate name
  function do_ajax_form_systemuser_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_systemuser_validate_name(var_name, var_script_case_init, do_ajax_form_systemuser_validate_name_cb);
  } // do_ajax_form_systemuser_validate_name

  function do_ajax_form_systemuser_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "name";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_systemuser_validate_name_cb
  // ---------- Form
  function do_ajax_form_systemuser_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_systemuser_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_systemuser_submit_form(var_accesslevelid, var_departmentid, var_login, var_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_systemuser_submit_form_cb);
  } // do_ajax_form_systemuser_submit_form

  function do_ajax_form_systemuser_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_systemuser_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_systemuser_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_systemuser_navigate_form(var_systemuserid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_systemuser_navigate_form_cb);
  } // do_ajax_form_systemuser_navigate_form

  function do_ajax_form_systemuser_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_systemuser_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_systemuser_navigate_form_cb
