  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_category_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_category_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_category_mob_validate_description(var_description, var_script_case_init, do_ajax_form_category_mob_validate_description_cb);
  } // do_ajax_form_category_mob_validate_description

  function do_ajax_form_category_mob_validate_description_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_category_mob_validate_description_cb

  // ---------- Validate list_order
  function do_ajax_form_category_mob_validate_list_order()
  {
    var nomeCampo_list_order = "list_order";
    var var_list_order = scAjaxGetFieldText(nomeCampo_list_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_category_mob_validate_list_order(var_list_order, var_script_case_init, do_ajax_form_category_mob_validate_list_order_cb);
  } // do_ajax_form_category_mob_validate_list_order

  function do_ajax_form_category_mob_validate_list_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_category_mob_validate_list_order_cb
  // ---------- Form
  function do_ajax_form_category_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_category_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_category_mob_submit_form(var_description, var_list_order, var_categoryid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_category_mob_submit_form_cb);
  } // do_ajax_form_category_mob_submit_form

  function do_ajax_form_category_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_category_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_category_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("description");
    scAjaxHideErrorDisplay("list_order");
    var var_categoryid = document.F2.categoryid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_category_mob_navigate_form(var_categoryid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_category_mob_navigate_form_cb);
  } // do_ajax_form_category_mob_navigate_form

  function do_ajax_form_category_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.categoryid.value = scAjaxGetKeyValue("categoryid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_category_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_category_mob_navigate_form_cb
  ...
  var ajax_error_list = {
    "description": {"label": "<?php echo $this->Ini->Nm_lang['lang_category_fild_description'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
