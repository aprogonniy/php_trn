<?php  
  session_start() ;
  class form_category_form_teste
  {
   function form_category_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_category/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_category</FONT></B> 
<br> 
...
<input type="submit" value="form_category"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_category_form_teste();
  $frm_teste->form_category_teste();
?>
