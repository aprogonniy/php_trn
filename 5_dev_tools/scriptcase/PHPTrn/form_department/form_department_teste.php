<?php  
  session_start() ;
  class form_department_form_teste
  {
   function form_department_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_department/img";
...
<?php
  ...
  $frm_teste = new form_department_form_teste();
  $frm_teste->form_department_teste();
?>
