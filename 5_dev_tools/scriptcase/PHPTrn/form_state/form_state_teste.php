<?php  
  session_start() ;
  class form_state_form_teste
  {
   function form_state_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_state/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_state</FONT></B> 
<br> 
...
<input type="submit" value="form_state"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_state_form_teste();
  $frm_teste->form_state_teste();
?>
