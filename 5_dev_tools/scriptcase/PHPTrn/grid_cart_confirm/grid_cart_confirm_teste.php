<?php  
  ...
  session_start() ;
  class grid_cart_confirm_form_teste
  {
  function grid_cart_confirm_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_cart_confirm</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_cart_confirm.php" 
               target="_self"> 
...
<input type=submit value="grid_cart_confirm"> 
</form> 
<script language=javascript> 
 document.FCons.v_custname.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_cart_confirm_form_teste();
  $frm_teste->grid_cart_confirm_teste();
?>
