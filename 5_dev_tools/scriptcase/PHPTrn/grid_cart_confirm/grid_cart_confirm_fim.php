...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_cart_confirm"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PHPTrn_____grid_cart_confirm"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cart_confirm']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cart_confirm']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cart_confirm']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cart_confirm']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cart_confirm']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cart_confirm']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cart_confirm']['embutida_filho'] as $ind => $sc_init)
          {
