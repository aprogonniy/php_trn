<?php  
  ...
  session_start() ;
  class blank_finish_order_form_teste
  {
  function blank_finish_order_teste()
  {
...
<html> 
<HEAD>
 <title>blank_finish_order</title> 
...
?> 
<br> 
<B><FONT SIZE="4">blank_finish_order</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="blank_finish_order.php" 
               target="_self"> 
...
<input type=submit value="blank_finish_order"> 
</form> 
...
<?php
  ...
  $frm_teste = new blank_finish_order_form_teste();
  $frm_teste->blank_finish_order_teste();
?>
