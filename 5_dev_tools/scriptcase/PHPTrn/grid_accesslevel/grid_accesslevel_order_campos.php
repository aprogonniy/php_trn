<?php
   ...
   session_start();
    $Ord_Cmp = new grid_accesslevel_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_accesslevel_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["accesslevelid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_accesslevel']['labels']["accesslevelid"])) ? $_SESSION['sc_session'][$sc_init]['grid_accesslevel']['labels']["accesslevelid"] : "" . $this->Nm_lang['lang_accesslevel_fild_accesslevelid'] . "";
   $tab_ger_campos['description'] = "on";
   $tab_def_campos['description'] = "description";
   $tab_converte["description"]   = "description";
   $tab_labels["description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_accesslevel']['labels']["description"])) ? $_SESSION['sc_session'][$sc_init]['grid_accesslevel']['labels']["description"] : "" . $this->Nm_lang['lang_accesslevel_fild_description'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_accesslevel']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_accesslevel']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_accesslevel']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_accesslevel']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_accesslevel']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_accesslevel']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_accesslevel']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_accesslevel']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_accesslevel']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_accesslevel_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_accesslevel']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_accesslevel']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
