...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "accesslevelid";$Nm_numeric[] = "accesslevelid";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_accesslevelid"  <?php echo $str_hide_accesslevelid?>><INPUT  type="text" id="SC_accesslevelid" name="accesslevelid" value="<?php echo NM_encode_input($accesslevelid) ?>" size=5 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_description"  <?php echo $str_hide_description?>><INPUT  type="text" id="SC_description" name="description" value="<?php echo NM_encode_input($description) ?>" size=35 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
