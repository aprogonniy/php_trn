<?php  
  ...
  session_start() ;
  class grid_accesslevel_form_teste
  {
  function grid_accesslevel_teste()
  {
...
<?php
  ...
  $frm_teste = new grid_accesslevel_form_teste();
  $frm_teste->grid_accesslevel_teste();
?>
