<?php  
  session_start() ;
  class login_customer_form_teste
  {
   function login_customer_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "login_customer/img";
...
?> 
<br> 
<B><FONT SIZE="4">login_customer</FONT></B> 
<br> 
...
<input type="submit" value="login_customer"> 
</form> 
...
<?php
  ...
  $frm_teste = new login_customer_form_teste();
  $frm_teste->login_customer_teste();
?>
