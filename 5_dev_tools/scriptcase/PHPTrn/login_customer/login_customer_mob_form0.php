...
<?php
include_once("login_customer_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('login_customer_mob_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['recarga'];
}
     if ('' != $this->login)
     {
...
<?php
 include_once("login_customer_mob_js0.php");
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['login_customer_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['login_customer_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['empty_filter'] = true;
       }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_login" style="<?php echo $sStyleHidden_login; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style="vertical-align:top;" ><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['login_customer_mob']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
?>
<script>
 parent.scAjaxDetailStatus("login_customer_mob");
 parent.scAjaxDetailHeight("login_customer_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
