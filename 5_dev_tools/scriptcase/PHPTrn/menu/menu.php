...
$_SESSION['scriptcase']['menu']['glo_nm_conexao']   = "conn_example";
...
$url_third      = $_SESSION['scriptcase']['menu']['glo_nm_path_prod'] . "/third";
...
elseif (!isset($_SESSION['sc_session'][1]['menu']['init']))
{
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("blank_bg") . "/blank_bg_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_bg']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['blank_bg'] = "on";
    }
}
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_orders") . "/grid_orders_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_orders") . "/grid_orders_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_orders']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_orders'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_customers") . "/grid_customers_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_customers") . "/grid_customers_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_customers']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_products") . "/grid_products_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_products") . "/grid_products_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_products']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_producthome") . "/form_producthome_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_producthome") . "/form_producthome_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_producthome']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_producthome'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_category") . "/grid_category_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_category") . "/grid_category_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_category']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_subcategory") . "/grid_subcategory_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_subcategory") . "/grid_subcategory_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_subcategory']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_shipping") . "/form_shipping_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_shipping") . "/form_shipping_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_shipping']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_shippingrates") . "/grid_shippingrates_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_shippingrates") . "/grid_shippingrates_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_shippingrates']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_country") . "/grid_country_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_country") . "/grid_country_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_country']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_state") . "/grid_state_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_state") . "/grid_state_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_state']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_state'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_department") . "/form_department_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_department") . "/form_department_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_department']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_department'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_measure") . "/form_measure_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_measure") . "/form_measure_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_measure']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_measure'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_cardtype") . "/form_cardtype_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_cardtype") . "/form_cardtype_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_cardtype']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_accesslevel") . "/grid_accesslevel_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_accesslevel") . "/grid_accesslevel_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_accesslevel']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_systemuser") . "/grid_systemuser_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_systemuser") . "/grid_systemuser_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_systemuser']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("login") . "/login_ini.txt"))
{
...
<head>
 <title><?php echo $this->Nm_lang['lang_system'] ?></title>
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_orders']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_orders']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_orders'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=grid_orders&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_15",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
        'sc_id'    => "item_15",
        'disabled' => "N",
    );
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_customers']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_customers']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_customers'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_customers&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_14",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_products']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_products']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_products'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=grid_products&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_16",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_producthome']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_producthome']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_productshome'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=form_producthome&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[3] . "",
        'id'       => "item_17",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_category']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_category']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_category'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=grid_category&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_10",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_subcategory']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_subcategory']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_subcategory'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=grid_subcategory&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[5] . "",
        'id'       => "item_18",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_shipping']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_shipping']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_shipping'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_shipping&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[6] . "",
        'id'       => "item_11",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_shippingrates']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_shippingrates']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_shippingrates'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_shippingrates&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[7] . "",
        'id'       => "item_12",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_country']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_country']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_country'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_country&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[8] . "",
        'id'       => "item_9",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_state']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_state']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_state'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=grid_state&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[9] . "",
        'id'       => "item_8",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_department']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_department']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_department'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=form_department&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[10] . "",
        'id'       => "item_6",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_measure']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_measure']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_measure'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=form_measure&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[11] . "",
        'id'       => "item_7",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_cardtype']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_cardtype']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_cardtype'] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=form_cardtype&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[12] . "",
        'id'       => "item_5",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_accesslevel']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_accesslevel']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_security_accesslevel'] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_accesslevel&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[14] . "",
        'id'       => "item_3",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_systemuser']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_systemuser']) == "on")
{
    $str_icon = "";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $menu_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_security_systemuser'] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_systemuser&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[15] . "",
        'id'       => "item_4",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['login']) == "on")
{
    ...
    $menu_menuData['data'][] = array(
        ...
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[16] . "",
        'id'       => "item_13",
        'icon'     => $str_icon,
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " target=\"" . $this->menu_target('_parent') . "\"",
        'sc_id'    => "item_13",
        'disabled' => "N",
    );
}
...
<?php
    $link_default = "";
    if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_bg']) && $_SESSION['scriptcase']['sc_apl_seg']['blank_bg'] == "on") 
    { 
    $_SESSION['scriptcase']['menu']['apl_inicial'] = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu');\" item-href=\"menu_form_php.php?sc_item_menu=menu&sc_apl_menu=blank_bg&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_iframe\"";
    } 
    else
    { 
        $_SESSION['scriptcase']['menu']['apl_inicial'] = ($NM_scr_iframe != "") ? $NM_scr_iframe : "menu_pag_ini.php";
    } 
    $_SESSION['scriptcase']['menu']['path_link'] = $path_link;
?>
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    <tr>
        ...
        <iframe name="menu_iframe" id="iframe_menu" frameborder="0" class="scMenuIframe" src="<?php echo $_SESSION['scriptcase']['menu']['apl_inicial']?>"<?php echo $link_default ?>></iframe>
      </tr>
    </table>
</div>
<script type="text/javascript">
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "javascript:parent.nm_out_menu('menu_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "')";  
               }
               else
               {
           ...
           {
               $str_line['link'] = "javascript:parent.nm_out_menu('" . $_SESSION['scriptcase']['sc_saida_menu'] . "')"; 
           }
