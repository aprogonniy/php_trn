...
<?php
include_once("login_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('login_mob_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['recarga'];
}
?>
...
<?php
 include_once("login_mob_js0.php");
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['login_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['login_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
      ...
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
       <TR valign="middle">
        <TD align="left" rowspan="3" class="css_cabecalho">
          <IMG SRC="<?php echo $this->Ini->path_imag_cab ?>/grp__NM__img__NM__header_order_login.png" BORDER="0"/>
        </TD>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['empty_filter'] = true;
       }
...
<span id="id_read_on_login" class="sc-ui-readonly-login" style=";<?php echo $sStyleReadLab_login; ?>"><?php echo NM_encode_input($this->login); ?></span><span id="id_read_off_login" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 size=33 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
?>
<script>
 parent.scAjaxDetailStatus("login_mob");
 parent.scAjaxDetailHeight("login_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
