...
//
   ...
   @session_start() ;
       ...
       {
          include_once('login_mob.php');
          exit;
       }
   }
   $_SESSION['scriptcase']['login']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['login']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['login']['glo_nm_path_imagens']    = "/scriptcase2/file/img";
   $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['login']['glo_nm_path_doc']        = "/scriptcase2/file/img";
   $_SESSION['scriptcase']['login']['glo_nm_conexao']         = "conn_example";
//
class login_ini
{
   var $nm_cod_apl;
      ...
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  {
                      $inicial_login->contr_->NM_ajax_info['redir']['action']  = $nm_apl_dest;
                      ...
                      $inicial_login->contr_login->NM_ajax_info['redir']['script_case_session']  = session_id();
...
<?php
      ...
      $this->link_login_inline = $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('login') . "/login_inline.php";
      $this->nm_cont_lin       = 0;
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['login']['glo_nm_conexao'], $this->root . $this->path_prod, 'PHPTrn'); 
      } 
      else 
      { 
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']))
    {
        ...
        if ('ajax_login_validate_password' == $_POST['rs'])
        {
    ...
    elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['login']['parms']))
    {
        ...
        {
            $todo = explode("?@?", $_SESSION['sc_session'][$script_case_init]['login']['parms']);
            $ix = 0;
            while (!empty($todo[$ix]))
            {
               $cadapar = explode("?#?", $todo[$ix]);
    ...
    else
    {
        ...
        if (isset($_POST["v_user"])) 
        {
            ...
            nm_limpa_str_login($_SESSION['v_user']);
        }
        ...
        elseif ($_SESSION['sc_session'][$script_case_init]['login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['login']['run_iframe'] != "R")
        {
           ...
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            ...
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['login']['retorno_edit'] . "?script_case_init=" . $script_case_init . "&script_case_session=" . session_id();  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['login']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['login']['run_iframe'] != "R")
        {
            ...
            $_SESSION['sc_session'][$script_case_init]['login']['volta_dep'] = $nm_apl_dependente;
        ...
        $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['login']['volta_php'];
        $nm_saida_global = $_SESSION['sc_session'][$script_case_init]['login']['volta_php'];
        $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['login']['volta_dep'];
        ...
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['login']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['login']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init . "&script_case_session=" . session_id(); 
            } 
        } 
    ...
    sajax_export("ajax_login_validate_password");
...
//
    ...
    function ajax_login_validate_password($password, $script_case_init)
    {
        global $inicial_login;
        //register_shutdown_function("login_pack_ajax_response");
        $inicial_login->contr_login->NM_ajax_flag          = true;
        $inicial_login->contr_login->NM_ajax_opcao         = 'validate_password';
        $inicial_login->contr_login->NM_ajax_info['param'] = array(
    ...
    function ajax_login_submit_form($login, $password, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init)
    {
        global $inicial_login;
        //register_shutdown_function("login_pack_ajax_response");
        $inicial_login->contr_login->NM_ajax_flag          = true;
...
//-----
      {
         ...
         {
            $inicial_login->contr_login->NM_ajax_info['buttonDisplay'] = $inicial_login->contr_login->nmgp_botoes;
   ...
   {
      global $inicial_login;
      $aResp['ajaxAlert'] = array('message' => $inicial_login->contr_login->NM_ajax_info['ajaxAlert']['message']);
