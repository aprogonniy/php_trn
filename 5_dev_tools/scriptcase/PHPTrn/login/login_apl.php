   ...
   function ini_controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan'])
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['login']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['login']['label'] = "" . $this->Ini->Nm_lang['lang_system'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['login']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__notice.gif\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['login'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
...
//
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['login']['campos'][1] = $this->password; 
...
$_SESSION['scriptcase']['login']['contr_erro'] = 'off'; 
    ...
    function ValidateField_login(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['login']['php_cmp_required']['login'] == "on")) 
      { 
          if ($this->login == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['php_cmp_required']['password']) || $_SESSION['sc_session'][$this->Ini->sc_page]['login']['php_cmp_required']['password'] == "on")) 
      { 
          if ($this->password == "")  
          { 
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan'])
   {
