...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_login_validate_login()
  {
    ...
    x_ajax_login_validate_login(var_login, var_script_case_init, do_ajax_login_validate_login_cb);
  } // do_ajax_login_validate_login

  function do_ajax_login_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_login_cb

  // ---------- Validate password
  function do_ajax_login_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_password(var_password, var_script_case_init, do_ajax_login_validate_password_cb);
  } // do_ajax_login_validate_password

  function do_ajax_login_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_password_cb
  // ---------- Form
  function do_ajax_login_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_login_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_login_submit_form(var_login, var_password, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_login_submit_form_cb);
  ...
  } // do_ajax_login_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_login_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_login_navigate_form

  function do_ajax_login_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_login_navigate_form_cb
