...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_password' + iSeqRow).bind('blur', function() { sc_login_password_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_login_password_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_login_password_onblur(oThis, iSeqRow) {
  do_ajax_login_validate_password();
  scCssBlur(oThis);
}

function sc_login_password_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
