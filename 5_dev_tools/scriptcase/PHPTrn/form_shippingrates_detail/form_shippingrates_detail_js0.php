<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="shippingratesid_" value="<?php echo NM_encode_input($this->nmgp_dados_form['shippingratesid_']); ?>">
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_shippingrates_detail_submit_form(y, z); 
} 
<?php
}
?>
