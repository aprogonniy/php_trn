<?php  
  session_start() ;
  class form_shippingrates_detail_form_teste
  {
   function form_shippingrates_detail_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_shippingrates_detail/img";
...
<?php
  ...
  $frm_teste = new form_shippingrates_detail_form_teste();
  $frm_teste->form_shippingrates_detail_teste();
?>
