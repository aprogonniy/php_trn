<?php  
  session_start() ;
  class form_customers_customer_form_teste
  {
   function form_customers_customer_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_customers_customer/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_customers_customer</FONT></B> 
<br> 
...
<input type="submit" value="form_customers_customer"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_customers_customer_form_teste();
  $frm_teste->form_customers_customer_teste();
?>
