<?php  
  session_start() ;
  class container_form_teste
  {
   function container_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "container/img";
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'container')
  {
...
?> 
<br> 
<B><FONT SIZE="4">container</FONT></B> 
<br> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new container_form_teste();
  $frm_teste->container_teste();
?>
