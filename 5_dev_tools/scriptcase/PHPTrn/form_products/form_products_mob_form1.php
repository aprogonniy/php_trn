<div id="form_products_mob_form1" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_description" style="<?php echo $sStyleHidden_description; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span id="id_read_on_description" style="<?php echo $sStyleReadLab_description; ?>"><?php echo $this->description; ?></span><span id="id_read_off_description" style="<?php echo $sStyleReadInp_description; ?>"><textarea id="description" name="description" cols="50" rows="3" class="mceEditor_description" style="width: 100%; height:200px;"><?php echo $this->description; ?></textarea>
