<?php  
  session_start() ;
  class form_products_form_teste
  {
   function form_products_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_products/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_products</FONT></B> 
<br> 
...
<input type="submit" value="form_products"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_products_form_teste();
  $frm_teste->form_products_teste();
?>
