...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_products_form0').style.width='1px';
    document.getElementById('form_products_form0').style.height='0px';
    document.getElementById('form_products_form0').style.display='none';
    document.getElementById('form_products_form0').style.overflow='scroll';
    document.getElementById('form_products_form1').style.width='1px';
    document.getElementById('form_products_form1').style.height='0px';
    document.getElementById('form_products_form1').style.display='none';
    document.getElementById('form_products_form1').style.overflow='scroll';
    document.getElementById('form_products_form2').style.width='1px';
    document.getElementById('form_products_form2').style.height='0px';
    document.getElementById('form_products_form2').style.display='none';
    document.getElementById('form_products_form2').style.overflow='scroll';
    document.getElementById('form_products_form3').style.width='1px';
    document.getElementById('form_products_form3').style.height='0px';
    document.getElementById('form_products_form3').style.display='none';
    document.getElementById('form_products_form3').style.overflow='scroll';
    document.getElementById('form_products_form4').style.width='1px';
    document.getElementById('form_products_form4').style.height='0px';
    document.getElementById('form_products_form4').style.display='none';
    document.getElementById('form_products_form4').style.overflow='scroll';
    document.getElementById('form_products_form5').style.width='1px';
    document.getElementById('form_products_form5').style.height='0px';
    document.getElementById('form_products_form5').style.display='none';
    document.getElementById('form_products_form5').style.overflow='scroll';
