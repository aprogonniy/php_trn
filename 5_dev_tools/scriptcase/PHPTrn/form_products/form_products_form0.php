...
<?php
include_once("form_products_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_products_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['recarga'];
}
?>
...
<?php
 include_once("form_products_js0.php");
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_products'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_products'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_products_form0";
</script>
<ul class="scTabLine">
<?php
    if (empty($nmgp_num_form) || $nmgp_num_form == "form_products_form0")
    {
...
?>
   <li id="id_form_products_form0" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_form0')">
     <?php echo $this->Ini->Nm_lang['lang_products_fild_name']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_form1")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_form1" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_form1')">
     <?php echo $this->Ini->Nm_lang['lang_description']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_form2")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_form2" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_form2')">
     <?php echo $this->Ini->Nm_lang['lang_products_fild_picture']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_form3")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_form3" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_form3')">
     <?php echo $this->Ini->Nm_lang['lang_overview']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_form4")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_form4" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_form4')">
     <?php echo $this->Ini->Nm_lang['lang_specifications']; ?>
    </a>
   </li>
<?php
    if ($nmgp_num_form == "form_products_form5")
    {
        $css_celula = "scTabActive";
    }
    else
...
?>
   <li id="id_form_products_form5" class="<?php echo $css_celula; ?>">
    <a href="javascript: sc_exib_ocult_pag ('form_products_form5')">
...
<div id="form_products_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_name" style="<?php echo $sStyleHidden_name; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_name"><?php echo $this->nm_new_label['name']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['name'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_shippingid" style="<?php echo $sStyleHidden_shippingid; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_shippingid"><?php echo $this->nm_new_label['shippingid']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['shippingid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['shippingid'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_taxable" style="<?php echo $sStyleHidden_taxable; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_taxable"><?php echo $this->nm_new_label['taxable']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['taxable']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['taxable'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_taxable'][] = 'Y'; ?>
<?php  if ("Y" == $this->taxable)  { echo " checked" ;} ?>  onClick="" >Yes</TD>
  <TD class="scFormDataFontOdd" style=";">    <input  type=radio name="taxable" value="N"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_taxable'][] = 'N'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_onhandquantity" style="<?php echo $sStyleHidden_onhandquantity; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat" style=";" ><span id="id_label_onhandquantity"><?php echo $this->nm_new_label['onhandquantity']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['onhandquantity']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['onhandquantity'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
