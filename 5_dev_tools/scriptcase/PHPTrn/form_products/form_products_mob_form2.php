<div id="form_products_mob_form2" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php
?>
<TABLE align="center" id="hidden_bloco_2" class="scFormTable" width="100%" style="height: 100%;"><?php $sStyleHidden_description_dumb = ('' == $sStyleHidden_description) ? 'display: none' : ''; ?>
...
<?php } else { $sc_hidden_no++; ?>
 ...
 <script>var var_ajax_img_picture = '<?php echo $out1_picture; ?>';</script><input type="hidden" name="temp_out_picture" value="<?php echo NM_encode_input($out_picture); ?>" /><input type="hidden" name="temp_out1_picture" value="<?php echo NM_encode_input($out1_picture); ?>" /><?php if (!empty($out_picture)) {  echo "<a  href=\"javascript:nm_mostra_img(var_ajax_img_picture, '" . $this->nmgp_return_img['picture'][0] . "', '" . $this->nmgp_return_img['picture'][1] . "')\"><img id=\"id_ajax_img_picture\" border=\"0\" src=\"$out_picture\"></a>"; } else {  echo "<img id=\"id_ajax_img_picture\" border=\"0\" style=\"display: none\">"; } ?><br>
