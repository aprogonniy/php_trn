...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_products']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_products']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_products']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_products']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_products']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_products']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_products']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_products']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_products']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_products']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_products']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_products']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_products']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_products']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_products_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_products']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_products'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_products']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_products']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_products') . "/form_products.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_products']['label'] = "" . $this->Ini->Nm_lang['lang_tble_products'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_products']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_products'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_call'] : $this->Embutida_call;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_products.php"; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_products']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_products']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_products']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_products']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_products']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_products']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['embutida_liga_form_btn_nav'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_products']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_products']['insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_products']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_products']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_products']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_products']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_products']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_products']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_products", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_products_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_products_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_products/form_products_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_products_erro.class.php"); 
      }
      $this->Erro      = new form_products_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opcao']))
         { 
             if ($this->productid != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_products']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_products']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "form_products.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
    ...
    function ValidateField_productid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Productid: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->productid, 11, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Productid; " ; 
                  if (!isset($Campos_Erros['productid']))
                  {
                      $Campos_Erros['productid'] = array();
                  }
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['name'] == "on")) 
      { 
          if ($this->name == "")  
          { 
    ...
    function ValidateField_categoryid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->categoryid, 11, 0, 0, 0, "N") == false)  
              { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['categoryid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['categoryid'] == "on") 
           { 
    ...
    function ValidateField_subcategoryid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->subcategoryid, 11, 0, 0, 0, "N") == false)  
              { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['subcategoryid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['subcategoryid'] == "on") 
           { 
    ...
    function ValidateField_price(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->price, 8, 2, 0, 0, "N") == false)  
              { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['price']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['price'] == "on") 
           { 
    ...
    function ValidateField_shippingid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->shippingid, 11, 0, 0, 0, "N") == false)  
              { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['shippingid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['shippingid'] == "on") 
           { 
    ...
    function ValidateField_taxable(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['taxable']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['taxable'] == "on")
        { 
      ...
      if ($this->taxable != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_taxable']) && !in_array($this->taxable, $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_taxable']))
          {
    ...
    function ValidateField_onhandquantity(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->onhandquantity, 11, 0, 0, 0, "N") == false)  
              { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['onhandquantity']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['onhandquantity'] == "on") 
           { 
    ...
    {
        global $teste_validade;
      if ($this->measure == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['measure']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['php_cmp_required']['measure'] == "on"))
      {
          ...
          if (!empty($this->measure) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_measure']) && !in_array($this->measure, $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_measure']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['measure']))
              {
...
//--------------------------------------------------------------------------------------
   ...
   {
     global $nm_browser;
      if ($this->nmgp_opcao == "incluir" && $this->picture == "" &&  $this->picture_limpa != "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_clone']['picture']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_clone']['picture']))
      { 
          $this->picture = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_clone']['picture'];
      } 
      ...
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_form']['picture']) && $this->picture_limpa != "S")
          {
              $this->picture = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_form']['picture'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['productid']['keyVal'] = form_products_pack_protect_string($this->nmgp_dados_form['productid']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_products_pack_protect_string('Y') => form_products_pack_protect_string("Yes"));
$aLookup[] = array(form_products_pack_protect_string('N') => form_products_pack_protect_string("No"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_taxable'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_taxable'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_measure']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_measure'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_measure']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_measure'] = array(); 
}
$aLookup[] = array(form_products_pack_protect_string('') => form_products_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_measure'][] = '';
...
ORDER BY description";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_products_pack_protect_string($rs->fields[0]) => form_products_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['Lookup_measure'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao != "incluir")  
      {
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_clone']['picture']);
      }
      if (!empty($this->sc_force_zero))
      {
          foreach ($this->sc_force_zero as $i_force_zero => $sc_force_zero_field)
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_products']['contr_erro'] = 'on';
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_products' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_products']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->acessories = $this->acessories_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              }
              $this->nm_flag_iframe = true;
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['parms'] = "productid?#?$this->productid?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_products = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['total'] = $qt_geral_reg_form_products;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->productid))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_products = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] > $qt_geral_reg_form_products)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] = $qt_geral_reg_form_products; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_products) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['parms'] = "productid?#?$this->productid?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] < $qt_geral_reg_form_products;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_select'];
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['dados_clone']['picture'] = $this->nmgp_dados_select['picture'];  
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_picture))
       {
        ...
        include_once("form_products_form0.php");
        include_once("form_products_form1.php");
        include_once("form_products_form2.php");
        include_once("form_products_form3.php");
        include_once("form_products_form4.php");
        include_once("form_products_form5.php");
 }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_products_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['opc_ant']);
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_products']['sc_modal'])
   {
?>
