<?php  
  ...
  session_start() ;
  class grid_product_detail_form_teste
  {
  function grid_product_detail_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_product_detail</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="grid_product_detail.php" 
               target="_self"> 
v_product&nbsp;&nbsp;<input type=text name="v_product" size=20><br> 
<input type="hidden" name="script_case_session" value="<?php echo session_id() ?>"/>
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_product_detail"> 
</form> 
<script language=javascript> 
 document.FCons.v_product.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_product_detail_form_teste();
  $frm_teste->grid_product_detail_teste();
?>
