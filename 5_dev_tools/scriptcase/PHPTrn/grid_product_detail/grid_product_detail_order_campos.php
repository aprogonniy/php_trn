<?php
   ...
   session_start();
    $Ord_Cmp = new grid_product_detail_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_product_detail_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['picture'] = "on";
   $tab_def_campos['picture'] = "picture";
   $tab_converte["picture"]   = "picture";
   $tab_labels["picture"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["picture"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["picture"] : "" . $this->Nm_lang['lang_products_fild_picture'] . "";
   $tab_ger_campos['description'] = "on";
   $tab_def_campos['description'] = "description";
   $tab_converte["description"]   = "description";
   $tab_labels["description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["description"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["description"] : "description";
   $tab_ger_campos['add_cart'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['add_cart'] = "add_cart";
       $tab_converte["add_cart"]   = "add_cart";
   }
   else
   {
       $tab_def_campos['add_cart'] = "";
       $tab_converte[""]   = "add_cart";
   }
   $tab_labels["add_cart"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["add_cart"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["add_cart"] : " ";
   $tab_ger_campos['overview'] = "on";
   $tab_def_campos['overview'] = "overview";
   $tab_converte["overview"]   = "overview";
   $tab_labels["overview"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["overview"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["overview"] : "overview";
   $tab_ger_campos['specifications'] = "on";
   $tab_def_campos['specifications'] = "specifications";
   $tab_converte["specifications"]   = "specifications";
   $tab_labels["specifications"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["specifications"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["specifications"] : "specifications";
   $tab_ger_campos['acessories'] = "on";
   $tab_def_campos['acessories'] = "acessories";
   $tab_converte["acessories"]   = "acessories";
   $tab_labels["acessories"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["acessories"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_detail']['labels']["acessories"] : "acessories";
   $tab_ger_campos['picture'] = "none";
   $tab_ger_campos['add_cart'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_product_detail']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_product_detail']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_product_detail']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_product_detail']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_product_detail']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_product_detail']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_product_detail']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_product_detail']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_product_detail']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_product_detail']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_product_detail']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_product_detail']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_product_detail_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_product_detail']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_product_detail']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
